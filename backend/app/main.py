...
# T-0195: Zeitpunkt des Prozessstarts und ausgelieferter Commit. Der Deploy-Lauf prueft damit,
...
def _commit() -> str | None:
    """Kurz-Hash des ausgelieferten Standes; None, wenn nicht ermittelbar."""
...
# Einmal beim Start ermitteln: /api/health darf kein git aufrufen (Laufzeit, Nebenwirkungen).
COMMIT = _commit()
