...
# seiten:  gedruckte Seiten von TB 6 Kap. 3.4 (S. 82–88; gedruckte Seite = PDF-Seite von
#          docs/KWAR/kwra2021_teilbericht_6_integrierte_auswertung_bf_211027_0.pdf), auf denen die
#          Klimawirkung genannt ist — nicht nur mit Netzrolle. Nichtleere, aufsteigende Liste ohne
#          Doppelte; enthält jede Seite aus beleg_rolle und beleg_auswertung. Nachgelesen im
#          Teilbericht, nicht aus der Arbeitsmappe (die keine Seiten nennt).
