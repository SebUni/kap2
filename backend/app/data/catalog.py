...
HAZARDS: list[dict] = [
    ...
    {"code": "HEAVY_RAIN_FLOOD", "name": "Starkniederschlag und Fluten",
     ...
     "proxy": "Versiegelungsgrad (OSM) × topografische Senkenlage (DGM-Proxy) × regionaler Starkregenindex.",
     "source": "DWD RADOLAN + DGM-Abflussproxy (OSM/Topografie)"},
    ...
    {"code": "LANDSLIDE", "name": "Hangrutschungen / Erdrutsche",
     ...
     "proxy": "Hangneigung (DGM-Proxy) × Starkregenindex.",
     "source": "BKG DGM + DWD RADOLAN"},
...
EXPOSURES: list[dict] = [
    ...
    {"code": "COASTAL_RIPARIAN_ZONES", "name": "Küsten- und Uferzonen",
     ...
     "proxy": "Flächenanteil nahe Gewässern (OSM water/waterway-Puffer).",
     "source": "OSM"},
    {"code": "FLOODPLAINS", "name": "Überschwemmungsflächen",
     "unit": "ha", "norm_min": 0.0, "norm_max": 1.0, "spatial": True,
     "description": "Hochwasser- und Überschwemmungsflächen.",
     "proxy": "Senkenlage nahe Gewässern (Topografie + OSM-Gewässerpuffer).",
     "source": "OSM + Topografie"},
    ...
    {"code": "FISH_SPAWNING_HABITATS", "name": "Laich- und Aufwuchsgebiete",
     ...
     "proxy": "Fließgewässer-/Uferanteil (OSM waterway/natural=water).",
     "source": "OSM / LfU"},
]
...
RISKS: list[dict] = [
    {"code": "EXPECTED_ANNUAL_MORTALITY", "name": "Erwartete jährliche Mortalität",
     ...
     "ref_value": 18.0, "scale": "pop", "cost_per_outcome_eur": 3500000.0,
    ...
    {"code": "EXPECTED_ANNUAL_MORBIDITY", "name": "Erwartete jährliche Morbidität",
     ...
     "ref_value": 320.0, "scale": "pop", "cost_per_outcome_eur": 5000.0,
    ...
    {"code": "EXPECTED_ANNUAL_INJURIES", "name": "Erwartete jährliche Verletztenzahlen",
     ...
     "ref_value": 45.0, "scale": "pop", "cost_per_outcome_eur": 12000.0,
    ...
    {"code": "EXPECTED_ANNUAL_MENTAL_HEALTH", "name": "Psychische Belastungsfälle",
     ...
     "ref_value": 150.0, "scale": "pop", "cost_per_outcome_eur": 4000.0,
    ...
    {"code": "EXPECTED_ANNUAL_AFFECTED_EVACUATED", "name": "Betroffene/Evakuierte Personen",
     ...
     "vulnerabilities": ["EMERGENCY_MANAGEMENT", "EARLY_WARNING_SYSTEMS"],
     "ref_value": 800.0, "scale": "pop", "cost_per_outcome_eur": 2500.0,
    ...
    {"code": "EXPECTED_THERMAL_STRESS_HOURS", "name": "Stunden thermischer Belastung",
     ...
     "ref_value": 400.0, "scale": "pop", "cost_per_outcome_eur": 0.0,
    ...
    {"code": "EXPECTED_POLLUTANT_EXPOSURE_HOURS", "name": "Schadstoffexpositionsstunden",
     ...
     "ref_value": 250.0, "scale": "pop", "cost_per_outcome_eur": 0.0,
    ...
    {"code": "EXPECTED_BUILDING_DAMAGE_EUR", "name": "Gebäudeschäden",
     ...
     "ref_value": 4500000.0, "scale": "pop", "description": "Erwartete jährliche Gebäudeschäden.", "priority": 1},
    {"code": "EXPECTED_TRANSPORT_DAMAGE_EUR", "name": "Schäden an Verkehrswegen",
     ...
     "ref_value": 1800000.0, "scale": "pop", "description": "Erwartete jährliche Schäden an Verkehrswegen.", "priority": 2},
    {"code": "EXPECTED_ENERGY_INFRA_DAMAGE_EUR", "name": "Schäden an Energieinfrastruktur",
     ...
     "ref_value": 900000.0, "scale": "pop", "description": "Erwartete jährliche Schäden an Energieinfrastruktur.", "priority": 1},
    {"code": "EXPECTED_TELECOM_DAMAGE_EUR", "name": "Schäden an Telekommunikation",
     ...
     "vulnerabilities": ["CRITICAL_INFRA_CONDITION", "REDUNDANCY_BACKUP"],
     "ref_value": 400000.0, "scale": "pop", "description": "Erwartete jährliche Schäden an Telekommunikationsinfrastruktur.", "priority": 2},
    {"code": "EXPECTED_WATER_WASTEWATER_DAMAGE_EUR", "name": "Schäden Wasser-/Abwasser",
     ...
     "ref_value": 700000.0, "scale": "pop", "description": "Erwartete jährliche Schäden an Wasser-/Abwassersystemen.", "priority": 1},
    {"code": "EXPECTED_AGRICULTURAL_DAMAGE_EUR", "name": "Landwirtschaftliche Schäden",
     ...
     "ref_value": 2200000.0, "scale": "area", "description": "Erwartete jährliche landwirtschaftliche Schäden / Ernteverluste.", "priority": 1},
    {"code": "EXPECTED_TOTAL_DAMAGE_EAD_EUR", "name": "Gesamtschäden (EAD)",
     ...
     "ref_value": 8000000.0, "scale": "pop", "description": "Erwartete jährliche Gesamtschäden (Expected Annual Damage).", "priority": 1},
    {"code": "EXPECTED_RESTORATION_COSTS_EUR", "name": "Wiederherstellungskosten",
     ...
     "ref_value": 1500000.0, "scale": "pop", "description": "Erwartete jährliche Wiederherstellungskosten.", "priority": 2},
    {"code": "EXPECTED_SOIL_LOSS_DEGRADATION_EUR", "name": "Bodenverluste / -degradation (€)",
     ...
     "ref_value": 600000.0, "scale": "area", "description": "Erwartete jährliche Bodenverluste / Bodendegradation.", "priority": 2},
    {"code": "EXPECTED_CI_OUTAGE_HOURS", "name": "Ausfallzeiten kritischer Infrastruktur",
     ...
     "ref_value": 120.0, "scale": "flat", "description": "Erwartete jährliche Ausfallzeiten kritischer Infrastrukturen.", "priority": 1},
    {"code": "EXPECTED_ENERGY_OUTAGE_HOURS", "name": "Ausfallstunden Energieversorgung",
     ...
     "exposures": ["ENERGY_INFRASTRUCTURE"],
     "vulnerabilities": ["CRITICAL_INFRA_CONDITION", "REDUNDANCY_BACKUP"],
     "ref_value": 40.0, "scale": "flat", "description": "Erwartete Ausfallstunden der Energieversorgung.", "priority": 1},
    {"code": "EXPECTED_WATER_SUPPLY_OUTAGE_HOURS", "name": "Ausfallstunden Wasserversorgung",
     ...
     "ref_value": 30.0, "scale": "flat", "description": "Erwartete Ausfallstunden der Wasserversorgung.", "priority": 1},
    {"code": "EXPECTED_WASTEWATER_OUTAGE_HOURS", "name": "Ausfallstunden Abwasserentsorgung",
     ...
     "ref_value": 25.0, "scale": "flat", "description": "Erwartete Ausfallstunden der Abwasserentsorgung.", "priority": 2},
    {"code": "EXPECTED_COMMUNICATION_OUTAGE_HOURS", "name": "Ausfallzeiten Kommunikation",
     "outcome_unit": "Stunden/Jahr", "group": "flood", "cost_dimension": "operational",
     "hazards": ["EXTRATROPICAL_STORM", "HEAVY_RAIN_FLOOD"],
     "exposures": ["COMMUNICATION_INFRA"],
     "vulnerabilities": ["CRITICAL_INFRA_CONDITION", "REDUNDANCY_BACKUP"],
     "ref_value": 20.0, "scale": "flat", "description": "Erwartete Ausfallzeiten der Kommunikationssysteme.", "priority": 2},
    {"code": "EXPECTED_TRANSPORT_DISRUPTION_HOURS", "name": "Verkehrsunterbrechungen",
     ...
     "vulnerabilities": ["MATERIAL_HEAT_SENSITIVITY", "CRITICAL_INFRA_CONDITION"],
     "ref_value": 60.0, "scale": "flat", "description": "Erwartete Verkehrsunterbrechungen.", "priority": 2},
    {"code": "EXPECTED_SUPPLY_CHAIN_DISRUPTION_HOURS", "name": "Lieferkettenunterbrechungen",
     ...
     "ref_value": 50.0, "scale": "flat", "description": "Erwartete Unterbrechungen von Lieferketten.", "priority": 2},
    {"code": "EXPECTED_ADMIN_OUTAGE_HOURS", "name": "Administrative Ausfallzeiten",
     ...
     "ref_value": 15.0, "scale": "flat", "description": "Erwartete administrative Ausfallzeiten.", "priority": 3},
    {"code": "EXPECTED_FUNCTIONAL_FAILURE_DURATION", "name": "Dauer von Funktionsausfällen",
     ...
     "ref_value": 35.0, "scale": "flat", "description": "Erwartete Dauer von Funktionsausfällen.", "priority": 2},
    {"code": "MEDICAL_UNDERSUPPLY_RISK_INDEX", "name": "Risiko medizinischer Unterversorgung",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko medizinischer Unterversorgung.", "priority": 1},
    {"code": "EXPECTED_BIODIVERSITY_LOSS", "name": "Biodiversitätsverlust",
     ...
     "ref_value": 5.0, "scale": "area", "description": "Erwarteter jährlicher Biodiversitätsverlust.", "priority": 2},
    {"code": "EXPECTED_HABITAT_LOSS", "name": "Habitatverlust",
     ...
     "ref_value": 8.0, "scale": "area", "description": "Erwarteter jährlicher Habitatverlust.", "priority": 2},
    {"code": "EXPECTED_SOIL_DEGRADATION", "name": "Bodenverschlechterung",
     "outcome_unit": "ha/Jahr", "group": "drought", "cost_dimension": "environment",
     "hazards": ["DROUGHT", "HEAVY_RAIN_FLOOD", "SOIL_SALINIZATION"],
     "exposures": ["EROSION_PRONE_SOILS", "AGRICULTURAL_LAND"],
     "vulnerabilities": ["SOIL_SENSITIVITY", "IRRIGATION_DEPENDENCY"],
     "ref_value": 12.0, "scale": "area", "description": "Erwartete jährliche Bodenverschlechterung.", "priority": 2},
    {"code": "EXPECTED_VEGETATION_DAMAGE", "name": "Vegetationsschäden",
     ...
     "ref_value": 15.0, "scale": "area", "description": "Erwartete Vegetationsschäden.", "priority": 2},
    {"code": "HYDROLOGICAL_STRESS_RISK_INDEX", "name": "Risiko hydrologischer Belastungen",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko hydrologischer Belastungen.", "priority": 1},
    {"code": "EXPECTED_WATER_AIR_POLLUTION", "name": "Gewässer-/Luftbelastung",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Erwartete jährliche Gewässer- oder Luftbelastung.", "priority": 2},
    {"code": "ECOSYSTEM_DEGRADATION_RISK_INDEX", "name": "Risiko Ökosystemdegradation",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko der Ökosystemdegradation.", "priority": 2},
    {"code": "ECOSYSTEM_FRAGMENTATION_RISK_INDEX", "name": "Risiko Ökosystemfragmentierung",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko der Ökosystemfragmentierung.", "priority": 3},
    {"code": "EXPECTED_ECOSYSTEM_SERVICE_LOSS", "name": "Verlust von Ökosystemleistungen",
     ...
     "vulnerabilities": ["BIODIVERSITY_RESILIENCE", "GREEN_SPACE_SHARE"],
     "ref_value": 800000.0, "scale": "area", "description": "Erwarteter Verlust von Ökosystemleistungen.", "priority": 2},
    {"code": "EXPECTED_INDIRECT_ECONOMIC_LOSS_EUR", "name": "Indirekte wirtschaftliche Verluste",
     ...
     "ref_value": 1200000.0, "scale": "pop", "description": "Erwartete indirekte wirtschaftliche Verluste.", "priority": 2},
    {"code": "EXPECTED_SUPPLY_SHORTAGE_COSTS_EUR", "name": "Kosten Versorgungsengpässe",
     ...
     "ref_value": 600000.0, "scale": "pop", "description": "Erwartete Kosten durch Versorgungsengpässe.", "priority": 2},
    {"code": "EXPECTED_CLIMATE_MIGRATION_COSTS_EUR", "name": "Kosten klimabedingter Migration",
     ...
     "ref_value": 400000.0, "scale": "pop", "description": "Erwartete Kosten klimabedingter Migration / Verdrängung.", "priority": 3},
    {"code": "EXPECTED_LOCATION_DISADVANTAGE_EUR", "name": "Wirtschaftliche Standortnachteile",
     ...
     "ref_value": 500000.0, "scale": "pop", "description": "Erwartete wirtschaftliche Standortnachteile.", "priority": 3},
    {"code": "EXPECTED_DELAYED_DAMAGE_COSTS_EUR", "name": "Verzögerte Schadenswirkungen",
     ...
     "ref_value": 350000.0, "scale": "pop", "description": "Erwartete verzögerte Schadenswirkungen.", "priority": 3},
    {"code": "SYSTEMIC_DOMINO_RISK_INDEX", "name": "Risiko systemischer Dominoeffekte",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko systemischer Dominoeffekte.", "priority": 1},
    {"code": "RESOURCE_CONFLICT_RISK_INDEX", "name": "Risiko von Ressourcenkonflikten",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko von Ressourcenkonflikten.", "priority": 3},
    {"code": "SOCIAL_INEQUALITY_AMPLIFICATION_RISK_INDEX", "name": "Verstärkung sozialer Ungleichheiten",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko der Verstärkung sozialer Ungleichheiten.", "priority": 2},
    {"code": "ENVIRONMENTAL_FEEDBACK_RISK_INDEX", "name": "Risiko umweltbezogener Rückkopplungen",
     "outcome_unit": "Index", "group": "gradual", "cost_dimension": "environment",
     "hazards": ["COMPOUND_EVENT", "WILDFIRE", "DROUGHT"],
     "exposures": ["FOREST_AREA", "BIODIVERSITY_HOTSPOTS"],
     "vulnerabilities": ["BIODIVERSITY_RESILIENCE", "WILDFIRE_SUSCEPTIBILITY"],
     "ref_value": 100.0, "scale": "flat", "description": "Risiko umweltbezogener Rückkopplungseffekte.", "priority": 3},
    {"code": "EXPECTED_FISHERIES_ECONOMIC_LOSS_EUR", "name": "Wirtschaftliche Verluste Fischerei",
     ...
     "ref_value": 300000.0, "scale": "area", "description": "Erwartete jährliche wirtschaftliche Verluste in der Fischerei.", "priority": 2},
    {"code": "EXPECTED_AQUACULTURE_DAMAGE_EUR", "name": "Schäden in der Aquakultur",
     ...
     "ref_value": 200000.0, "scale": "area", "description": "Erwartete jährliche Schäden in der Aquakultur.", "priority": 2},
    {"code": "FISHERIES_STOCK_STRESS_RISK_INDEX", "name": "Risiko fischereilicher Bestandsbelastung",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko fischereilicher Bestandsbelastung.", "priority": 2},
    {"code": "LOW_WATER_FISHERIES_IMPACT_INDEX", "name": "Fischereiliche Folgen von Niedrigwasser",
     ...
     "ref_value": 100.0, "scale": "flat", "description": "Risiko fischereilicher Folgen von Niedrigwasser.", "priority": 2},
]
