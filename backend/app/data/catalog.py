...
HAZARDS: list[dict] = [
    ...
    {"code": "HEAT_WAVE", "name": "Hitzeextreme / Hitzewellen",
     ...
     "proxy": "DWD heiße Tage (Bundesland) + UHI-Modell (ΔT) pro 100m-Zelle aus OSM (siehe Handbuch).",
     "source": "DWD CDC + UHI-Modell (OSM)"},
    {"code": "COLD_EXTREME", "name": "Kälteextreme und Frostereignisse",
     "unit": "Tage/Jahr", "norm_min": 0.0, "norm_max": 40.0, "spatial": True,
     "description": "Extreme Kälte- und Frostereignisse (regional relevant).",
     "proxy": "Regionaler Frosttage-Wert, leicht reduziert in dicht bebauten (wärmeren) Zellen.",
     "source": "DWD CDC"},
    ...
    {"code": "DROUGHT", "name": "Dürren",
     ...
     "proxy": "Regionale Trockentage + erhöhte Empfindlichkeit auf versiegelten/landwirtschaftlichen Flächen.",
     "source": "DWD CDC / UBA"},
    ...
    {"code": "LOW_FLOW_NIEDRIGWASSER", "name": "Niedrigwasser / reduzierte Abflüsse",
     ...
     "proxy": "Regionaler Niedrigwasser-Wert (an Trockenheit gekoppelt).",
     "source": "BfG Pegel / UBA"},
]
...
EXPOSURES: list[dict] = [
    ...
    {"code": "TRANSPORT_HUBS", "name": "Verkehrsknotenpunkte",
     ...
     "proxy": "OSM Bahnhöfe/ÖPNV-Knoten/große Kreuzungen pro Zelle.",
     "source": "OSM"},
...
VULNERABILITIES: list[dict] = [
    ...
    {"code": "FINANCIAL_ADAPTATION_CAPACITY", "name": "Finanzielle Anpassungskapazität (invers)", "unit": "Index",
     ...
     "proxy": "Regionaler Annahmewert.", "source": "Annahme (kommunal)"},
    {"code": "INFRA_CRITICALITY", "name": "Kritikalität von Infrastrukturen", "unit": "Index",
     ...
     "proxy": "Dichte kritischer OSM-Infrastruktur pro Zelle.", "source": "OSM"},
    ...
    {"code": "LEVEE_CONDITION", "name": "Deichzustand (invers)", "unit": "Index",
     ...
     "proxy": "Regionaler Annahmewert; Küste/Flussufer.", "source": "Annahme"},
