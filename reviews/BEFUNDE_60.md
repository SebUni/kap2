...
Kurzform über alle bisher vergebenen Befundnummern (1–104). Art, Begründung und Vorschlag je Befund
stehen in den Befundtabellen von [Review-Runde 1](#review-runde-1) (Befunde 1–19),
[Review-Runde 2](#review-runde-2) (Befunde 20–46) und [Review-Runde 3](#review-runde-3)
(Befunde 47–104) weiter unten; der Wortlaut der Prüfausdrücke steht dort ebenfalls, diese Tabelle
nennt für die Befunde ab 20 nur, ob einer hinterlegt ist. Für die Befunde 47–104 (Ergänzung
T-0566) steht in dieser Kopftabelle ausschließlich die Kurzfassung aus Review-Runde 3; wo dort `offen`
steht, sind Umsetzungsnachweis und Prüfausdruck noch nicht vergeben. **Nachtrag T-0567 (23.09.2026):** 24, 57, 74 und 82 stehen auf `behoben`
(siehe [Autor-Revision T-0567](#autor-revision-t-0567-befunde-24-57-74-82)); die Überschrift zählt
deshalb 75 − 4 = 71. **Nachtrag T-0568 (23.09.2026):** 25, 54, 55, 56, 75 und 95 stehen auf `behoben`
(siehe [Autor-Revision T-0568](#autor-revision-t-0568-befunde-25-54-55-56-75-95)); 25 war davor
`bewusst offen`, die übrigen fünf `offen` — die Überschrift zählt deshalb 71 − 6 = 65. **Nachtrag T-0569 (23.09.2026):** 12, 27, 38, 60, 70, 76 und 98
stehen auf `behoben` (siehe [Autor-Revision T-0569](#autor-revision-t-0569-befunde-12-27-38-60-70-76-98));
27 und 38 waren davor `bewusst offen`, die übrigen fünf `offen` — die Überschrift zählt deshalb 65 − 7 = 58.
**Nachtrag T-0570 (23.09.2026):** 58, 62 und 89 stehen auf `behoben` (siehe
[Autor-Revision T-0570](#autor-revision-t-0570-befunde-58-62-89)); alle drei waren davor `offen` —
die Überschrift zählt deshalb 58 − 3 = 55. Der Prüfausdruck zu 98 ist dort fortgeschrieben.
**Nachtrag T-0571 (23.09.2026):** 59, 91 und 94 stehen auf `behoben` (siehe
[Autor-Revision T-0571](#autor-revision-t-0571-befunde-59-91-94)); alle drei waren davor `offen` —
die Überschrift zählt deshalb 55 − 3 = 52.
**Nachtrag T-0573 (23.09.2026):** 53, 92, 93 und 100 stehen auf `behoben`, 41 bleibt `behoben` und
trägt jetzt einen eigenen Prüfausdruck (siehe
[Autor-Revision T-0573](#autor-revision-t-0573-befunde-41-53-92-93-100)); 53, 92, 93 und 100 waren
davor `offen` — die Überschrift zählt deshalb 52 − 4 = 48.
**Nachtrag T-0574 (23.09.2026):** 35, 61, 64, 96 und 97 stehen auf `behoben` (siehe
[Autor-Revision T-0574](#autor-revision-t-0574-befunde-35-61-64-96-97)); alle fünf waren davor
`offen` — die Überschrift zählt deshalb 48 − 5 = 43.
**Nachtrag T-0575 (23.09.2026):** 63 und 65 stehen auf `behoben` (siehe
[Autor-Revision T-0575](#autor-revision-t-0575-befunde-63-65)); beide waren davor `offen` —
die Überschrift zählt deshalb 43 − 2 = 41.
**Nachtrag T-0576 (23.09.2026):** 37 und 88 stehen auf `behoben` (siehe
[Autor-Revision T-0576](#autor-revision-t-0576-befunde-37-88)); beide waren davor `offen` —
die Überschrift zählt deshalb 41 − 2 = 39. Der Prüfausdruck zu 37 ist dort ersetzt.
**Nachtrag T-0577 (23.09.2026):** 66, 67, 68 und 79 stehen auf `behoben` (siehe
[Autor-Revision T-0577](#autor-revision-t-0577-befunde-66-67-68-79)); alle vier waren davor `offen` —
die Überschrift zählt deshalb 39 − 4 = 35. Der Prüfausdruck zu 19 ist dort fortgeschrieben.
**Nachtrag T-0578 (23.09.2026):** 83, 84, 85, 86 und 99 stehen auf `behoben` (siehe
[Autor-Revision T-0578](#autor-revision-t-0578-befunde-83-84-85-86-99)); alle fünf waren davor `offen` —
die Überschrift zählt deshalb 35 − 5 = 30. Der Prüfausdruck zu 15 ist dort fortgeschrieben.
**Nachtrag T-0579 (23.09.2026):** 21, 47, 48, 72 und 104 stehen auf `behoben`, 46 bleibt `behoben` und
trägt jetzt einen eigenen Prüfausdruck (siehe
[Autor-Revision T-0579](#autor-revision-t-0579-befunde-21-46-47-48-72-104)); 21 war davor
`bewusst offen`, die übrigen vier `offen` — die Überschrift zählt deshalb 30 − 5 = 25.
**Nachtrag T-0580 (23.09.2026):** 49 steht auf `behoben` (siehe
[Autor-Revision T-0580](#autor-revision-t-0580-befund-49)); 49 war davor `offen` — die Überschrift
zählt deshalb 25 − 1 = 24. Die Prüfausdrücke zu 47 und 48 sind dort fortgeschrieben.
**Nachtrag T-0581 (23.09.2026):** 29, 30, 31, 77, 78 und 90 stehen auf `behoben` (siehe
[Autor-Revision T-0581](#autor-revision-t-0581-befunde-29-30-31-77-78-90)); 29, 30 und 31 waren
davor `bewusst offen`, 77, 78 und 90 `offen` — die Überschrift zählt deshalb 24 − 6 = 18.
**Nachtrag T-0728 (23.09.2026):** 11 und 69 stehen auf `behoben` (siehe
[Autor-Revision T-0728](#autor-revision-t-0728-befunde-11-69)); beide waren davor `offen` —
die Überschrift zählt deshalb 18 − 2 = 16.
**Stand: nach der Befundregression Runde 3, Teile 1–8 (18.–21.09.2026; T-0565).** Der Status
übernimmt jetzt zusätzlich die Urteile „bestätigt geschlossen" und „zurückgefallen" der acht
Regressionsabschnitte für die Nummern 6, 13, 22, 36, 37 und 39 (Fundstellen:
[Befundregression Teil 1](#befundregression-teil-1-6-11-12-13),
[Befundregression Teil 2](#befundregression-teil-2-17-20-21-22),
[Befundregression Teil 6](#befundregression-teil-6-35-36-37-38) und
[Befundregression Teil 7](#befundregression-teil-7-39-40-41-42)): 6, 13, 36 und 39 stehen jetzt auf
`behoben`, 22 und 37 sind auf ihren vor der jeweiligen Regression zuletzt vergebenen Status `offen`
zurückgefallen. Urteile „unvollständig geschlossen" ändern die Statusspalte weiterhin nicht (das
Urteil steht in der Nachweisspalte), sind aber, wo daraus ein neuer Befund hervorging, in der
Begründungsspalte auf dessen Nummer verwiesen (34 → Befund 91, 40 → Befund 99 und Befund 100,
41 → Befund 100, 46 → Befund 104). Für alle übrigen Nummern bleibt der jeweils letzte in den
Abschnitten der Runden 1 und 2 einschließlich
[Autor-Revision nach Runde 2](#autor-revision-nach-runde-2) vergebene Status unverändert. Gezählt
sind in der Überschrift die Zeilen mit Status `offen` oder `bewusst offen` (6 + 11 = 17 aus den
Befunden 1–46, plus 58 neu ergänzte Befunde 47–104, alle `offen` = 75; Stand nach der
Befundregression Runde 3, Teile 1–8, 21.09.2026, und der Ergänzung T-0566). Wo ein Umsetzungsnachweis steht, der Befund
aber auf `offen` bleibt, hat die jeweilige Regression die Statusspalte ausdrücklich nicht
fortgeschrieben; ihr Urteil steht in der Nachweisspalte.
...
| 6 | Bericht Kap. 1 Weitergaben Z. 86 gegen `KWRA-Monetarisierung.xlsx` Blatt „Schadenskonten-System" Z29 · **Lücke** — K3-Buchungsobjekt #37 fehlt vollständig, #12 ohne Partitionsregel-Zitat | B | behoben | Urteil der Befundregression Runde 3, Teil 1: **bestätigt geschlossen**, am heutigen Berichtsstand neu erhoben (Urteil der Runde 2 nicht übernommen). Bericht Kap. 1, Abschnitt „Weitergaben", Z. 120: #37 steht mit Kante 49 → 37 (Abgleich-Protokoll Punkt 3, Zeile 7) und #12 steht mit R9-Partitionszitat (Rechenregeln C11) in der Liste der Partitionsregel-Zitate; beide Zitate in der Regression im Original gegen `KWRA-Monetarisierung.xlsx` gelesen. | — | Vorschlag in Runde 1 |
...
| 11 | Bericht Kap. 8 Z. 336–351 · **Lücke** — keine einzige Quelle mit DOI/URL, Zugriffsdatum und Archiv-Snapshot (0 Treffer „http") | B | behoben | Urteil der Regression Runde 3, Teil 1 (Befundregression Teil 1): der einzig verbliebene Rest ist als Befund 69 ausgegliedert; mit dessen Behebung (siehe [Autor-Revision T-0728](#autor-revision-t-0728-befunde-11-69)) ist Befund 11 vollständig erfüllt. Bericht Kap. 8 „Quellen (§3.8)": alle drei Quellen tragen Vollzitat samt DOI/URL bzw. bei den beiden Arbeitsmappen Dateistand (Commit-Hash, Datum) und Prüfsumme (SHA-256), je mit Zugriffsdatum, die Hochwasserschutzfibel (Quelle 3) ist mit Vollzitat, URL, Archiv-Snapshot und Zugriffsdatum wörtlich aus `backend/app/data/sources.py` übernommen, ohne diese Datei zu ändern, und die Fundstellenliste von Quelle 1 deckt jetzt auch die tragende Zeile Z272 ab. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 8 ')[1].split(chr(10)+'## 9 ')[0];h=k.count('http')>=3;q1=s.split(chr(10)+'1. **KWRA-Schadensbaum')[1].split(chr(10)+'2. **KWRA-Monetarisierung')[0];r=('Z3–Z272' in q1) and ('Z271' not in q1);raise SystemExit(0 if (h and r) else 1)"` | Vorschlag in Runde 1; Rest per Befund 69 behoben |
| 12 | Bericht Kap. 1 „Konto-Einbettung" Z. 90–100 · **Lücke** — kein Kostensatz, kein Preisstand; R5 (Versicherung = Transfer) nicht nachgezogen | B | behoben | Autor-Revision T-0569 (siehe [Autor-Revision T-0569](#autor-revision-t-0569-befunde-12-27-38-60-70-76-98)): der in den Regressionen der Runden 2 und 3 offene Rest ist die Preisstand-Seite (Befund 70) — Bericht Kap. 1 „Konto-Einbettung“ führt das Preisstandjahr 2026 jetzt als „abgeleitet aus Register 60-R24-01“, der überholte Bedingungssatz ist durch den Vermerk ersetzt, dass der K3-eigene Kostensatz vorliegt und der Ersetzungspfad eingelöst ist; §3.9 ABGESCHÄTZT ist auf den Fortschreibungsfaktor 2023 → 2026 eingegrenzt. Kostensatz-Typ (Entscheidungslog Nr. 7) und R5 („übernommen“) standen bereits. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('### Konto-Einbettung')[1].split('### ')[0];raise SystemExit(0 if 'Preisstandjahr (abgeleitet aus Register 60-R24-01)' in k and 'Bis ein K3-eigener Kostensatz' not in k and 'Rechenregeln:** R5 (übernommen)' in k else 1)"` | Vorschlag umgesetzt, Status vorher `offen`. |
| 13 | Bericht Kap. 1 Z. 35–36 gegen `backend/app/data/catalog.py` Z. 335–340 · **Fehler** — Behauptung „trägt genau die Namenslisten von W117" ist falsch (5 statt 7 Sensitivitäten, 5 statt 8 Wirkungs-Eingänge) | B | behoben | Urteil der Befundregression Runde 3, Teil 1: **bestätigt geschlossen**, am heutigen Berichtsstand neu erhoben (Urteil der Runde 2 nicht übernommen). Bericht Kap. 1, Absatz „W-Knoten" Z. 53–54: die Behauptung ist auf den belegbaren Stand korrigiert (Code trägt nur eine Teilmenge mit abweichender Namensquelle, fünf statt sieben Sensitivitäten, fünf statt acht Wirkungs-Eingänge — gegen `catalog.py` Z. 338/339 und die Arbeitsmappe F272/H272 nachgerechnet) und die Divergenz ist als Integrationspunkt für `/integriere-risiko 60` ins Entscheidungslog (Nr. 6) gezogen; `backend/app/data/catalog.py` bleibt dabei unverändert (eiserne Regel 5). | — | Vorschlag in Runde 1 |
...
| 21 | Bericht Kap. 1 Knoten-Bilanz, Spalte „Name" (S074, W100, S092) gegen KWK B199/B223/B256 · **Fehler** — drei Knotennamen ohne Kürzungszeichen verkürzt | C | behoben | Autor-Revision T-0579 (siehe [Autor-Revision T-0579](#autor-revision-t-0579-befunde-21-46-47-48-72-104)): Die drei Namen der Knoten-Bilanz stehen jetzt wörtlich nach der Arbeitsmappe: S074 „Topographie (Geländeform, Höhe, etc.)“ (B199), W100 „Einschränkungen der Funktionsfähigkeit von Kanalnetzen und Vorflutern“ (B223), S092 „Bauliche, organisatorische und finanzielle Vorsorge der Eigentümer und Nutzer von Gebäuden und Infrastrukturen“ (B256); alle 32 Namen der Bilanz stimmen mit Spalte B der genannten KWK-Zeile überein. | `python3 -c "import openpyxl,re;P=chr(124);s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split(P.join(['',' Knoten ',' Name ',' Blatt/Zeile ',' rechnet in ','']))[1].split(chr(10)+chr(10))[0];rows=[[c.strip() for c in z.strip().strip(P).split(P)] for z in t.split(chr(10)) if z.strip().startswith(P)][1:];wb=openpyxl.load_workbook('docs/Schadensbaum/KWRA-Schadensbaum_X_UBA-klimawirkungsketten.xlsx',read_only=True,data_only=True);k=list(wb['Klimawirkungsketten'].iter_rows(values_only=True));rx=r'\s*\(('+P.join(['über W085',r'= Id \d+',r'direkt[^)]*'])+r')\)\s*$';bad=[r[0] for r in rows if re.sub(rx,'',r[1]).strip()!=k[int(re.search(r'KWK Z(\d+)',r[2]).group(1))-1][1]];raise SystemExit(0 if len(rows)==32 and not bad else 1)"` | Runde 1 bewusst offen (Kategorie C); nachgezogen T-0579. Prüfausdruck gegenüber Runde 1 fortgeschrieben (ohne Pipe-Zeichen, verlangt zusätzlich alle 32 Zeilen). |
| 22 | Bericht Kopf und Abschnitt „Ergebnis" gegen den Ist-Stand · **Widerspruch** — Kopf führt „Erstaufschlag, noch nicht gegengeprüft" und einen überholten Geltungsbereich | B | offen | Urteil der Befundregression Runde 3, Teil 2: **zurückgefallen** — der Nachzug vom 17.09.2026 (T-0245) ist belegt, aber die vom Befund beschriebene Lage ist am 18.09.2026 durch sechs weitere Revisionspakete erneut eingetreten (Kopf/„Ergebnis" nennen weiter Runde 2, während Runde 3 läuft), und der Satz „Gegenprüfung … noch nicht gemessen" (Z. 37) war nie geschlossen. → neuer Befund 73. | — | Der vorgeschlagene Lint-Check gehört laut Befund zu T-0234 und war hier nicht Gegenstand. |
...
| 24 | Bericht §3.1 „Physischer Teil-Ausweis" (\(\text{EAD} = \bar A \cdot w\)) gegen §3.5/§3.6 · **Fehler** — Gleichung ohne Indizierung: auf der Zelle exakt, auf der Kommune nur als Summe | C | behoben | Bericht §3.1, Aufzählungspunkt „Physischer Teil-Ausweis (Zwischengröße vor dem Euro)": die indexfreie Gleichung ist auf die Zelle indiziert (\(\text{EAD}_z = \bar A_z \cdot w_z\)), für die Kommune steht die Summe \(\text{EAD}_k = \sum_{z \in k} \bar A_z \cdot w_z\) mit Verweis auf §3.6; §3.5, \(\bar A\)-Zeile, nennt dieselbe Unterscheidung (T-0567, siehe [Autor-Revision T-0567](#autor-revision-t-0567-befunde-24-57-74-82)). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('\n### 3.1 ')[1].split('\n### 3.2 ')[0];raise SystemExit(0 if 'EAD}_z = ' in k and 'EAD}_k = ' in k and 'EAD} = ' not in k else 1)"` | Vorschlag in Runde 2 umgesetzt; der Status „bewusst offen" ist aufgehoben (Regression Runde 3 → Befund 74). Der Prüfausdruck der Runde 2 (Abschn. 1.2) belegt das Gegenbeispiel und endet weiter mit 0. |
| 25 | Bericht §3.5 und §5.1.1 gegen §5.1.2/§5.1.3 · **Lücke** — vier Formelzeichen ohne Zeile in der Zeichentabelle, die Vollständigkeit beansprucht | C | behoben | Autor-Revision T-0568 (siehe [Autor-Revision T-0568](#autor-revision-t-0568-befunde-25-54-55-56-75-95)): Bericht §3.5 führt jetzt \(q_0\) (Herkunft `herleitung: §4.7` — geparkt, Datenquelle fehlt) und die Szenariobeiträge der Beispielrechnung als \(\tau_1\)…\(\tau_3\) (m²/a, `herleitung:#s-bem-naeherung`); §5.1.3 heißt sie ebenfalls \(\tau_i\), so dass \(t\) allein den Gebäudetyp bezeichnet. Der frühere Status „bewusst offen" ist aufgehoben. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('\n### 3.5 ')[1].split('\n### 3.6 ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];k5=s.split('\n## 5 ')[1].split('\n## 6 ')[0];q=[c for c in r if c[0].startswith(chr(92)+'(q_0')];u=[c for c in r if 'tau_' in c[0]];raise SystemExit(0 if q and 'geparkt' in q[0][3] and u and not any(x in k5 for x in ('t_1','t_2','t_3')) else 1)"` | Vorher bewusst offen (Kategorie C); mit der Aufnahme der vier Zeilen entfällt der Grund. |
...
| 27 | Bericht Kap. 2, Registerzeile 60-R24-01 und Langbeleg B4 · **Fehler/Lücke** — Jahresraten 3,4 %/2,3 % der Fortschreibung ohne Herleitung, Bandende gerundet | C | behoben | Autor-Revision T-0569 (siehe [Autor-Revision T-0569](#autor-revision-t-0569-befunde-12-27-38-60-70-76-98)): (a) B4 Rechenschritt 2 weist 3,4 % und 2,3 % als gerundete Setzungen von KAP3 aus (Median 3,3 % ⇒ 1,033³ = 1,102, Mittel 3,83 % ⇒ 1,0383³ = 1,119 der zitierten Werte; Wirkung −0,2 %/+1,3 % gegenüber 1,105), belegt ist nur 5,0 %; (b) Bandenden mit den ungerundeten Faktoren 1,0706/1,1576: 1.890–2.043 bzw. 1.485–1.606 €₂₀₂₆/m² BGF (Registerzeile, Spiegel `docs/evidenz/register.md`, §3.4, §4.3, Kap. 7); (c) Registerzeile und B4 trennen Typ-Spanne 1.993 (MFH) bis 2.535 (EFH/ZFH) und Unsicherheitsband 1.856–2.860 €₂₀₂₆/m², Bestand 7,6–11,7 Bio. €₂₀₂₆. Nachgezogen: \(M_0\)-Band 0,657–2,638. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();r=[l for l in s.split(chr(10)) if l.startswith(chr(124)+' 60-R24-01 ')][0];b=s.split('**Rechenschritt 2 ')[1].split('**B5 ')[0];raise SystemExit(0 if ('1.890–2.043' in r and '1.485–1.606' in r and '1.993 (MFH) bis 2.535 (EFH/ZFH)' in r and '1.856–2.860' in r and 'gerundete Setzungen von KAP3' in b and '1.889–2.047' not in s and round(1765*1.05**3)==2043) else 1)"` | Vorschlag umgesetzt, Status vorher `bewusst offen`. |
...
| 29 | Bericht Kap. 2, Registerzeile 60-S092-01, Spalte Studientyp, gegen Langbeleg B5 · **Widerspruch** — Begründung des Verzichts auf eine Effektgröße widerspricht dem Langbeleg | C | behoben | Autor-Revision T-0581 (siehe [Autor-Revision T-0581](#autor-revision-t-0581-befunde-29-30-31-77-78-90)): Registerzeile 60-S092-01, Spalte Studientyp: „im Volltext nicht verifiziert“ ist ersetzt durch Thieken u. a. 2008 als volltextgeprüfte, nach §3.5 als Wertquelle nicht zulässige Befragungsevidenz (Langbeleg B5, Tab. 2); dieselbe falsche Aussage in §5.1 „Anlass“ ist mitgezogen. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-S092-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;raise SystemExit(0 if 'Thieken u. a. 2008' in c[4] and '**volltextgeprüft**' in c[4] and 'nach §3.5 als Wertquelle aber **nicht zulässig**' in c[4] and 'nicht verifiziert' not in c[4] and 'nicht im Volltext verifiziert' not in s else 1)"` | Vorschlag in Runde 2; umgesetzt T-0581 |
| 30 | Bericht Kap. 2, Registerzeile 60-S093-01, gegen §3.3 Stützstellentabelle · **Lücke** — Typstruktur der zitierten Schadensfunktion nicht durchgezogen | C | behoben | Autor-Revision T-0581 (siehe [Autor-Revision T-0581](#autor-revision-t-0581-befunde-29-30-31-77-78-90)): Registerzeile 60-S093-01, Spalte Übertragbarkeit/Modellgrenzen: neue Modellgrenze (d) „Typstruktur“ — \(d(h)\) typunabhängig, Gebäudetyp rechnet nur im Preis, Verweis auf §3.3; Spiegel in `docs/evidenz/register.md` nachgezogen. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();r=open('docs/evidenz/register.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-S093-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;y=[l for l in r.split(chr(10)) if l.startswith(P+' 60-S093-01 ')];raise SystemExit(0 if '(d) **Typstruktur:**' in c[6] and 'typunabhängig' in c[6] and 'in §3.3' in c[6] and len(y)==1 and '(d) **Typstruktur:**' in y[0] else 1)"` | Vorschlag in Runde 2; umgesetzt T-0581 |
| 31 | Bericht Kap. 2, Registerzeile 60-W085-01, gegen §3.4 Schritt 2 · **Lücke** — \(p_3\) fehlt in der Registerzeile, obwohl es in der Formel rechnet | C | behoben | Autor-Revision T-0581 (siehe [Autor-Revision T-0581](#autor-revision-t-0581-befunde-29-30-31-77-78-90)): Registerzeile 60-W085-01, Spalte Effektgröße: Zentralwert HQextrem \(p_3\) = 2,236·10⁻³ a⁻¹ (§3.9 Abgeschätzt, geometrisches Mittel der Bandenden, Herleitung §3.4 Schritt 2); in B1 der Rechenschritt ergänzt; Spiegel in `docs/evidenz/register.md` nachgezogen. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();r=open('docs/evidenz/register.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-W085-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;b1=s.split('**B1 — 60-W085-01')[1].split('**B2 — ')[0];y=[l for l in r.split(chr(10)) if l.startswith(P+' 60-W085-01 ')];raise SystemExit(0 if '= 2,236·10⁻³ a⁻¹** (T ≈ 447 a; §3.9 Abgeschätzt, geometrisches Mittel der Bandenden' in c[3] and 'Zentralwert' in b1 and '2,236·10⁻³ a⁻¹' in b1 and len(y)==1 and '2,236·10⁻³' in y[0] else 1)"` | Vorschlag in Runde 2; umgesetzt T-0581 |
...
| 34 | Bericht §4.1, §4.2, §4.4 und §4.5 · **Lücke** — \(\lambda\) nicht über die Anker-Zeitreihe gefittet, keine Jahres-Auswahlregel, keine Sensitivität je Zeitfenster | A | behoben | \(A_{\text{ver}}\) = 1,838 Mrd. € als Kleinste-Quadrate-Mittel der vollständigen Reihe 2002–2024, \(A^{*}\) = 1,132 Mrd. €₂₀₂₆/a, \(\lambda\) = 0,832 (Band 0,22–1,66 aus dem Tukey-Fence-Test — **abgelöst:** das Band 0,22–1,66 ist mit der vollständigen Bandfortpflanzung in §4.4 durch 0,11–3,44 (Befund 36) ersetzt, dann durch 0,11–3,49 (T-0569, Befund 98) und mit dem typgewichteten Wertsatz durch 0,12–3,93, \(\lambda\) durch 0,911 (T-0570); der Tukey-Fence liefert nach §4.1a das Band von \(A_{\text{ver}}\), nicht von \(\lambda\); Vermerk T-0571, Befund 91), Sensitivität über vier Fenster; Fundstellen §4.1, §4.2, §4.4, Kap. 7 (`flood_bldg.lambda`, `wert: 0.832`), §7.2 und Entscheidungslog Nr. 8 (Rechenweg T-0315, Nachzug T-0318/T-0319, Beleg T-0321). | vorhanden (Wortlaut: Runde 2, Abschn. 3.3) | Die Befundtabelle der Runde 2 führt den Befund als Kategorie B, die Statuszeile der Autor-Revision (T-0321) als A; hier steht die zuletzt vergebene Kategorie. Die Befundregression Runde 3, Teil 5, hat den fortbestehenden Ledger-Rest (abgelöstes λ-Band 0,22–1,66 in der Übersichtstabelle und in Z. 1759) als **Befund 91** verbucht; der Status von 34 selbst bleibt unberührt. |
| 35 | Bericht §4.6 · **Fehler** — Untergrenze des Sanity-Bandes zirkulär, Obergrenze keine echte Schranke | B | behoben | Bericht §4.6 (Tabelle, „Weitung ausgewiesen und fixiert“, „Ausnahme vom Amtlichkeitsgebot“): Untergrenze \(U\) = 0,189 Mrd. €₂₀₂₆/a aus beiden amtlichen Fondsvolumina 2013/2021 auf das Ankerfenster 2002–2024 (keine Anker- und keine Registergröße), unabhängige Obergrenze \(O_u\) = 11,04 Mrd. €₂₀₂₆/a aus dem Fondsvolumen 2021, klassengerechte Bestandsschranke 6,29 als Modellschranke daneben; Band [0,189; 11,04] vorab fixiert; Block `beispiel_60_kalibrierung` — siehe [Autor-Revision T-0574](#autor-revision-t-0574-befunde-35-61-64-96-97) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.6 ')[1].split(chr(10)+'### 4.7 ')[0];ok=all(x in k for x in ('**0,189 Mrd. €₂₀₂₆/a**','**11,04 Mrd. €₂₀₂₆/a**','Keine der sechs Ankergrößen','Amtlichkeitsgebot','1,132','Die frühere Wiederkehrzeit')) and 'E_fonds = E_2013 + E_2021' in s and 'assert U <= lam * M0 <= O_u' in s and abs((8*1.02**13+30*1.02**5)/9*0.9/23-0.189)<5e-4;raise SystemExit(0 if ok else 1)"` | Rest aus Regression Teil 6 (Weitung, → Befund 96) mit T-0574 behoben. |
| 36 | Bericht §4.4 „Plausibilitätsschranke" gegen §4.4 Band und §4.8 · **Widerspruch/Lücke** — Schranke 0,50/2,00 ohne Herleitung und nicht in der P1-Tabelle | B | behoben | Urteil der Befundregression Runde 3, Teil 6: **bestätigt geschlossen**, am heutigen Berichtsstand neu erhoben. Die gesetzte Schranke 0,50/2,00 existiert nicht mehr; §4.4 Z. 1240–1258 leitet [0,11; 3,44] vollständig aus dem fortgepflanzten Band von \(A^{*}\) (§4.2) und \(M_0\) (§4.3) her und weist die Geltung ausdrücklich auf den Zentralwert beschränkt aus; §4.8 führt die Schranke mit Wert. | vorhanden (Wortlaut: Runde 2, Abschn. 3.3) | Die Übersichtstabelle Z. 61 und die Statuszeile Z. 991 des Berichts führen 36 laut Regression weiter als „offen"; das Ledger übernimmt hier das am heutigen Stand bestätigte Urteil. |
| 37 | Bericht §4.8 Parametertabelle gegen §4.2, §4.4, §4.5, §4.6 · **Lücke** — drei in Kapitel 4 rechnende Werte fehlen in der P1-Tabelle | B | behoben | Bericht §4.8: jede in Kapitel 4 rechnende Größe hat eine eigene Zeile mit Wert, Band und Kennzeichnung — neu \(M_0\) (berechnet, mit den einfließenden Abschätzungen), Wohnfläche je Wohngebäude, \(k_{\text{BGF}}\), beide Wertsätze, Wert je exponiertem Wohngebäude, Wohngebäudeanteil je Adresse, Adresszahlen, beide Klassenraten, Fortschreibungsrate der Fondsvolumina (Abschätzung von KAP3 mit Sensitivität), Gebäudewert 527.280 € und gedeckelte Schadensquote 0,250 (nur \(O_M\)); bei \(\lambda\) und \(U\) sind die einfließenden Abschätzungen ergänzt — siehe [Autor-Revision T-0576](#autor-revision-t-0576-befunde-37-88) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split(chr(10)+'### 4.8 ')[1].split(chr(96)*3+'python')[0];r=[[c.strip() for c in z.split(chr(124))[1:-1]] for z in t.split(chr(10)) if z.startswith(chr(124)+' ') and not z.startswith(chr(124)+' Parameter')];w=('1,838 Mrd.','0,65 (','1,54 (','0,50 (','1,15 (','1,07 (','3 % (','1,243 Mrd.','208 m²','1,30 (','1.950 €','1.533 €','0,596 (','481.726,25 €','0,872 (','339.000 bzw. 1.380.000','0,0059796 a','0,00067515 a','8 und 30 Mrd.','2 %/a','0,11 (','0,90 (','23 a','0,189 Mrd.','11,04 Mrd.','6,29 Mrd.','527.280 €','0,250','0,5 bzw. 2,0','0,1 a');k=('**Quelle','**Abschätzung von KAP3','**berechnet','**gezählt');ok=all(len(x)==3 for x in r) and all(any(x[1].startswith(v) and any(q in x[2] for q in k) for x in r) for v in w);raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 2. Nachtrag T-0574: Die in Runde 2 geführte Zeile „Betroffenheit exponierter Gebäude“ ist mit der §4.6-Neufassung durch „Klassenraten Bestandsschranke“ abgelöst; die rechnenden Abschätzungen der Untergrenze stehen seit T-0574 als eigene Zeilen in §4.8 (Befund 97), der Status von 37 ist hier nicht fortgeschrieben. Nachtrag T-0576: Status `behoben`; der Prüfausdruck aus Runde 2 ist ersetzt, weil die Durchsicht der Prüfausdrücke ihn als untauglich einstufte (er fragt nur die Namen der drei damals fehlenden Zeilen ab) — der neue prüft je rechnendem Wert von Kapitel 4 eine eigene Zeile mit Kennzeichnung. |
| 38 | Bericht §4.2 Zeile \(\pi\) und §4.8 · **Fehler** — Bandenden von \(\pi\) falsch gerundet | C | behoben | Autor-Revision T-0569 (siehe [Autor-Revision T-0569](#autor-revision-t-0569-befunde-12-27-38-60-70-76-98)): \(\pi\)-Band aus dem ungerundeten B4-Band gerechnet, 1,0706/1,03 = 1,039 bis 1,1576/1,03 = 1,124 (§4.2 Tabelle und Herleitung, §4.8, Block `flood_bldg.pi`); \(A^{*}\)-Band 0,296–2,291, Zusicherungen im Block `beispiel_60_kalibrierung` auf die neuen Enden gezogen (der Block rechnet jetzt mit 1,124, nicht mit der eigenen Rundung). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 4 ')[1].split(chr(10)+'## 5 ')[0];raise SystemExit(0 if ('1,04–1,11' not in k and k.count('1,07 (1,039–1,124)')==2 and '* 1.124' in k and round(1.05**3/1.03,3)==1.124) else 1)"` | Vorschlag umgesetzt, Status vorher `bewusst offen`. |
| 39 | Bericht §4.7 „Wächter" gegen §4.4 und §5.1.2 · **Lücke** — Referenzzustand ist der Stichtag 31.12.2024 statt des gewichteten Ausstattungsmittels | B | behoben | Urteil der Befundregression Runde 3, Teil 7: **bestätigt geschlossen**, am heutigen Berichtsstand neu erhoben. Die Autor-Revision (Z. 1803, nach der Statuszeile dieses Punkts eigentlich noch offen geführt) hat den Referenzzustand tatsächlich auf das über die 23 Kalibrierjahre gleichgewichtete Ausstattungsmittel umgestellt (§4.7 Z. 1394–1410) und die Verfallsregel entsprechend ausgerechnet; „Ausstattungsstand 31.12.2024" kommt im Bericht nicht mehr vor. | vorhanden (Wortlaut: Runde 2, Abschn. 3.3) | Die Übersichtstabelle Z. 64 und die Statuszeile Z. 994 des Berichts führen 39 laut Regression weiter als „offen"; das Ledger übernimmt hier das am heutigen Stand bestätigte Urteil. |
| 40 | Bericht Kap. 7 gegen §3.4, §3.5, §4.2/§4.8 · **Lücke** — Parameter-Blöcke nur für den Hebel aus §5.1, Kostensätze ohne Block und ohne `preisstand` | A | behoben | Bericht Kap. 7: 18 neue Parameter-Blöcke (darunter `flood_bldg.n_efh_zfh` und `flood_bldg.n_mfh` mit `preisstand: 2026` und `umrechnungsfaktor: 1.8578`), vier Herleitungsanker (`#tiefen-schadensfunktion`, `#kernformel-zelle`, `#kalibrierung-zielwert`, `#niveau-skalar`), ersetzter Einleitungssatz und §3.5-Zeile \(n_t\) mit Umrechnungsfaktor (T-0245). | vorhanden (Wortlaut: Runde 2, Abschn. 4.3) | Mit Integrationsvermerk geschlossen: die Extraktion der Blöcke in die Produkt-Registry gehört zur Integration (P-N), nicht zu diesem Berichtsschritt. Die Befundregression Runde 3, Teil 7, hat den fortbestehenden Rest dieses Pakets — acht rechnende §4.8-Parameter ohne eigenen Block — als **Befund 99** verbucht (Kap. 7, Nachbarbefund 41 desselben Pakets); die dort ebenfalls im selben Regressionspaket erhobene, auf einem überholten Anker rechnende Ergebnis-Sensitivität in §7.2 (Rest von Befund 41) ist als **Befund 100** verbucht. Der Status von 40 selbst bleibt unberührt. |
| 41 | Bericht Langbeleg B4 und §3.4 gegen `KWRA-Monetarisierung.xlsx` J64/J65 und C27 · **Widerspruch** — Neuwertansatz, obwohl die Mappe den Zeitwertansatz vorschreibt | B | behoben | Bericht §7.2 „Antrag auf Fortschreibung der Arbeitsmappe: Neuwert statt Zeitwertansatz" (Anker `#fortschreibung-neuwert-k3`, 17.09.2026): Neuwert bleibt Basiswert, Alterswertminderung \(f_{\text{AWM}}\) = 0,55 (Band 0,40–0,75, Abschätzung von KAP3 nach § 38 ImmoWertV), Untergrenzen-Aussage als Modellgrenze 9 in Kap. 6; nachgezogen in Kap. 1, Register 60-R24-01, B4, §3.4, §4.8, Versionsstempel und Entscheidungslog Nr. 7 (T-0285). Ergebnis-Sensitivität seit T-0573 auf dem geltenden Anker: K3-Betrag 0,62 (0,45–0,85) statt 1,13 Mrd. €₂₀₂₆/a in §7.2 und §4.8 — siehe [Autor-Revision T-0573](#autor-revision-t-0573-befunde-41-53-92-93-100) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();p=[z for z in s.split('\n### 4.8 ')[1].split('\n## 5 ')[0].split('\n') if 'Alterswertminderungsfaktor (Zeitwertansatz, nur Sensitivität)' in z];ok=len(p)==1 and 'fortschreibung-neuwert-k3' in s and '0,55 (0,40–0,75)' in p[0] and '0,62 (0,45–0,85) statt 1,13 Mrd.' in p[0] and '0,99' not in s and '0,54' not in p[0];raise SystemExit(0 if ok else 1)"` | Anders umgesetzt als vorgeschlagen: Der Zeitwertansatz wird nicht übernommen, sondern als Antrag auf Fortschreibung der Mappe geführt (eiserne Regel 2: Arbeitsmappen nie still überstimmen). Die Befundregression Runde 3, Teil 7, hat den Rest — die Ergebnis-Sensitivität in §7.2 rechnete noch auf dem abgelösten Anker 1,6 statt 1,838 — als **Befund 100** verbucht; 100 ist mit T-0573 behoben, der Prüfausdruck hier bindet den nachgezogenen Stand. |
...
| 46 | Bericht Kap. 1 Knoten-Bilanz, Zeilen S074 und R17, gegen §3.2 „Kein-Doppelkanal" · **Widerspruch** — Verarbeitung an einer Formelstelle FS-Exposition, die das Modell ausschließt | B | behoben | Autor-Revision T-0579 (siehe [Autor-Revision T-0579](#autor-revision-t-0579-befunde-21-46-47-48-72-104)): Rest nach der Befundregression (Befund 104, Präambel Befund 48) mit nachgezogen: Präambel führt FS-Exposition nicht mehr als Formelstelle, sondern als aufgehoben (Kein-Doppelkanal §3.2); Langbeleg B2 ordnet S074 keiner eigenen Formelstelle zu; die Zeilen S074/R17 bleiben „Sensitivitätsband … keine eigene Formelstelle“. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k1=s.split(chr(10)+'## 1 ')[1].split(chr(10)+'## 2 ')[0];v=k1.split('### Knoten-Bilanz')[1].split(chr(10)+P)[0];z=[l for l in k1.split(chr(10)) if l.startswith(P+' S074 ') or l.startswith(P+' R17 ')];raise SystemExit(0 if len(z)==2 and all('**Sensitivitätsband**' in l and 'keine eigene Formelstelle' in l for l in z) and '**FS-Exposition**' not in s and 'Formelstelle FS-Exposition zugeordnet' not in s and 'ist'+chr(10)+'**aufgehoben**' in v else 1)"` | Vorschlag in Runde 2; behoben T-0245; Rest (Befund 104, Präambel) nachgezogen T-0579, eigener Prüfausdruck T-0579. |
| 47 | Bericht Kap. 1, Knoten-Bilanz Z. 107 (Knoten S104, KWK A268/B268), Spalte „rechnet in" = FS-Bestandsdynamik, gegen Kap. 6 Z. 1790–1798 und… · **Widerspruch/Lücke** — Die Bilanz weist S104 als verarbeitet aus und nennt Kapitel 6 als Einlösestelle. | B | behoben | Autor-Revision T-0579 (siehe [Autor-Revision T-0579](#autor-revision-t-0579-befunde-21-46-47-48-72-104)): Bilanzzeile S104 steht auf „inaktiv (geparkt: Formelstelle FS-Bestandsdynamik ohne Term, Registerzeile 60-S104-01 offen)“ mit Zitat der Kap.-6-Stelle („im heutigen Modellstand nicht als eigener Pfad ein“, R24 konstant); die Präambel führt FS-Bestandsdynamik als „in dieser Fassung inaktiv, geparkt“. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k1=s.split(chr(10)+'## 1 ')[1].split(chr(10)+'## 2 ')[0];z=[l for l in k1.split(chr(10)) if l.startswith(P+' S104 ')];c=[x.strip() for x in z[0].split(P)] if len(z)==1 else ['']*6;k6=s.split(chr(10)+'## 6 ')[1].split(chr(10)+'## 7 ')[0];raise SystemExit(0 if c[4].startswith('**inaktiv (geparkt: Formelstelle FS-Bestandsdynamik ohne Term, Registerzeile 60-S104-01 bewusst inaktiv)**') and 'im heutigen Modellstand **nicht** als eigener Pfad ein' in c[4] and 'Modellstand **nicht** als eigener Pfad ein' in k6 and '60-S104-01' in k6 else 1)"` | Vorschlag in Runde 3; umgesetzt T-0579; Prüfausdruck fortgeschrieben T-0580 |
| 48 | Bericht Kap. 1, Präambel der Knoten-Bilanz Z. 69–74 („Benannte Formelstellen: … FS-Exposition (Wassertiefe am Gebäude) …"), gegen die… · **Widerspruch** — Nach der Revision bindet keine Zeile der Bilanz mehr an FS-Exposition, und im Modell kommt die Formelstelle nicht vor; die Präambel führt sie gleichwohl weiter als eine der sieben Stellen, „an die Kapitel 3 die Größe künftig bindet" (gemessen: fünf der sieben… | C | behoben | Autor-Revision T-0579 (siehe [Autor-Revision T-0579](#autor-revision-t-0579-befunde-21-46-47-48-72-104)): Präambel der Knoten-Bilanz nennt sechs statt sieben benannte Formelstellen; FS-Exposition ist als „frühere siebte Formelstelle … aufgehoben“ mit Begründung (Kapitel 3 kennt sie nicht, S074/R17 nur Sensitivitätsband über FS-Hazard) geführt; jede der sechs Formelstellen kommt in einer Bilanzzeile vor. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);v=s.split('### Knoten-Bilanz')[1].split(chr(10)+P)[0];b=s.split('### Knoten-Bilanz')[1].split(chr(10)+chr(10)+'KWK = ')[0];fs=[x for x in ('FS-Hazard','FS-Schadensgrad','FS-Mengengerüst','FS-Schutzsystem','FS-Bestandsdynamik','FS-Vorsorge') if '**'+x+'**' in v];raise SystemExit(0 if 'sechs benannten' in v and 'sieben benannten' not in v and len(fs)==6 and '**FS-Exposition**' not in v and 'siebte Formelstelle FS-Exposition' in v and v.count('**in dieser Fassung inaktiv')==2 and'inaktiv,'+chr(10)+'geparkt**: Registerzeile 60-S104-01 ist bewusst inaktiv (geparkt)' in v and all(x in b.split(chr(10)+P,1)[1] for x in fs) else 1)"` | Vorschlag in Runde 3; umgesetzt T-0579; Prüfausdruck fortgeschrieben T-0580 |
| 49 | Bericht Kap. 2 Teil A, Registertabelle Z. 165–195, Spalte „Entscheidung": 25 der 32 Zeilen tragen `offen` — Z. 165–169 (60-E12-01… · **Lücke/Widerspruch** — `offen` ist keine der vier zulässigen Entscheidungen. Für die 19 Knoten, die Kapitel 1 begründet inaktiv führt (E02, E03, E10, E14, E17, R18, R19, R23, R25, S096, S097, S098, W006, W008, W074, W077, W087, W091, W100), existiert die Begründung bereits wörtlich… | B | behoben | Autor-Revision T-0580 (siehe [Autor-Revision T-0580](#autor-revision-t-0580-befund-49)): alle 25 Registerzeilen ohne Entscheidung tragen jetzt „bewusst inaktiv“ mit derselben Begründung samt Zitat wie ihr Knoten in der Knoten-Bilanz (Kap. 1); E07, E08, E12, S072, S073 als „im Hazard-Datensatz enthalten, Kein-Doppelkanal §3.2“, S096–S098 und S104 als geparkt; Evidenzspalten „entfällt — kein Rechenpfad“; Spiegel in `docs/evidenz/register.md` nachgezogen. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-')];n=sum(1 for l in z if 'offen' in l.split(P)[8]);print(len(z),n);raise SystemExit(0 if len(z)==32 and n==0 else n or 99)"` | Vorschlag in Runde 3; umgesetzt T-0580 |
| 50 | Bericht Kap. 8, Quelle 1 (Z. 2333–2341: „Sheets „Klimawirkungsketten" (Z3–Z271 wie in Kap. 1 zitiert) und „Schadensbaum-Netzwerkliste"… · **Lücke/falsche Zuordnung** — Gemessen (Zitatsammlung über den ganzen Bericht) zitiert der Bericht KWK Z272 — die Zeile des Zielknotens W117 und damit die tragendste Fundstelle der Kette —, die Quellenangabe endet aber bei Z271. | C | offen | — | — | Vorschlag in Runde 3 |
| 51 | Bericht Kap. 2 Teil B — B1 Quelle 3 (LfU-FAQ, Z. 222–227), B2 Quelle 1 (LAIV MV „Geländemodelle", Z. 242–246), B3 Quelle 2 (GDV „ZÜRS Geo"… · **Lücke** — Diese fünf Einträge tragen weder ein Erscheinungs-/Standjahr noch eine Fassungsangabe; belegt ist nur der Zugriffstag 13.09.2026 und der Snapshot. | C | offen | — | — | Vorschlag in Runde 3 |
| 52 | Bericht Kap. 2, Überschrift des Teils B Z. 197: „### Belege zu den entschiedenen Registerzeilen (§3.8, Volltext geprüft am 13.09.2026)" —… · **veraltete Angabe** — Die Überschrift datiert die Prüfung des gesamten Abschnitts auf den 13.09.2026. | C | offen | — | — | Vorschlag in Runde 3 |
| 53 | Bericht Kap. 2 Teil B, B4 Z. 383–389 („die Arbeitsmappe schreibt über Mon. J65 → J64 den Zeitwertansatz vor. Entschieden: Der Neuwert… · **Lücke** — Der Bericht rechnet seinen Basiswert seit dem 17.09.2026 bewusst abweichend von der verbindlichen Vorgabe J65 → J64 (Zeitwertansatz). | B | behoben | Bericht §7.2 „Status": Stand an der Quelle (Abgleich-Protokoll ohne Zeile zu #60, vorgesehene Zeile nach Muster Z151), Entscheider (Eigner der Mappe), Frist (vor Abnahme und Integration von #60) und Abnahmesperre im Punkt Quellen-Synchronität; Verweise darauf in B4 und Kap. 8 Quelle 2 — siehe [Autor-Revision T-0573](#autor-revision-t-0573-befunde-41-53-92-93-100) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();b=s.split('\n## 3 ')[0];q=s.split('\n## 8 ')[1].split('\n## 9 ')[0];z=s.split('\n### 7.2 ')[1].split('\n## 8 ')[0];ok='**Status des Antrags:** beantragt 17.09.2026' in b and '**Anhängige Abweichung:**' in q and '#fortschreibung-neuwert-k3' in q and '**Stand an der Quelle (Befund 53):**' in z and all(x in z for x in ('**Entscheider:**','**Frist:**','Fortschreibung Bewertungslogik (keine Kante)','noch keine Zeile'));raise SystemExit(0 if ok else 1)"` | Vorschlag (b) und (c) umgesetzt; (a) — die Zeile im Abgleich-Protokoll selbst — ist Sache des Mappen-Eigners und im Bericht als offene Handlung mit Frist geführt, nicht durch den Bericht vollzogen (eiserne Regel 2). |
| 54 | Bericht §3.5 „Zeichentabelle (alle Formelzeichen der Kapitel 3 und 5, §3.2/§3.9)" Z. 750–789 (28 Zeilen), gegen §3.4 Schritt 3 Z. 689–692… · **Lücke** — Die Tabelle beansprucht in ihrer Überschrift und im Einleitungssatz Vollständigkeit („führt jedes Formelzeichen, das in diesem Kapitel oder in Kapitel 5 vorkommt"). | B | behoben | Autor-Revision T-0568: Bericht §3.5, neue Zeile \(f_{\text{AWM}}\) (Einheit „– (Verhältnis RND/GND)", `herleitung:#fortschreibung-neuwert-k3`, §7.2/§4.8) und Zeile \(w\) (\(w_z\), \(w_{\text{Kommune}}\)) als Gattungszeichen nach dem Muster der \(\bar A\)-Zeile, mit dem Hinweis, dass der Euro-Ausweis der Kommune die Summe über die Zellen ist. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('\n### 3.5 ')[1].split('\n### 3.6 ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];a=[c for c in r if 'AWM' in c[0]];w=[c for c in r if c[0].startswith(chr(92)+'(w'+chr(92)+')')];raise SystemExit(0 if a and 'fortschreibung-neuwert-k3' in a[0][3] and w and 'Gattungszeichen' in w[0][1] and 'Kommune' in w[0][0] else 1)"` | Vorschlag in Runde 3 |
| 55 | Bericht §3.5 Z. 771 (d_1, d_5: „register: 60-S093-01") und Z. 773 (f_{S093}, f_{S094}: „register: 60-S093-01 bzw. 60-S094-01"), gegen Kap.… · **Widerspruch** — Vier Formelzeichen des Basiswert-Pfades holen ihre Herkunft aus Registerzeilen, die der Bericht selbst nicht für Formeln zugelassen hat. | B | behoben | Autor-Revision T-0568: Präambel Kap. 2 nennt die beiden Fälle ausdrücklich (neutral gesetztes Glied 1,00 eines Sensitivitätsbands in der Formel; belegte Enden \(d_1\)/\(d_5\) der Wasserstandsachse als Basiswert aus §3.3); §3.5 führt \(d_1\)/\(d_5\) und \(d(h)\) mit Herkunft `herleitung: §3.3` statt Registerzeile, \(f_{S093}\)/\(f_{S094}\) mit dem Vermerk „neutral gesetztes Glied"; die Registerzeilen 60-S093-01/60-S094-01 bestreiten das Glied in der Kernformel nicht mehr, im Bericht wie im Spiegel `docs/evidenz/register.md` (Nacharbeit Runde 1). | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('\n### 3.5 ')[1].split('\n### 3.6 ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];p=s.split('\n## 2 ')[1].split(chr(10)+chr(124))[0];d=[c for c in r if c[0].startswith(chr(92)+'(d_1')];f=[c for c in r if 'S093' in c[0]];g=[z for z in s.split(chr(10)) if z.startswith(chr(124)+' 60-S09')];h=[z for z in open('docs/evidenz/register.md',encoding='utf-8').read().split(chr(10)) if z.startswith(chr(124)+' 60-S09')];raise SystemExit(0 if 'neutral gesetztes Glied' in p and d and 'register:' not in d[0][3] and f and 'neutral gesetztes Glied' in f[0][3] and g and not any('kein eigenes Multiplikativglied' in z for z in g) and len([z for z in h if 'neutral gesetztes Glied' in z])==2 and not any('kein eigenes Multiplikativglied' in z for z in h) else 1)"` | Vorschlag in Runde 3 |
| 56 | Bericht §3.5 Z. 762–789, Reihenfolge der 28 Tabellenzeilen (z, k, s/i, t, n, W, a, h, d(h), d_1/d_5, h_1/h_5, f_{S093}/f_{S094}, A_{z,s}… · **Formabweichung** — Die Tabelle ist nach dem Auftreten in den Formeln sortiert, nicht alphabetisch. | C | behoben | Autor-Revision T-0568: Bericht §3.5, 31 Zeilen alphabetisch nach dem Grundbuchstaben (lateinisch vor griechisch, klein vor groß, Index nachgeordnet); die Sortierregel steht im Einleitungsabsatz, der Rechenschritt je Zeichen in der Herkunftsspalte. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('\n### 3.5 ')[1].split('\n### 3.6 ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];B=chr(92);G='alpha beta gamma delta epsilon zeta eta theta iota kappa lambda mu nu xi pi rho sigma tau upsilon phi chi psi omega'.split();f=lambda m:(lambda g:(1,G.index(g.group(1).lower()),g.group(1)[0].isupper(),m[g.end():].replace(' ','')) if g else (0,m[0].lower(),m[0].isupper(),m[1:].replace(' ','')))(re.match(re.escape(B)+'([A-Za-z]+)',m));x=lambda c:re.sub(re.escape(B)+'(bar'+chr(124)+'text'+chr(124)+'mathrm) ?','',re.search(re.escape(B+'(')+'(.*?)'+re.escape(B+')'),c).group(1)).replace('{','').replace('}','');k=[f(x(c[0])) for c in r];raise SystemExit(0 if len(k)>=31 and k==sorted(k) and 'alphabetisch' in t.split(chr(10)+chr(124))[0] else 1)"` | Vorschlag in Runde 3 |
| 57 | Bericht §3.1 Z. 541–548 — Betrachtungsebene „die Kommune" (Z. 541) und Formel \text{EAD} = \bar A \cdot w (Z. 548) —, gegen §3.6 Z. 797… · **Fehler/Lücke** — Auf der Zelle ist der Euro-Betrag exakt proportional zur physischen Zwischengröße (\text{EAD}_z = \bar A_z w_z) — das erfüllt den Kern von LF 3. | B | behoben | Vorschlag (a)–(c) umgesetzt: (a) Bericht §3.1 trägt \(\text{EAD}_z = \bar A_z \cdot w_z\) und \(\text{EAD}_k = \sum_{z \in k} \bar A_z \cdot w_z\) statt der indexfreien Identität; (b) §3.6, Teil-Ausweis 1: \(\bar A_k\) und \(\text{EAD}_k\) sind über Kommunen hinweg nicht proportional, Spannweite 1.533…1.950 €₂₀₂₆/m² BGF genannt; (c) Golden-Test `beispiel_60_kernformel` um eine Kommune mit EFH- und MFH-Zelle erweitert (`ead_mix` = 20.195,7 gegen 18.077,9 €₂₀₂₆/a), grün im Lint (T-0567). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('\n### 3.6 ')[1].split('\n### 3.7 ')[0];raise SystemExit(0 if 'ead_mix' in k and '1.533…1.950' in k and 'nicht proportional' in k else 1)"` | Vorschlag in Runde 3 |
| 58 | Bericht §4.3 Z. 1138–1139 („208 m² Wohnfläche · 1,30 BGF/Wohnfläche · 1.950 €₂₀₂₆/m² BGF = 527.280 €₂₀₂₆") und M₀-Bandtabelle Z. 1199–1208… · **Fehler/Lücke** — Das Produktionsmodell bewertet jede Zelle mit einem typgewichteten Wertsatz über \theta_{z,t}; der nationale Kalibrierlauf, aus dem M_0 und damit \lambda folgen, setzt stattdessen für den gesamten exponierten Bestand den EFH/ZFH-Satz 1.950 €₂₀₂₆/m² BGF an.… | B | behoben | Bericht §4.3 Punkt 2, M₀-Bandtabelle (Zeilen n_EFH/ZFH, n_MFH, Typ-Mix), Bandrechnung; §4.4, §4.8, Beispielblock beispiel_60_kalibrierung, Kap. 7 flood_bldg.lambda, Kap. 4 Einleitung (Vorläufigkeitsvermerk mit Richtung), Evidenzdatei 60_destatis_wohnflaeche_gebaeudetyp_2021.csv — siehe Autor-Revision T-0570 | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('\n### 4.3 ')[1].split('\n### 4.4 ')[0];raise SystemExit(0 if '= 0,596 · 1.950 + 0,404 · 1.533 = **1.781,532' in k and '0,872 · 481.726,25 €' in k and '**1,243 Mrd.' in k and '1.950 €₂₀₂₆/m² BGF = **527.280' not in k else 1)"` | Vorschlag in Runde 3; umgesetzt T-0570 |
| 59 | Drei Stellen im Prüfumfang, die rechnerisch den abgelösten Anker A^{*} = 0,985 Mrd. €₂₀₂₆/a tragen statt den geltenden 1,132… · **veraltete Angabe/Widerspruch** — Jeder der Zahlenwerte lässt sich exakt auf den alten Anker zurückrechnen, ist also nicht neu gerechnet, sondern stehen geblieben. (a) 0,985 / 0,931 = 1,05800 — genau die ausgewiesenen 1,058; mit dem geltenden Anker ist es 1,132 / 0,931 = 1,216, die Angabe… | B | behoben | Bericht §4.3 Punkt 3 (Gegenrechnung, bereits mit T-0570 auf \(\lambda\) = 1,33 gezogen und hier nachgeprüft), Kap. 6 Modellgrenze 9 (0,62 statt 1,13 Mrd. €₂₀₂₆/a, Band 0,45–0,85, Verweis auf §4.6) samt Versionsstempel (nur −45 %, keine Beträge), Entscheidungslog Nr. 7 (\(\lambda\) 1,66 bis 2,28 auf \(A^{*}\) = 1,132, \(M_0\) = 1,243, \(\lambda\) = 0,911; Auswirkungsspalte verweist auf §4.6); §7.2 und §4.8 bleiben dem Schwesterpaket T-0573 (Befunde 92, 93, 100) — siehe Autor-Revision T-0571 | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();a=s.split('\n### 4.3 ')[1].split('\n### 4.4 ')[0];g=s.split('9. **Bewertung zum Neuwert')[1].split('\n## ')[0];e=[z for z in s.split('\n') if 'Neuwert oder Zeitwertansatz der Arbeitsmappe (Mon. J65 → J64) als Basiswert K3?' in z];ok=len(e)==1 and '1,058' not in a and '0,850 Mrd. €₂₀₂₆/a und' in a and '= 1,33;' in a and '0,62 statt 1,13 Mrd.' in g and '0,45–0,85' in g and 'zum Zeitwert rund 45 % niedriger' in g and all(x not in g for x in ('0,54','0,99','0,39–0,74'));ok=ok and '1,66 (bis 2,28)' in e[0] and '0,911' in e[0] and '0,62 (0,45–0,85)' in e[0] and all(x not in e[0] for x in ('0,724','1,32','1,81','0,54','0,99'));ok=ok and abs(1.132/0.850-1.33)<5e-3 and abs(1.132*0.55-0.62)<5e-3 and abs(1.132*0.40-0.45)<5e-3 and abs(1.132*0.75-0.85)<5e-3 and abs(1.132/(1.243*0.55)-1.66)<5e-3 and abs(1.132/(1.243*0.40)-2.28)<5e-3;raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 3; umgesetzt T-0571 |
| 60 | Bericht §4.2 Z. 1119–1121 (\pi = 1,07: „Das Register führt für 2023 → 2026 den Baupreisfaktor 1,105 (B4, Band 1,07–1,16). Abzüglich rund 3… · **Fehler** — \pi ist ein abgeleiteter Parameter: Er entsteht aus dem B4-Faktor durch Division mit 1,03. | C | behoben | Autor-Revision T-0569 (siehe [Autor-Revision T-0569](#autor-revision-t-0569-befunde-12-27-38-60-70-76-98)): wie 38 — §4.2 führt \(\pi\) als abgeleiteten Parameter mit beiden Bandenden aus derselben Division; oberes Ende 1,124 statt 1,11 (die im Vorschlag genannten 1,13 aus dem gerundeten 1,16 entfallen, weil ungerundet gerechnet wird). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 4 ')[1].split(chr(10)+'## 5 ')[0];raise SystemExit(0 if ('1{,}1576/1{,}03 = 1{,}124' in k and 'Band 1,039–1,124' in k and '0,296–2,291' in k and 'band: [1.039, 1.124]' in s) else 1)"` | Vorschlag umgesetzt, Status vorher `offen`. |
| 61 | Bericht §4.4 „Plausibilitätsschranke" Z. 1240–1258, besonders die Herleitung Z. 1243–1250 („Sie ist das vollständig fortgepflanzte Band aus… · **Fehler (Zirkelschluss)** — Die Schranke ist definitionsgemäß das Intervall [A^{*}_{u}/M_{0,o},\; A^{*}_{o}/M_{0,u}]. Jedes \lambda = A^{*}/M_0, das aus Werten innerhalb der eigenen Bänder gebildet wird, liegt zwangsläufig darin — die Prüfung kann kein Ergebnis zurückweisen, das mit der… | B | behoben | Bericht §4.4: fortgepflanztes Band 0,12–3,93 als **Unsicherheitsband, kein Prüfstein**; Plausibilitätsschranke [0,5; 2,0] als Abschätzung von KAP3 aus einem Modellverständnis-Argument ohne Größe, die in \(\lambda\) eingeht, mit Sensitivität (Faktor 1,5 / 3) und Trennschärfe-Nachweis; §4.1a, §4.8 (zwei Zeilen) und Block nachgezogen — siehe [Autor-Revision T-0574](#autor-revision-t-0574-befunde-35-61-64-96-97) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.4 ')[1].split(chr(10)+'### 4.5 ')[0];ok='kein Prüfstein.**' in k and '**Plausibilitätsschranke [0,5; 2,0] (Abschätzung von KAP3).**' in k and 'Modellverständnis-Argument' in k and 'gilt als zulässig' not in k and 'pl_lo, pl_hi = 0.5, 2.0' in s and 'assert schranke_lo < pl_lo and pl_hi < schranke_hi' in s and '0,5 bzw. 2,0' in s;raise SystemExit(0 if ok else 1)"` | Wie vorgeschlagen; das Band bleibt als Unsicherheitsband stehen. Der Faktor 2 ist eine Abschätzung, keine Messung. |
| 62 | Drei nachgerechnete Zwischenergebnisse: (a) §4.4 Z. 1248–1249 „\lambda_{\text{unten}} = 0,297 / 2,643 = 0,112384…"; (b) ebenda Z. 1249… · **Fehler (Rechenweg)** — Die drei Divisionen bzw. Produkte ergeben nachgerechnet andere Ziffern, als der Bericht ausweist: (a) 0,297/2,643 = 0,1123723…, nicht 0,112384… (Abweichung ab der fünften Nachkommastelle); (b) 2,263/0,657 = 3,4444444…, nicht 3,444409… — die ausgewiesene… | C | behoben | Bericht §4.3 Bandrechnung und §4.4 Schranke aus der Rechnung neu gesetzt, Zusicherung im Beispielblock — siehe Autor-Revision T-0570 | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();ok='0,122061…' in s and '3,929674…' in s and '1.534,08/a = 582.838.678' in s and '5.084,22/a = 2.425.419.445' in s;ok=ok and abs(0.296/2.425-0.122061)<1e-6 and abs(2.291/0.583-3.929674)<1e-6 and abs(0.872*435696.30*1534.08-582838678)<1 and abs(0.872*547073.95*5084.22-2425419445)<1;raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 3; umgesetzt T-0570 |
| 63 | Bericht §4.5, Prüfgröße Z. 1271–1286 und Grenzen-Absatz Z. 1341–1349, gegen `docs/evidenz/60_gdv_jahresreihe_2002_2024.csv` (23… · **Lücke** — Die einzige unabhängige Verteilungsprüfung des Berichts vergleicht ein Mittelwert-Aggregat der Ankerreihe mit einem gesetzten Regime-Anteil aus drei Stützstellen. | B | behoben | Bericht §4.5, neuer Absatz „Zweite Prüfgröße: Quantilvergleich der höchsten Jahre": die vier höchsten Jahre der Ankerreihe nach Rang mit Weibull-Position \(p_i = i/24\) als Vielfaches ihres Auslassungs-Normaljahrs (9,34 / 4,67 / 2,24 / 1,44) gegen die Kurve \(D(p)\) aus §3.4 Schritt 2 (8,82 / 4,22 / 0 / 0), Rangtabelle statt Extremwertverteilung (P3); eigene, vorab fixierte Toleranz „90-%-Rangband" (Binomialverteilung der Rangplätze, Niveau als Abschätzung von KAP3, Sensitivität 80 %), nicht als Ersatz für \(R_{\text{anker}}\). Ergebnis: bestanden auf allen vier Rängen; Trennschärfe gemessen und ausgewiesen (auch doppelter, dreifacher und halber HQextrem-Schaden bestehen). Grenzen-Absatz auf die **Ereignis**ebene beschränkt; §4.8 Zeile „Toleranz Quantilvergleich"; Block `beispiel_60_kalibrierung` rechnet Tabelle, Band und Varianten nach — siehe [Autor-Revision T-0575](#autor-revision-t-0575-befunde-63-65) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.5 ')[1].split(chr(10)+'### 4.6 ')[0];ok=all(x in k for x in ('Zweite Prüfgröße: Quantilvergleich der höchsten Jahre','Toleranz — vorab fixiert: 90-%-Rangband','i/(n+1) = i/24','**9,34**','0 bis 47,5','praktisch nicht scheitern')) and 'qv = quantilvergleich()' in s and 'Toleranz Quantilvergleich' in s and abs(12.6/((42.28-12.6)/22)-9.34)<5e-3;raise SystemExit(0 if ok else 1)"` | Die im Befund erwartete Schärfung „nach oben" tritt gemessen nicht ein: Bei 23 Jahren reicht das Rangband der vier höchsten Ränge über die HQhäufig-Rate hinaus, das untere Bandende ist 0. Ausgewiesen, nicht geglättet; der Punktvergleich spricht eher für mehr Gewicht zwischen HQhäufig und HQ100 als auf HQextrem, ohne daraus etwas zu entscheiden (§2.4). |
| 64 | Bericht §4.6, Obergrenze O Z. 1363 („O = (339.000 \cdot 0{,}1 + 1.380.000 \cdot 0{,}01) \cdot 527.280 \cdot 0{,}250 = 6,29 Mrd. €₂₀₂₆/a …… · **Fehler (Zirkelschluss, nur halbseitig behoben)** — Die Neufassung nach Befund 35 (Z. 1353–1358) hat die Untergrenze aus der Zirkularität geholt und weist das im Text ausdrücklich nach („In dieses U geht keine der sechs Ankergrößen … als Faktor ein", Z. 1362); für die Obergrenze fehlt derselbe Nachweis, und er… | B | behoben | Bericht §4.6: Obergrenze getrennt in unabhängige \(O_u\) = 11,04 (Fondsvolumen 2021, obere Anteilsenden, „Mittel ≤ schwerstes Jahr“) und Modellschranke \(O_M\) = 6,29 mit ausgewiesenem Vielfachen \(O_M/M_0\) = 5,06 und dem Nachweis, dass sie nach bestandener Schranke (§4.4) nicht auslösen kann; Integrationstest nennt beide Grenzarten getrennt; §4.8, Block — siehe [Autor-Revision T-0574](#autor-revision-t-0574-befunde-35-61-64-96-97) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.6 ')[1].split(chr(10)+'### 4.7 ')[0];ok=all(x in k for x in ('Modellschranke','(modellabhängig, kein Prüfstein)','6,29 / 1,243 = 5,06','getrennt benennt')) and 'assert 2.0 * M0 < O_M' in s and 'O_u = E_2021 * (1 / 3) * 1.00' in s and abs(6.29/1.243-5.06)<5e-3;raise SystemExit(0 if ok else 1)"` | Vorschlag „nach dem Muster von \(U\)“ mit dem Fondsvolumen 2021 umgesetzt, aber mit den oberen Anteilsenden und ohne Wiederkehrzeit (sonst läge die Grenze unter dem Ist-Wert und wäre keine Obergrenze). |
| 65 | Bericht §4.5 Ist-Ergebnis Z. 1319–1325: „auf HQhäufig 66,1 %, auf HQ100 23,2 % und auf das Extremregime 10,6 % …, also 33,9 % auf das… · **Fehler (Rundung/innerer Widerspruch)** — Die beiden genannten Einzelanteile summieren sich zu 23,2 + 10,6 = 33,8, nicht 33,9; 33,9 entsteht nur als 100 − 66,1, also aus der Gegenrichtung, und die drei Anteile summieren sich zu 99,9 statt 100,0. | C | behoben | Bericht §4.5 „Ist-Ergebnis": Anteile aus den Summanden \(\tau_1, \tau_2, \tau_3\) der Trapezsumme auf zwei Stellen, 66,14 + 23,23 + 10,63 = 100,00 %, seltenes Regime als Summe seiner Teile 23,23 + 10,63 = 33,86 %, Ankerwert ungerundet 20,186/42,28 = 47,74 %, Differenz 47,74 − 33,86 = 13,88 Pp (gerundet 13,9); der Rundungswiderspruch ist im Text benannt. Block `beispiel_60_kalibrierung` sichert Summe 100 und Teilsummen ab — siehe [Autor-Revision T-0575](#autor-revision-t-0575-befunde-63-65) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.5 ')[1].split(chr(10)+'### 4.6 ')[0];ok=all(x in k for x in ('HQhäufig 66,14 %','23,23 % und auf das Extremregime 10,63 %','23,23 + 10,63 = **33,86 %**','47,74 − 33,86 = 13,88')) and '**33,9 %**' not in k and abs(66.14+23.23+10.63-100)<1e-9 and abs(23.23+10.63-33.86)<1e-9 and 'assert proz == [66.14, 23.23, 10.63]' in s;raise SystemExit(0 if ok else 1)"` | Verdikt unverändert (13,88 > 11,5 Pp, nicht bestanden). Der vorgeschlagene allgemeine Lint auf Anteilstripel ist nicht gebaut (außerhalb des Zuschnitts); die Prüfung steht für diese Stelle im Rechenblock. |
| 66 | Bericht §5.1.3, Absatz „Tragende Begründung der oberen Bandgrenze: Ankerwert der Verteilungsprüfung (§4.5)" Z. 1697–1717 (darin der… · **Widerspruch/veraltete Bandzuordnung** — Die obere Bandgrenze von s_{\text{bem}} hat nach der Revision zu Befund 26 genau eine tragende Begründung, den zellunabhängigen Ankerwert der Verteilungsprüfung; dieser Anker ist mit Befund 33 auf die Jahresauslassung über 2002–2024 umgestellt und liefert… | B | behoben | Autor-Revision T-0577 (siehe [Autor-Revision T-0577](#autor-revision-t-0577-befunde-66-67-68-79)): Bericht §5.1.3, Absatz „Tragende Begründung der oberen Bandgrenze“ stützt die Obergrenze von \(s_{\text{bem}}\) auf den Ankerwert 47,74 % der Jahresauslassung (§4.5) und setzt sie auf 0,52 (1 − 0,4774 = 0,5226); der Restpunkt-Vermerk ist durch einen Nachzug-Vermerk ersetzt, ein neuer Absatz begründet, warum der Punktwert 0,50 bleibt (oberer Näherungswert, Fehlerrichtung). Gleichlautend nachgezogen: \(s_{\text{bem}}\) 0,30–0,52, \(r_{\text{S092}}\) 0,0075–0,0832, Einzelachse 0,021–0,0364 in Kap. 1, Kap. 2, §3.5, §5.1.1, §5.1.2, §5.1.3, Beispielblöcken, Kap. 7 (`flood_bldg.s_bem`, `flood_bldg.r_s092`), Entscheidungslog Nr. 3 und `docs/evidenz/register.md` Zeile 60-S092-01. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();r=open('docs/evidenz/register.md',encoding='utf-8').read();z=[l for l in r.split(chr(10)) if l.startswith(chr(124)+' 60-S092-01 ')];raise SystemExit(0 if all(t in s for t in ('band: [0.30, 0.52]','band: [0.0075, 0.0832]','0,50 (Band 0,30–0,52)','1 − 0,4774 = 0,5226','0,021–0,0364','P2-Abschätzung r = 0,035 (0,0075–0,0832)')) and 'band: [0.30, 0.62]' not in s and 'Nachzug betrifft' not in s and len(z)==1 and 'Band 0,0075–0,0832' in z[0] else 1)"` | Vorschlag in Runde 3 |
| 67 | Bericht §5.1.2 Z. 1635–1638 („Gezählt wird allein die Nachrüstung nach dem letzten Kalibrierjahr 2024 … der heutige Ausstattungsgrad q_0… · **Lücke (Referenzzustand ohne Zahlenwert)** — Der Hebel wirkt als \text{EAD}\cdot(1-r) auf einen Erwartungsschaden, dessen Niveau-Skalar an Jahren bis 2024 kalibriert ist und in dem der bereits vorhandene Objektschutz steckt. | B | behoben | Autor-Revision T-0577: \(q_0\) ist als abgeschätzter Parameter geführt — §4.7 Absatz `#q0-abschaetzung` mit Wert 0,15, Band 0,05–0,30, Herleitung (Abschätzung von KAP3, Befragungen nicht als Effektgröße) und Watchlist der weiter geparkten Datenebene; \(\Delta q \le 1 - q_0\) in §4.7 und §5.1.2; Wirkung nur auf den ungeschützten Teil als bezifferte Modellgrenze 4 in §5.1.2 (+5,5 %, Band +1,8 bis +11,7 %, Gegenrichtung zu \(s_{\text{bem}}\)), nachgerechnet im Block `beispiel_60_s092_abschaetzung`; Zeilen in §3.5 und §4.8 nachgezogen. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('\n### 4.7 ')[1].split('\n## 5 ')[0];m=s.split('\n### 5.1.2 ')[1].split('\n### 5.1.3 ')[0];raise SystemExit(0 if all(t in k for t in ('id=\"q0-abschaetzung\"','= **0,15** (Band **0,05–0,30**)','0,15 (0,05–0,30)','le 1 - q_0')) and all(t in m for t in ('= 0,15 (Band 0,05–0,30;','le 1 - q_0','(4) Wirkung nur auf den ungeschützten Teil')) and 'nicht gesetzt, nicht geschätzt' not in s else 1)"` | Vorschlag in Runde 3 |
| 68 | Bericht Kapitel 5, HTML-Kommentar Z. 1576–1582, dort Z. 1581 („Offene Hebel-Kandidaten: S096/S097/S098 (über R7-Erwartungswert mit #50)… · **Lücke (Sichtbarkeit/Verweis)** — Kapitel 5 ist der Ort, an dem ein Leser nach Hebeln und ihren Wirkungen sucht. | C | behoben | Autor-Revision T-0577: Kapitel 5 trägt vor §5.1 den sichtbaren Absatz „Nicht als Hebel geführt: S093 Gebäudezustand und S094 Baumaterial“ mit den Registerzeilen 60-S093-01/60-S094-01, Bändern 0,71–1,40 und 0,84–1,18 (gemeinsam 0,60–1,66), Sensitivitäten, geparkter Ebene und der Bedingung, unter der ein Hebel entstünde; der HTML-Kommentar führt S093/S094 nicht mehr als Hebel-Kandidaten. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=re.sub('<!--.*?-->','',s.split('\n## 5 ')[1].split('\n### 5.1 ')[0],flags=re.S);raise SystemExit(0 if all(t in k for t in ('Nicht als Hebel geführt','60-S093-01','60-S094-01','0,71–1,40','0,84–1,18','0,60–1,66','geparkt')) else 1)"` | Vorschlag in Runde 3 |
| 69 | Bericht Kap. 8 „Quellen (§3.8)", Quelle 1, Z. 2339 („… Sheets „Klimawirkungsketten" (Z3–Z271 wie in Kap. 1 zitiert) und… · **Lücke/Fehler (Fundstellenangabe deckt die benutzte Quelle nicht ab)** — Die Zellenliste der Quelle 1 ist abschließend formuliert („wie in Kap. 1 zitiert") und endet bei Z271. | C | behoben | Bericht Kap. 8 „Quellen (§3.8)", Quelle 1 (siehe [Autor-Revision T-0728](#autor-revision-t-0728-befunde-11-69)): Der Bereich der Klimawirkungsketten deckt jetzt „Z3–Z272" ab und schließt damit die tragende Zeile Z272 (Knoten W117) ein; die abschließend wirkende Formulierung „wie in Kap. 1 zitiert" ist durch den Zusatz „u. a." entschärft, wie im Vorschlag vorgesehen. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();q1=s.split(chr(10)+'1. **KWRA-Schadensbaum')[1].split(chr(10)+'2. **KWRA-Monetarisierung')[0];raise SystemExit(0 if ('Z3–Z272' in q1 and 'Z271' not in q1 and 'u. a. wie in Kap. 1 zitiert' in q1) else 1)"` | Vorschlag in Runde 3 |
| 70 | Bericht Kap. 1 „Konto-Einbettung", Punkt „Preisstandjahr", Z. 133–139, darin der Bedingungssatz Z. 136–138 („Bis ein K3-eigener Kostensatz… · **Widerspruch (überholte Bedingung, unzutreffender Herkunftsvermerk)** — Der Ersetzungspfad benennt eine Bedingung, die eingetreten ist: Ein K3-eigener Kostensatz mit Quelle liegt vor (Register 60-R24-01 → §3.5 Z. 779), ist auf den Preisstand 2026 indexiert und trägt den Basiswert des Berichts (527.280 €₂₀₂₆ je Wohngebäude, §4.3). | C | behoben | Autor-Revision T-0569 (siehe [Autor-Revision T-0569](#autor-revision-t-0569-befunde-12-27-38-60-70-76-98)): Vorschlag umgesetzt — Kap. 1 „Konto-Einbettung“, Punkt „Preisstandjahr (abgeleitet aus Register 60-R24-01)“, Bedingungssatz durch den Vermerk ersetzt, dass der K3-eigene Kostensatz (Register 60-R24-01, §3.5, Basiswert 527.280 €₂₀₂₆) vorliegt; §3.9 ABGESCHÄTZT bleibt, eingegrenzt auf den Fortschreibungsfaktor 1,105 (Band 1,07–1,16); §3.1 „Bezugsjahr (Preisstand)“ zieht den Rückverweis nach. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('### Konto-Einbettung')[1].split('### ')[0];raise SystemExit(0 if 'Preisstandjahr (Abschätzung von KAP3' not in k and 'Ersetzungspfad (W1) ist mit dem Register eingelöst' in k and 'allein der Fortschreibungsfaktor 2023 → 2026' in k and 'abgeleitet aus Register 60-R24-01; §3.9' in s else 1)"` | Vorschlag umgesetzt, Status vorher `offen`. |
| 71 | `backend/scripts/lint_methodik.py`, Ausgabeblock Z. 952–959 (Zeile 953 gibt allein die Zahl der grünen Checks aus) im Zusammenspiel mit… (Werkzeugbefund) · **Lücke (stumm übersprungene Prüfung bei grüner Gesamtmeldung)** — Von den drei Forderungen des Befunds 17 ist die dritte („Zählung grüner Checks um eine Zählung übersprungener Checks ergänzen") nicht umgesetzt: Die Ausgabe nennt nur grüne und rote Checks. | C | offen | — | — | Vorschlag in Runde 3 |
| 72 | Bericht Kap. 1 „Knoten-Bilanz", Spalte „Name", Z. 85 (S074), Z. 100 (W100), Z. 101 (S092), gegen… · **Lücke (bewusste Abweichung ohne sichtbare Modellgrenze)** — Befund 21 ist im Ledger als „bewusst offen" geführt, mit der Begründung, die Kürzung habe keine Rechenwirkung und werde mit der nächsten Revision nachgezogen. | C | behoben | Autor-Revision T-0579 (siehe [Autor-Revision T-0579](#autor-revision-t-0579-befunde-21-46-47-48-72-104)): Die drei Namen sind wörtlich übernommen (erste Alternative des Vorschlags, Befund 21 entfällt mit); die Präambel sagt zusätzlich, dass die Spalte „Name” den Wortlaut der Arbeitsmappe (Blatt „Klimawirkungsketten”, Spalte B) ungekürzt führt und nur der Klammerzusatz am Ende ein Zusatz des Berichts ist. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k1=s.split(chr(10)+'## 1 ')[1].split(chr(10)+'## 2 ')[0];n={'S074':'Topographie (Geländeform, Höhe, etc.) (über W085)','W100':'Einschränkungen der Funktionsfähigkeit von Kanalnetzen und Vorflutern (= Id 52)','S092':'Bauliche, organisatorische und finanzielle Vorsorge der Eigentümer und Nutzer von Gebäuden und Infrastrukturen'};t=k1.split('### Knoten-Bilanz')[1].split('### Weitergaben')[0];z={l.split(P)[1].strip():l.split(P)[2].strip() for l in t.split(chr(10)) if l.startswith(P+' ') and l.count(P)==6};raise SystemExit(0 if all(z.get(a)==b for a,b in n.items()) and 'Arbeitsmappe (Blatt „Klimawirkungsketten”, Spalte B der genannten Zeile) **ungekürzt**' in k1 else 1)"` | Vorschlag in Runde 3; umgesetzt T-0579 |
| 73 | Bericht Kopf-Statuszeile Z. 3 („Status: in Revision nach Review-Runde 2 … Stand 17.09.2026"), „Ergebnis", Punkt „Offen (Stand 17.09.2026… · **Widerspruch (überholter Bearbeitungs- und Prüfstand im Kopf; Rückfall in die Lage des Befunds 22)** — Befund 22 verlangte, Kopfstatus, Geltungsbereich und „Ergebnis/Offen" am Ende jeder Revisionsrunde nachzuziehen. | B | offen | — | — | Vorschlag in Runde 3 |
| 74 | Bericht §3.1, Aufzählungspunkt „Physischer Teil-Ausweis (Zwischengröße vor dem Euro)" Z. 545–548 („… dem erwarteten Schaden der Zelle… · **Lücke (bewusste Abweichung ohne sichtbare Modellgrenze)** — Befund 24 ist im Ledger als „bewusst offen" geführt, begründet damit, dass die Gleichung auf der Zelle exakt sei und §3.6 kommunal korrekt summiere. | C | behoben | Die Modellgrenze steht jetzt im Bericht selbst: §3.1 (Aufzählungspunkt „Physischer Teil-Ausweis", Absatz „Modellgrenze" mit dem Beispiel 20.195,7 gegen 18.077,9 €₂₀₂₆/a, 10,5 % bezogen auf \(\text{EAD}_k\)), §3.5 (\(\bar A\)-Zeile) und §3.6 (Teil-Ausweis 1) vermerken, dass \(\bar A_k\) und \(\text{EAD}_k\) bei gemischtem Gebäudetyp nicht proportional sind (T-0567). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=lambda a,b: s.split('\n### '+a+' ')[1].split('\n### '+b+' ')[0];raise SystemExit(0 if all('nicht proportional' in t(a,b) for a,b in (('3.1','3.2'),('3.5','3.6'),('3.6','3.7'))) else 1)"` | Vorschlag in Runde 3 |
| 75 | Bericht §3.5, Einleitungssatz Z. 752 („Die Tabelle führt jedes Formelzeichen, das in diesem Kapitel oder in Kapitel 5 vorkommt, mit… · **Lücke (unerfüllter Vollständigkeitsanspruch; Zeichenkollision)** — Befund 25 ist als „bewusst offen" geführt mit der Begründung, die vier Zeilen hätten keine Rechenwirkung und q_0 sei in §4.7/§4.8 als geparkt dokumentiert. | C | behoben | Autor-Revision T-0568: Einleitungssatz §3.5 benennt die Zeichen ohne Rechenwirkung im Basiswert (\(f_{\text{AWM}}\), \(q_0\), \(\tau_1\)…\(\tau_3\)) und die Umbenennung \(t_i\) → \(\tau_i\); die \(t\)-Zeile bleibt reiner Laufindex des Gebäudetyps (Notation); \(\tau_i\) steht mit Einheit m²/a und Herkunft §5.1.3 in der Tabelle. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('\n### 3.5 ')[1].split('\n### 3.6 ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];e=t.split(chr(10)+chr(124))[0];u=[c for c in r if 'tau_' in c[0]];z=[c for c in r if c[0]==chr(92)+'(t'+chr(92)+')'];raise SystemExit(0 if u and u[0][2]=='m²/a' and 'herleitung:' in u[0][3] and 'tau' in e and 'q_0' in e and z and z[0][3]=='Notation' else 1)"` | Vorschlag in Runde 3 |
| 76 | Bericht Kap. 2, Registerzeile 60-R24-01 Z. 193, und Langbeleg B4, Rechenschritt 2 Z. 357–367, Rechenschritt 3 Z. 369–376, Rechenschritt 4… · **Lücke (bewusst offene Entscheidung ohne sichtbare Modellgrenze)** — Befund 27 ist im Ledger als „bewusst offen" geführt mit der Begründung, es handele sich um einen Rundungs- und Herleitungsmangel im Band von n_t (rund 0,2 % am oberen Bandende) bei unberührten Zentralwerten. | C | behoben | Autor-Revision T-0569 (siehe [Autor-Revision T-0569](#autor-revision-t-0569-befunde-12-27-38-60-70-76-98)): wie 27; zusätzlich steht in B4 Rechenschritt 2 eine „Modellgrenze:“ zur Setzung der Jahresraten (gesetzt, nicht gemessen; Wirkung der Alternativen; Ersetzung durch die Jahresdurchschnittsreihe), die Entscheidung ist damit außerhalb des Ledgers sichtbar. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();b=s.split('**Rechenschritt 2 ')[1].split('**Rechenschritt 3 ')[0];c=s.split('**Rechenschritt 3 ')[1].split('**B5 ')[0];raise SystemExit(0 if ('**Modellgrenze:**' in b and 'Median (3,3 %)' in b and 'Typ-Spanne' in c and '7,6–11,7 Bio.' in c) else 1)"` | Vorschlag umgesetzt, Status vorher `offen`. |
| 77 | Bericht Kap. 2, Registerzeile 60-S092-01 Z. 186, Spalte Studientyp, gegen Registerzeile 60-S093-01 Z. 187 und Langbeleg B5 Z. 409–410 (Tab.… · **Widerspruch (im Bericht unaufgelöst, keine sichtbare Einordnung)** — Befund 29 ist als „bewusst offen" geführt, weil er nur die Begründung des Verzichts auf eine Effektgröße betreffe, nicht deren Wert. | C | behoben | Autor-Revision T-0581 (siehe [Autor-Revision T-0581](#autor-revision-t-0581-befunde-29-30-31-77-78-90)): Registerzeile 60-S092-01, Spalte Studientyp: Plausibilitätsprobe der Kette §5.1 (nicht als Wert) mit 0,696/0,446 je vorsorgendem Gebäude gegen \(s_{\text{bem}} \cdot e_{\text{bem}}\) = 0,35 (Band 0,15–0,416); Kopplung S092 ↔ S093 in der Zeile und in B5 vermerkt; Spiegel in `docs/evidenz/register.md` nachgezogen. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-S092-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;b=s.split('**B5 — 60-S093-01')[1].split('**B6 — ')[0];raise SystemExit(0 if all(x in c[4] for x in ('0,696','0,446','Plausibilitätsprobe der Kette §5.1 (nicht als Wert)','Kopplung S092 ↔ S093')) and 'Kopplung S092 ↔ S093' in b and 'Registerzeile 60-S092-01' in b else 1)"` | Vorschlag in Runde 3; umgesetzt T-0581 |
| 78 | Bericht Kap. 2, Registerzeile 60-S093-01 Z. 187 (Effektgröße „Gebäudetyp (3 Klassen)") und Kapitel 2 insgesamt (Z. 152–500), gegen §3.3 Z.… · **Lücke (strukturabhängige Evidenz nicht durchgezogen, Nichtverwendung nicht als Modellgrenze ausgewiesen)** — Befund 30 ist als „bewusst offen" geführt mit der Begründung, die fehlende Typstruktur sei „eine noch auszuweisende Modellgrenze". Ausgewiesen ist sie bis heute nicht: In Kapitel 2 kommen „je Gebäudetyp", „typabhängig" und „Typstruktur" je null mal vor, §3.3… | C | behoben | Autor-Revision T-0581 (siehe [Autor-Revision T-0581](#autor-revision-t-0581-befunde-29-30-31-77-78-90)): §3.3 neuer Absatz „Typstruktur — Modellgrenze“ mit Richtung (EFH-Zellen unterschätzt, MFH-Zellen überschätzt) und Größenordnung (Faktor 1,15–1,25 bzw. 0,63–0,77; Abschätzung von KAP3); Kap. 9 Ansatz (a) auf den umgesetzten Aufbau gezogen (Typachse nicht im Schadensgrad, Gebäudetyp im Wertsatz). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split(chr(10)+'### 3.3 ')[1].split(chr(10)+'### 3.4 ')[0];k9=s.split(chr(10)+'## 9 ')[1].split(chr(10)+'## Entscheidungslog')[0];raise SystemExit(0 if '*Typstruktur — Modellgrenze' in t and all(x in t for x in ('**Richtung:**','**Größenordnung:**','+15 % bis +25 %','−23 % bis −37 %','**typunabhängig**')) and 'Gebäudetyp ·' not in k9 and 'Typachse von FLEMOps' in k9 else 1)"` | Vorschlag in Runde 3; umgesetzt T-0581 |
| 79 | §4.7 Z. 1400–1405 (Gewicht (2024-t+1)/23; „2020 mit 5/23 = 21,7 %", „2014 mit 11/23 = 47,8 %"), Z. 1416–1426 (Verfallsregel „Gewicht 1/24… · **Fehler (falsche Gewichtung in einer bezifferten Modellgrenze)** — Der Wächter beziffert den bereits im kalibrierten Niveau steckenden Anteil einer Vor-2025-Maßnahme über ein Zählgewicht der Kalibrierjahre (1/23 je Jahr). | B | behoben | Autor-Revision T-0577: §4.7 rechnet den im Niveau steckenden Anteil einer Vor-2025-Maßnahme mit dem Betragsanteil \(g_t = \sum_{s \ge t} A_s / \sum_s A_s\) (Ankerreihen-CSV) statt mit \((2024-t+1)/23\), mit Rechenweg in Worten und zwei Beispielen (2020: 40,2 %, 2014: 53,7 %) und der Schiefe der Reihe als Grund; Modellgrenze nachgezogen (59,8 und 46,3 Prozentpunkte, bis 93,9 %, 30,0 bis 49,1 % für Nachrüstjahre 2010–2015), Verfallsregel auf den Betragsanteil des neuen Jahres am erweiterten Fenster gestellt. | `python3 -c "import csv;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('\n### 4.7 ')[1].split('\n### 4.8 ')[0];a={int(x['jahr']):float(x['wert_mrd_eur'].replace(',','.')) for x in csv.DictReader(open('docs/evidenz/60_gdv_jahresreihe_2002_2024.csv',encoding='utf-8'),delimiter=';')};g=lambda t:sum(v for j,v in a.items() if j>=t)/sum(a.values())*100;f=lambda x:('%.1f'%x).replace('.',',');raise SystemExit(0 if all(t in k for t in (f(g(2020))+' %',f(g(2014))+' %',f(100-g(2020))+' Prozentpunkte',f(100-g(2014))+' Prozentpunkte',f(100-g(2024))+' %',f(100-g(2010))+' bis '+f(100-g(2015))+' %','Betragsanteil')) and '78,3 Prozentpunkte' not in k and 'rund der Hälfte bis zu drei' not in k else 1)"` | Vorschlag in Runde 3 |
| 80 | Kap. 9, Kriterienraster Z. 2462, Zeile „Maßnahmen-Anschluss", Spalte (a): „der Objektschutz-Hebel S092 greift als Faktor auf den… · **Widerspruch (Bericht gegen Bericht, am entscheidungstragenden Kriterium)** — Kap. 9 wertet Ansatz (b) im selben Feld gerade deshalb ab, weil S092 sich dort „nur als pauschaler Abschlag auf das Gesamtergebnis anhängen" ließe, „ohne Wirkungsort (§3.5)" — genau das ist aber die heute umgesetzte Form in (a): r_{\text{S092}} multipliziert… | C | offen | — | — | Vorschlag in Runde 3 |
| 81 | Kap. 9 „Umsetzungsgrundlage" Z. 2490–2492 („(b) bleibt als Ergänzungsmodul vorgesehen: als grober Plausibilitätsrahmen für Kommunen, in… · **Lücke (Zwei-Kanäle-Risiko nicht ausgeschlossen)** — Das Ergänzungsmodul (b) berechnet für dieselbe Kommune, dasselbe Konto K3 und dasselbe Bezugsjahr einen zweiten Euro-Betrag aus anderer Datenbasis (Flächenschadensrate B2). | C | offen | — | — | Vorschlag in Runde 3 |
| 82 | Bericht §3.2 „Datenebenen nach §3.1", Zeile GEBAEUDEWERT Z. 563 — Spalte „Quelle / Beschaffungsweg": „Wertsätze aus ImmoWertV Anlage 4 (NHK… · **Widerspruch/Lücke in der Kennzeichnung** — n_t ist ein Mischwert. Der Kern (NHK 2010, Indexierung 2010 → 2023) ist belegt und in dieser Sitzung nachgerechnet; die Fortschreibung 2023 → 2026 mit dem Faktor 1,105 ist dagegen ausdrücklich eine Abschätzung von KAP3, weil „eine… | C | behoben | Vorschlag (a) und (b) umgesetzt: Bericht §3.2, Zeile GEBAEUDEWERT, Spalte „Normierung/Zentrierung" trägt hinter „Preisstand 2026 einheitlich" den Vermerk „(Indexierung 2010 → 2023 belegt; Fortschreibung 2023 → 2026 mit Faktor 1,105 = Abschätzung von KAP3, §3.9, Band 1,07–1,16, Herleitung B4)"; §3.4 nennt die Wertsätze „im Kern belegt, mit abgeschätztem Fortschreibungsfaktor (§3.9)" statt „belegt" — Text und Blockkennzeichnung `abschaetzung_kap3` sagen dasselbe. Vorschlag (c) (Lint-Regel) nicht umgesetzt, siehe [Autor-Revision T-0567](#autor-revision-t-0567-befunde-24-57-74-82) (T-0567). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=lambda a,b: s.split('\n### '+a+' ')[1].split('\n### '+b+' ')[0];raise SystemExit(0 if 'Fortschreibung 2023 → 2026 mit Faktor 1,105 = Abschätzung von KAP3' in t('3.2','3.3') and 'sind belegt und auf den Preisstand' not in t('3.4','3.5') else 1)"` | Vorschlag in Runde 3; Teil (c) bewusst nicht in diesem Paket (Ticketzuschnitt: Bericht §3.1/§3.2 und Ledger, keine Lint-Änderung), die Kennzeichnung ist mit (a)/(b) an allen drei Stellen einheitlich |
| 83 | Bericht Kapitel 7 Kopf Z. 1845 („Kap. 7 führt je rechnendem Parameter aus §3.5 und §4.8 einen Block: die Kostensätze …, die Parameter der… · **Lücke/Widerspruch (Vollständigkeit der Parameter-Blöcke)** — In dieser Sitzung maschinell gegenübergestellt — `python3 -c "…[l.split('id:')[1] for l in L[1842:2185] if l.strip().startswith('id:')]"` liefert 22 Block-IDs, die §4.8-Tabelle führt 15 rechnende Parameter des Kalibrierkapitels. | B | behoben | Autor-Revision T-0578 (siehe [Autor-Revision T-0578](#autor-revision-t-0578-befunde-83-84-85-86-99)): Bericht Kap. 7 führt jetzt für jede der 36 Zeilen der Tabelle §4.8 einen Block; 28 Blöcke sind neu (Anker, Baupreisanstieg, Klassenraten der Bestandsschranke, Typ-Mix, \(M_0\) mit Eingängen, Plausibilitätsschranke min/max, beide Prüftoleranzen, \(U\), \(E_{\text{fonds}}\), Fortschreibungsrate, \(w\), \(f_{\text{fluss}}\), \(N\), \(O_u\), \(O_M\), Gebäudewert reiner EFH/ZFH-Satz, \(f_{\text{AWM}}\), \(q_0\)); zwei Zeilen zeigen auf vorhandene Blöcke (Unsicherheitsband \(\lambda\) → `band` von `flood_bldg.lambda`, gedeckelte Schadensquote → `flood_bldg.d_5`), benannt im neuen Kopfabsatz „Zuordnung der Zeilen aus §4.8“. Neue Anker `#anker-gdv`, `#modellsumme-m0`, `#verteilungspruefung`, `#sanity-band`. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 7 ')[1].split(chr(10)+'### 7.1 ')[0];bl={re.search(r'^  id: (\S+)$',b,re.M).group(1):b for b in re.split(r'^parameter:$',k,flags=re.M)[1:]};t=s.split(chr(10)+'### 4.8 ')[1].split(chr(10)+chr(96)*3)[0];z=[l for l in t.split(chr(10)) if l.startswith(chr(124)+' ') and not l.startswith(chr(124)+' Parameter ')];neu=['a_ver', 'baupreisanstieg_2023_2024', 'rate_bestand_gk3_gk4', 'rate_bestand_gk2', 'theta_efh_zfh', 'm0', 'wohnflaeche_je_wohngebaeude', 'wert_je_wohngebaeude', 'w_wohn', 'adressen_gk3_gk4', 'adressen_gk2', 'r_gk3_gk4', 'r_gk2', 'lambda_schranke_min', 'lambda_schranke_max', 'toleranz_verteilungspruefung', 'niveau_quantilvergleich', 'sanity_u', 'e_fonds', 'fondsrate', 'w_aufbauhilfe', 'f_fluss', 'n_ankerfenster', 'sanity_o_u', 'sanity_o_m', 'gebaeudewert_efh_om', 'f_awm', 'q0'];alt=['w_wg', 'u', 'phi_fluss', 'kappa', 'pi', 'lambda', 'k_bgf', 'n_efh_zfh', 'n_mfh', 'd_5'];ids=['flood_bldg.'+x for x in neu+alt];raise SystemExit(0 if len(z)==36 and all(i in bl for i in ids) and 'Zuordnung der Zeilen aus §4.8' in k and 'Feld \x60band\x60 des Blocks \x60flood_bldg.lambda\x60' in k else 1)"` | Vorschlag in Runde 3; umgesetzt T-0578 |
| 84 | Bericht Kapitel 7, Block `flood_bldg.p_hq_haeufig` Z. 1971–1983, Feld `band: null` (Z. 1975) bei `wert: 0.1` (Z. 1973) und `herkunft… · **Lücke (Unsicherheitsband der Quelle geht beim Übergang ins Maschinenformat verloren)** — Der Kartenfall HQ10 ist nicht bundesweit gesetzt — die Länder kartieren „häufig" zwischen HQ5 und HQ20, das Register beziffert die Spanne mit 2,0·10⁻¹ bis 5,0·10⁻² a⁻¹, also Faktor 4 um den gesetzten Wert. | B | behoben | Autor-Revision T-0578 (siehe [Autor-Revision T-0578](#autor-revision-t-0578-befunde-83-84-85-86-99)): Block `flood_bldg.p_hq_haeufig` trägt `band: [0.05, 0.2]` aus Registerzeile 60-W085-01; die Wirkung ist im Kap.-7-Kopf beziffert (Trapezsumme je Zelle vor \(\lambda\) 0,63- bis 1,73-fach, Anteil des häufigen Szenarios 46 bis 80 % statt 66 %; Bundessumme unberührt); `flood_bldg.p_hq100` trägt `band_grund: "definitorisch (HQ100, § 74 WHG)"`. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 7 ')[1].split(chr(10)+'### 7.1 ')[0];bl={re.search(r'^  id: (\S+)$',b,re.M).group(1):b for b in re.split(r'^parameter:$',k,flags=re.M)[1:]};h=bl['flood_bldg.p_hq_haeufig'];c=bl['flood_bldg.p_hq100'];raise SystemExit(0 if '  band: [0.05, 0.2]' in h and 'band: null' not in h and '  band_grund: ' in c and '0,63-Fache' in k and '1,73-Fache' in k else 1)"` | Vorschlag in Runde 3; umgesetzt T-0578 |
| 85 | Bericht Kapitel 7, Block `flood_bldg.lambda`, Feld `vorlaeufig_grund` Z. 2178 („Weiterhin vorlaeufig, weil die Ledger-Befunde 33… · **Widerspruch (drei Stellen, drei verschiedene Begründungen desselben Vorläufigkeitsvermerks)** — Der Zahlenwert ist geprüft und stimmt (`python3 -c "print(round(1.132/1.360,4))"` → 0,8324 gegen 0,832, Abweichung −0,05 %), ebenso das Band [0.11, 3.44] gegen §4.8 Z. 1467. | C | behoben | Autor-Revision T-0578 (siehe [Autor-Revision T-0578](#autor-revision-t-0578-befunde-83-84-85-86-99)): `vorlaeufig_grund` im Block `flood_bldg.lambda` nennt nur noch den offenen Grund (Verteilungsprüfung §4.5 nicht bestanden, 13,9 gegen 11,5 Pp) und verweist auf §4.4 `#niveau-skalar`, ohne Befundnummern; die §4.8-Zeile \(\lambda\) nennt denselben Grund statt „offene Ledger-Befunde 33 und 34“. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 7 ')[1].split(chr(10)+'### 7.1 ')[0];bl={re.search(r'^  id: (\S+)$',b,re.M).group(1):b for b in re.split(r'^parameter:$',k,flags=re.M)[1:]};b=bl['flood_bldg.lambda'];g=re.search(r'^  vorlaeufig_grund: (.*)$',b,re.M).group(1);t=s.split(chr(10)+'### 4.8 ')[1].split(chr(10)+chr(96)*3)[0];raise SystemExit(0 if '33' not in g and 'Verteilungspruefung (§4.5) nicht bestanden' in g and '#niveau-skalar' in g and 'Ledger-Befunde 33 und 34' not in t else 1)"` | Vorschlag in Runde 3; umgesetzt T-0578 |
| 86 | Bericht Kapitel 7, Blöcke `flood_bldg.f_s093` Z. 2069–2081 und `flood_bldg.f_s094` Z. 2083–2095 (`wert: 1.0`, `band: [0.71, 1.40]` bzw.… · **Lücke (Status „neu anzulegen/geparkt" der Datenebene wird nicht ins Maschinenformat übernommen)** — Kapitel 7 ist die Schnittstelle zur Produkt-Registry; was dort nicht als Feld steht, kommt im Produkt nicht an. | C | behoben | Autor-Revision T-0578 (siehe [Autor-Revision T-0578](#autor-revision-t-0578-befunde-83-84-85-86-99)): Jeder Block trägt `datenebene:` (Ebene aus §3.2 oder `null`), bei genannter Ebene `ebene_status:` (`neu_anzulegen` für HQ_FLAECHE, HQ_TIEFE, GEBAEUDEWERT; `geparkt` für GEBAEUDEZUSTAND_BAUSTOFF); `flood_bldg.f_s093`/`f_s094` zusätzlich `platzhalter: true` und `platzhalter_text: "neutral gesetzt, Datenebene fehlt (§3.2)"`; der Kap.-7-Kopf beschreibt die Felder. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 7 ')[1].split(chr(10)+'### 7.1 ')[0];bl={re.search(r'^  id: (\S+)$',b,re.M).group(1):b for b in re.split(r'^parameter:$',k,flags=re.M)[1:]};st=('vorhanden','neu_anzulegen','geparkt');ok=all(re.search(r'^  datenebene: \S+$',b,re.M) for b in bl.values());e=[b for b in bl.values() if not re.search(r'^  datenebene: null$',b,re.M)];ok2=all(re.findall(r'^  ebene_status: (\S+)$',b,re.M) in ([x] for x in st) for b in e);g=all('  datenebene: GEBAEUDEZUSTAND_BAUSTOFF' in bl['flood_bldg.'+x] and '  ebene_status: geparkt' in bl['flood_bldg.'+x] and '  platzhalter: true' in bl['flood_bldg.'+x] for x in ('f_s093','f_s094'));n=all('  ebene_status: neu_anzulegen' in bl['flood_bldg.'+x] for x in ('p_hq_haeufig','p_hq100','p_hq_extrem','n_efh_zfh','n_mfh','k_bgf'));raise SystemExit(0 if ok and ok2 and g and n and '\x60ebene_status:\x60' in k else 1)"` | Vorschlag in Runde 3; umgesetzt T-0578 |
| 87 | Bericht §4.8, Parametertabelle Z. 1461–1475 und Testblock `beispiel_60_kalibrierung` Z. 1477–1573, gegen `backend/scripts/kalibrierung/`… (Werkzeugbefund) · **Lücke** — Die Kalibrierung von #60 — Zielwert A^{*}, Modellsumme M_0, Niveau-Skalar \lambda samt Band und Plausibilitätsschranke — existiert ausführbar nur als Testblock im Methodikbericht. | B | offen | — | — | Vorschlag in Runde 3 |
| 88 | Bericht §4.8, Parametertabelle Z. 1461–1475 (abschließend formuliert: „Parameter dieses Kapitels") gegen den Testblock Z. 1485 (`208.0 *… · **Lücke (Vorgabe P1)** — P1 verlangt eine nutzersichtbare Parameterliste mit Quelle oder ausgewiesener KAP3-Abschätzung samt Herleitung für alle Parameter und stellt ausdrücklich klar, dass eine Herleitung nur als Code-Kommentar die Vorgabe nicht erfüllt. | B | behoben | Bericht §4.8 unter unveränderter Überschrift „Parameter dieses Kapitels“: eigene Zeilen für Wohngebäudeanteil 0,872 (Quelle), \(r_{\text{GK3+GK4}}\) und \(r_{\text{GK2}}\) (Zentralwert Quelle `m0_klassenraten.csv` mit Zeile und Spalte, Band Abschätzung von KAP3), BGF-Faktor 1,30 (1,25–1,40), Wertsätze 1.950 (1.890–2.043) und 1.533 (1.485–1.606), Wohnfläche 208 m², Gebäudewert 527.280 € mit seinen drei Bausteinen; \(E_{\text{nom}}\), \(w_u\), \(f_{\text{fluss}}\) standen seit T-0574 als \(E_{\text{fonds}}\), \(w\), \(f_{\text{fluss}}\) in der Tabelle, \(T_u\) ist durch die gezählte Fensterlänge \(N\) ersetzt; Block `beispiel_60_kalibrierung` rechnet die neuen Zwischenwerte und die Sensitivität nach — siehe [Autor-Revision T-0576](#autor-revision-t-0576-befunde-37-88) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split(chr(10)+'### 4.8 ')[1].split(chr(96)*3+'python')[0];z=[l for l in t.split(chr(10)) if l.startswith(chr(124)+' ')];f=lambda a,b:any(a in l and b in l for l in z);ok=s.split(chr(10)+'### 4.8 ')[1].startswith('Parameter dieses Kapitels') and f('Wohngebäudeanteil je Adresse','0,872 (kein Band)') and f('0,0059796 a⁻¹ (0,0033–0,0103)','Zeile '+chr(96)+'gk3_gk4;alle'+chr(96)) and f('0,00067515 a⁻¹ (0,000301–0,001154)','Zeile '+chr(96)+'gk2;alle'+chr(96)) and f('1,30 (1,25–1,40)','**Abschätzung von KAP3**, Herleitung §3.4 Schritt 3') and f('1.950 €₂₀₂₆/m² BGF (1.890–2.043)','**Quelle:** Register 60-R24-01') and f('1.533 €₂₀₂₆/m² BGF (1.485–1.606)','**Quelle:** Register 60-R24-01') and f('Wohnfläche je Wohngebäude','208 m² (kein Band)') and f('527.280 €₂₀₂₆','208 m² · 1,30 · 1.950') and f('60_wiederaufbauhilfen_2013_2021.csv','**Quelle:** AufbhG 2013') and f('0,11 (0,06–0,17)','Abschätzung von KAP3') and f('0,90 (0,80–1,00)','Abschätzung von KAP3') and f('23 a (2002–2024)','**gezählt**') and f('2 %/a','**Abschätzung von KAP3**: Setzung in §4.6') and 'w_wohn = 0.872' in s and 'assert abs(208.0 * 1.30 * 1950.0 - 527280.0)' in s;raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 3, erste Alternative (Zeilen aufnehmen) umgesetzt; die Überschrift „Parameter dieses Kapitels“ bleibt und ist damit zutreffend. |
| 89 | Bericht §4.8 Z. 1467 (\lambda-Zeile: „M_0 aus den gemessenen Klassenraten GK3+GK4 und GK2… · **Lücke (Nachprüfbarkeit der Fundstelle)** — Die Werte selbst stimmen zeichengenau (Nachrechnung 2). Die Fundstellenangabe benennt aber nur Klasse und Kommune, während die CSV in derselben Zeile zwei Ratenspalten führt: `rate_zellen_1_pro_a` (0,004197318695391 bzw. 0,000436059863136) und… | C | behoben | Bericht §4.8 λ-Zeile und die beiden Kommentare im Beispielblock nennen Zeile und Spalte; Begründung der Spaltenwahl steht in §4.3 Punkt 3 — siehe Autor-Revision T-0570 | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('\n### 4.8 ')[1].split('\n## 5 ')[0];raise SystemExit(0 if k.count('rate_exponiert_hqextrem_1_pro_a')>=3 and 'gk3_gk4;alle' in k and 'gk2;alle' in k and 'Wahl des Nenners' in s else 1)"` | Vorschlag in Runde 3; umgesetzt T-0570 |
| 90 | Bericht Kap. 2, Registerzeile 60-W085-01 Z. 164 (Spalten Effektgröße, Modellgrenze und Entscheidung), gegen §3.4 Z. 670 / Beispielblock Z.… · **Lücke (bewusst offene Entscheidung ohne sichtbare Modellgrenze)** — Befund 31 ist im Ledger als „bewusst offen" geführt mit der Begründung, p_3 stehe mit Herleitung in §3.4/§3.5 und als Produkt-Block in Kap. 7, es fehle nur der Eintrag in der Registerzeile. | C | behoben | Autor-Revision T-0581 (siehe [Autor-Revision T-0581](#autor-revision-t-0581-befunde-29-30-31-77-78-90)): Registerzeile 60-W085-01, Spalten Modellgrenze und Entscheidung: Zusammenziehung des Extrembands auf den Zentralwert \(p_3\) als bewusste Entscheidung mit Verweis auf §3.4 Schritt 2 benannt; Entscheidung „Basiswert“ nennt \(p_3\) ausdrücklich. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-W085-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;raise SystemExit(0 if all(x in c[6] for x in ('zum Zentralwert','2,236·10⁻³','§3.4 Schritt 2')) and 'Zentralwert' in c[8] and '2,236·10⁻³' in c[8] else 1)"` | Vorschlag in Runde 3; umgesetzt T-0581 |
| 91 | Ledger-Eintrag zu Befund 34 (Übersichtstabelle Z. 59 und Autor-Revision Z. 1759: „Band 0,22–1,66 aus dem Tukey-Fence-Test") gegen Bericht… · **Divergenz Ledger ↔ Bericht (abgelöste Fundstelle nicht als abgelöst vermerkt)** — Die Regression von Befund 34 verlangt, die im Ledger genannten Zahlen an der genannten Fundstelle nachzulesen. | C | behoben | Ledger Befund 34 (Kopftabelle und Autor-Revision nach Runde 2) um den Ablösungsvermerk 0,22–1,66 → 0,11–3,44 → 0,11–3,49 → 0,12–3,93 ergänzt; Bericht §4.1a Tukey-Fence: liefert das Band von \(A_{\text{ver}}\), das \(\lambda\)-Band folgt aus §4.4 — siehe Autor-Revision T-0571 | `python3 -c "p=chr(124);l=open('reviews/BEFUNDE_60.md',encoding='utf-8').read().split('\n');s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=[z for z in l if z.startswith(p+' 34 '+p+' Bericht §4.1')]+[z for z in l if z.startswith(p+' 34 '+p+' A '+p+' **Zusammenfassung')];ok=len(k)==2 and all('**abgelöst:** das Band 0,22–1,66' in z and '0,12–3,93' in z for z in k);t=s.split('**Herleitung des Ausreißerbands (Tukey-Fence).**')[1].split('\n\n')[0];ok=ok and 'Der Tukey-Fence-Test liefert damit das Band von' in t and '(1,061–1,838 Mrd. €), **nicht**' in t and '§4.4 (0,12–3,93)' in t;raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 3; umgesetzt T-0571 |
| 92 | Bericht §7.2 Z. 2288 („sinkt die kalibrierte Bundessumme K3 von 0,99 Mrd. €₂₀₂₆/a") und Z. 2303 (`A_stern = 1.6 * 0.65 * 1.54 * 0.50 * 1.15… · **Widerspruch (abgelöster Stand).** — Der erste Faktor der Ankerkette ist im Beispielblock 1,6 statt des heute geltenden A_{\text{ver}} = 1,838 aus der Kleinste-Quadrate-Bestimmung (§4.1). | B | behoben | Bericht §7.2 Beispielblock `beispiel_60_zeitwert`: \(A^{*}\) aus der Kette mit \(A_{\text{ver}}\) = 1,838 (§4.2) mit Zusicherung 1,132, \(M_0\) = 1,243 mit typgewichtetem Wertsatz (§4.3), \(U\) = 0,0103 (§4.6); Ergebnis-Sensitivität geht von 1,132 Mrd. €₂₀₂₆/a aus; §4.8-Zeile \(f_{\text{AWM}}\) nachgezogen — siehe [Autor-Revision T-0573](#autor-revision-t-0573-befunde-41-53-92-93-100) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();z=s.split('\n### 7.2 ')[1].split('\n## 8 ')[0];ok='A_stern = 1.838 * 0.65 * 1.54 * 0.50 * 1.15 * 1.07' in z and 'A_stern = 1.6 ' not in z and 'U = 1.6 ' not in z and 'assert abs(M0 - 1.243)' in z and '**1,132 Mrd. €₂₀₂₆/a** (§4.2, §4.6)' in z and '0,99' not in s and abs(1.838*0.65*1.54*0.50*1.15*1.07-1.132)<5e-3;raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 3; umgesetzt T-0573 (Kap. 6 Z. 1827 und Log Nr. 7 schon mit T-0571). |
| 93 | Bericht §7.2, Begründung 1 Z. 2250–2251 (1,51 / 2,08) gegen Z. 2293 (1,32) und Beispielblock Z. 2311–2312 (`1.32` / `1.81`) · **Widerspruch (innerhalb desselben Abschnitts).** — Dieselbe Aussage — „wird nur der Basiswert auf den Zeitwert gesetzt, steigt λ auf …" — trägt im selben Abschnitt zwei Zahlenpaare, weil die Prosa mit A^{*} = 1,132 und der Block mit 0,985 rechnet (beide Rechnungen in dieser Sitzung nachvollzogen, Abweichung… | B | behoben | Bericht §7.2: Begründung 1 auf \(M_0\) = 1,243 gerechnet (1,66 / 2,28) und als maßgebliche \(\lambda\)-Angabe gekennzeichnet; die zweite Angabe in der Ergebnis-Sensitivität gestrichen und durch Verweis auf Begründung 1 ersetzt; der Beispielblock sichert 1,66 / 2,28 zu — siehe [Autor-Revision T-0573](#autor-revision-t-0573-befunde-41-53-92-93-100) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();z=s.split('\n### 7.2 ')[1].split('\n## 8 ')[0];ok='1,132 / (1,243 · 0,55) =\n   **1,66**' in z and '1,132 / (1,243 · 0,40) = **2,28**' in z and 'maßgebliche' in z and '(Werte in Begründung 1)' in z and all(x not in z for x in ('1,51','2,08','1,32','1,81','1.32','1.81','1,360')) and 'assert abs(A_stern / (M0 * f_mid) - 1.66)' in z and 'assert abs(A_stern / (M0 * f_lo) - 2.28)' in z;raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 3; umgesetzt T-0573 |
| 94 | Bericht Abschnitt `## Ergebnis` Z. 35 („M_0 = 1,360 Mrd. €₂₀₂₆/a und \lambda = 0,724") gegen §4.4 Z. 1230 (\lambda = 0,832), §4.5 Z. 1381… · **Widerspruch (abgelöster Stand an der meistgelesenen Stelle).** — Der Ergebnisabschnitt ist die Kurzfassung des Berichts und verweist selbst auf „Kap. 4"; der dort geführte Skalar ist seit der Kleinste-Quadrate-Ankerbestimmung 0,832. | B | behoben | Bericht Abschnitt Ergebnis, Offen (1): \(M_0\) = 1,243 und \(\lambda\) = 0,911 mit Vermerk, dass die Werte in §4.3/§4.4 gepflegt werden — siehe Autor-Revision T-0571 | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();e=s.split('\n## Ergebnis\n')[1].split('\n## ')[0];ok='0,724' not in e and '1,360' not in e and '= 1,243 Mrd. €₂₀₂₆/a und ' in e and '= 0,911 (Werte nachgezogen 23.09.2026' in e and 'wert: 0.911' in s and '= 1,132 / 1,243 = **0,911**' in s;raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 3; umgesetzt T-0571 |
| 95 | Bericht §7.2 Z. 2262 und §4.8 Z. 1474 (f_{\text{AWM}}); Zeichentabellen §3.5 Z. 750 und §5.1.1 Z. 1602 (nur zitiert); Kapitel 7… · **Lücke (Prüfpunkt E4 aus §8).** — E4 verlangt für jedes Formelzeichen Bedeutung in Klartext samt Einheit, Fundstelle „Zeichentabellen in Abschnitt 3, Parameter-Blöcke in Abschnitt 7". f_{\text{AWM}} ist an beiden vorgesehenen Orten nicht geführt: §3.5 deckt laut Überschrift nur die Kapitel 3… | C | behoben | Autor-Revision T-0568: Bericht §3.5, Zeile \(f_{\text{AWM}}\) mit Bedeutung in Klartext, Einheit „– (Verhältnis RND/GND)" und dem ausdrücklichen Vermerk, dass der Faktor nur als Sensitivität läuft und deshalb keinen eigenen Parameter-Block in Kap. 7 trägt. | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('\n### 3.5 ')[1].split('\n### 3.6 ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];a=[c for c in r if 'AWM' in c[0]];raise SystemExit(0 if a and 'RND/GND' in a[0][2] and 'Parameter-Block' in a[0][1] and 'herleitung:' in a[0][3] else 1)"` | Vorschlag in Runde 3 |
| 96 | Bericht §4.6, Bandtabelle Z. 1362/1363 (U = 0,0103; O = 6,29 Mrd. €₂₀₂₆/a), Neufassungsabsatz Z. 1353–1358, Ist-Lage Z. 1381–1385… · **Lücke (Sanity-Band ohne Trennschärfe, Weitung nicht ausgewiesen)** — Die Neufassung nach Befund 35 beseitigt die Zirkularität (U enthält keine der sechs Ankergrößen) und den fehlenden Klassenbezug der Obergrenze — das ist erfüllt. | B | behoben | Bericht §4.6: Weitung beziffert (Runde 2 Faktor 3,5, T-0333 Faktor 611, jetzt Faktor 58) und begründet, Band vorab fixiert; \(U\) trennschärfer aus beiden Fondsvolumina (0,189 statt 0,0103) mit Empfindlichkeit 0,095–0,315; Abstand des Ist-Werts als Kennzahl (6,0-Faches der Untergrenze, 10 % der unabhängigen Obergrenze) — siehe [Autor-Revision T-0574](#autor-revision-t-0574-befunde-35-61-64-96-97) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.6 ')[1].split(chr(10)+'### 4.7 ')[0];ok=all(x in k for x in ('**Weitung ausgewiesen und fixiert (Befund 96).**','Spannweite **Faktor 58**','Faktor 611','**6,0-Fachen**','vorab fixiert','Empfindlichkeit von')) and abs((8*1.02**13+30*1.02**5)/9*0.9/23-0.189)<5e-4 and abs(30*1.02**5/3-11.04)<5e-3 and abs(1.132/0.189-6.0)<5e-2;raise SystemExit(0 if ok else 1)"` | Vorschlag „beide Volumina“ umgesetzt, auf das Ankerfenster (23 a) statt auf 13 Jahre umgelegt, weil die Kalibrierjahre 2002–2024 sind (§4.7). |
| 97 | Bericht §4.8 P1-Tabelle Z. 1459–1474, insbesondere die Zeile U Z. 1472, gegen §4.6 Z. 1362 (w = 1/3·1/3 ≈ 0,11; f_{\text{fluss}} = 0,90; T… · **Lücke (Vorgabe P1 „Gilt für alle Parameter"; §3.9 „Unzulässig: … Bandgrenzen, Referenzwerte")** — Befund 37 verlangte, jeden in Kapitel 4 rechnenden Wert mit Wert, Band und Kennzeichnung in die P1-Tabelle aufzunehmen, und beanstandete ausdrücklich, dass die damalige Betroffenheit 1/100 a „nur als Wort in der Herleitungsspalte von O vor[kommt], ohne eigene… | B | behoben | Bericht §4.8: eigene Zeilen für \(E_{\text{fonds}}\) (Quelle), \(w\) 0,11 (0,06–0,17) und \(f_{\text{fluss}}\) 0,90 (0,80–1,00) je „Abschätzung von KAP3, Herleitung §4.6“, \(N\) = 23 a (gezählt, ersetzt \(T\) = 100 a), \(U\) mit Band und Verweis, \(O_u\); Kopfzeile 37 um den Ablösungsvermerk ergänzt — siehe [Autor-Revision T-0574](#autor-revision-t-0574-befunde-35-61-64-96-97) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split(chr(10)+'### 4.8 ')[1].split(chr(10)+'## 5 ')[0];l=[z for z in open('reviews/BEFUNDE_60.md',encoding='utf-8').read().split(chr(10)) if z.startswith(chr(124)+' 37 '+chr(124)+' Bericht')];ok=all(x in t for x in ('Wohngebäudeanteil der Aufbauhilfe-Mittel','0,11 (0,06–0,17)','flussseitiger Anteil der Aufbauhilfe-Ereignisse','0,90 (0,80–1,00)','Länge des Ankerfensters für','23 a (2002–2024)')) and t.count('Abschätzung von KAP3, Herleitung §4.6')>=2 and len(l)==1 and 'Klassenraten Bestandsschranke' in l[0] and 'T-0574' in l[0];raise SystemExit(0 if ok else 1)"` | \(T\) entfällt mit T-0574; an seiner Stelle steht die gezählte Fensterlänge \(N\). |
| 98 | Bericht §4.2 Z. 1093 und Z. 1120–1121, §4.8 Z. 1466 (je „1,07 (1,04–1,11)"), Beispielblock Z. 1483–1484 (`* 1.11`, `assert abs(hi - 2.263)… · **Fehler (fortbestehender Rundungsfehler ohne sichtbare Modellgrenze; neue Folgewirkung)** — Befund 38 ist im Ledger als „bewusst offen" geführt mit der Begründung, der Rundungsfehler werde mit Befund 27 nachgezogen. | C | behoben | Autor-Revision T-0569 (siehe [Autor-Revision T-0569](#autor-revision-t-0569-befunde-12-27-38-60-70-76-98)): wie 38; zusätzlich Plausibilitätsschranke und \(\lambda\)-Band oben 3,49 (2,291/0,657) statt 3,44 in §4.1a, §4.4, §4.8, Block `flood_bldg.lambda`, Entscheidungslog Nr. 8 und Beispielblock (`lam_hi`, `schranke_hi`); \(M_0\)-Band 0,657–2,638 (aus Befund 27). Zentralwert \(\lambda\) = 0,832 unverändert, alle vier Fenster-\(\lambda\) (§4.1a) weiter innerhalb. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();raise SystemExit(0 if ('3,44' not in s and '3.44' not in s and s.count('[0,12; 3,93]')>=3 and 'band: [0.12, 3.93]' in s and 'assert abs(schranke_hi - 3.93)' in s and '0,583–2,425' in s) else 1)"` | Vorschlag umgesetzt, Status vorher `offen`. |
| 99 | Bericht Kap. 7, Einleitungssatz Z. 1845 („Kap. 7 führt je rechnendem Parameter aus §3.5 und §4.8 einen Block"), Blockliste Z. 1869–2168 (22… · **Lücke (§4 „Parameter-Block-Format … wird per Skript in die Produkt-Registry extrahiert"; Vorgabe P1 „gilt für alle Parameter"; §5 LF 12)** — Der Vorschlag zu Befund 40 lautete „je Parameter aus §3.5 und §4.8 einen Block anlegen", und der Bericht sagt in Z. 1845 von sich selbst, er tue das. | B | behoben | Autor-Revision T-0578 (siehe [Autor-Revision T-0578](#autor-revision-t-0578-befunde-83-84-85-86-99)): Die acht rechnenden §4.8-Zeilen haben Blöcke: `flood_bldg.a_ver` (mit `preisstand_hinweis`, Preisstand 2024 der GDV-Reihe), `baupreisanstieg_2023_2024`, `rate_bestand_gk3_gk4`/`rate_bestand_gk2`, `lambda_schranke_min`/`_max`, `toleranz_verteilungspruefung`, `sanity_u`, `sanity_o_u`, `sanity_o_m` (Preisstand 2026), `f_awm`; jeder mit `kennzeichnung`, `herleitung_anker` und `rolle` (kalibrierung, pruefgroesse, sensitivitaet). | `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 7 ')[1].split(chr(10)+'### 7.1 ')[0];bl={re.search(r'^  id: (\S+)$',b,re.M).group(1):b for b in re.split(r'^parameter:$',k,flags=re.M)[1:]};a=['a_ver', 'baupreisanstieg_2023_2024', 'rate_bestand_gk3_gk4', 'rate_bestand_gk2', 'lambda_schranke_min', 'lambda_schranke_max', 'toleranz_verteilungspruefung', 'sanity_u', 'sanity_o_u', 'sanity_o_m', 'f_awm'];b=[bl.get('flood_bldg.'+x,'') for x in a];ok=all(re.findall(r'^  kennzeichnung: (\S+)$',x,re.M) in (['quelle'],['abschaetzung_kap3']) and re.search(r'^  herleitung_anker: \"#\S+\"$',x,re.M) and re.search(r'^  rolle: \S+$',x,re.M) for x in b);ps=all('  preisstand: 2026' in bl.get('flood_bldg.'+x,'') for x in ('sanity_u','sanity_o_u','sanity_o_m'));raise SystemExit(0 if ok and ps and 'preisstand_hinweis:' in bl.get('flood_bldg.a_ver','') else 1)"` | Vorschlag in Runde 3; umgesetzt T-0578 |
| 100 | Bericht §7.2 Z. 2287–2294 („sinkt die kalibrierte Bundessumme K3 von 0,99 Mrd. €₂₀₂₆/a auf 0,54", Band 0,39–0,74; „bleibt der Betrag bei… · **Fehler (Sensitivität auf überholtem Anker; Bericht widerspricht sich intern)** — Die mit Befund 41 verlangte Ergebnis-Sensitivität des Zeitwertansatzes ist zwar vorhanden, rechnet aber auf dem Ankerwert 1,6 (Z. 2303), der seit der Kleinste-Quadrate-Ankerbestimmung durch 1,838 abgelöst ist; daraus stammt der Ausgangsbetrag 0,99 Mrd.… | B | behoben | Bericht §7.2 Ergebnis-Sensitivität: 1,132 → 0,62 Mrd. €₂₀₂₆/a (Band 0,45–0,85), −0,51 Mrd. bzw. −45 %; Zeitwert je Gebäude 264.949 €₂₀₂₆ (192.691–361.295) auf dem typgewichteten Neuwert 481.726,25 €; Beispielblock auf den geltenden Anker; §4.8 nachgezogen; Kap. 6 und Log Nr. 7 trugen die Werte schon seit T-0571 — siehe [Autor-Revision T-0573](#autor-revision-t-0573-befunde-41-53-92-93-100) | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();z=s.split('\n### 7.2 ')[1].split('\n## 8 ')[0];g=s.split('9. **Bewertung zum Neuwert')[1].split('\n## ')[0];ok=all(x in z for x in ('**0,62 Mrd. €₂₀₂₆/a**','**0,45–0,85 Mrd. €₂₀₂₆/a**','**−0,51 Mrd. €₂₀₂₆/a bzw.','bleibt der\nBetrag bei 1,132 Mrd.','assert abs(A_stern * f_mid - 0.62)','**264.949 €₂₀₂₆** (Band 192.691–361.295')) and all(x not in z for x in ('0,54','0,39–0,74','0,44 Mrd','290.004','527.280')) and '0,62 statt 1,13 Mrd.' in g and abs(1.132*0.55-0.62)<5e-3 and abs(1.132*0.40-0.45)<5e-3 and abs(1.132*0.75-0.85)<5e-3 and abs(1.132*0.45-0.51)<5e-3;raise SystemExit(0 if ok else 1)"` | Vorschlag in Runde 3; umgesetzt T-0573 |
| 101 | Bericht Kap. 8, Quelle 2 Z. 2345–2351, Zellenliste Z. 2346–2347 („Risiken-Monetarisierung“ (Z51, Z54–Z56, Z64, Z65, Z106), „Rechenregeln“… · **Lücke (§3.8 „exakte Fundstelle je zitierter Zelle“; §5 LF 10)** — Quelle 2 zählt die herangezogenen Zellen je Blatt abschließend auf, ohne Zusatz „u. a.“. Fünf Zellen, aus denen der Bericht wörtlich zitiert, fehlen in dieser Aufzählung, und es sind keine Nebenstellen: Rechenregeln Z7 trägt R5… | C | offen | — | — | Vorschlag in Runde 3 |
| 102 | Bericht Kap. 6, Modellgrenze 2 Z. 1805–1809 („Bauform-Grenze der Abschätzung S094 (Vorgabe P2):“), dieselbe Zuordnung in Register… · **Fehler/Lücke (Vorgabe P2 „für Maßnahmen ohne publizierte Effektgröße“; §3.5; §5 LF 12)** — P2 gilt Maßnahmen ohne publizierte Effektgröße. Die einzige solche Größe in #60 ist der Maßnahmen-Hebel S092 (Register 60-S092-01 Z. 186, „Abschätzung von KAP3“, Entscheidungslog Nr. 3). | C | offen | — | — | Vorschlag in Runde 3 |
| 103 | Bericht Kap. 9 Kriterienraster, Zeile „Datenverfügbarkeit“ Z. 2461 („alle vier Eingänge sind frei zugänglich“) und Zeile „Aufwand“ Z. 2464… · **Widerspruch (§3.7 Kriterienraster; §5 LF 12) und untauglich gewordener Prüfausdruck.** — Zwei Dinge, die zusammengehören. (1) Der Zählfehler aus Befund 45 steht unverändert, widerspricht heute aber nicht nur dem Modellkapitel §3.2, sondern der eigenen Ergebniszeile Z. 34 des Berichts; ein Leser findet zwei Zählungen desselben Sachverhalts im… | C | offen | — | — | Vorschlag in Runde 3 |
| 104 | Bericht Kap. 2, Langbeleg B2 — 60-S074-01 (Überschrift Z. 241), Abschnitt „Abgrenzung zur Knoten-Bilanz“ Z. 263–264: „S074 bleibt der… · **Widerspruch im Bericht (§2.1 „verarbeitet oder begründet inaktiv“; §3.2 Kein-Doppelkanal; §5 LF 10)** — Die Korrektur zu Befund 46 ist in der Knoten-Bilanz und im Register vollzogen, im Langbeleg B2 aber nicht nachgezogen. | C | behoben | Autor-Revision T-0579 (siehe [Autor-Revision T-0579](#autor-revision-t-0579-befunde-21-46-47-48-72-104)): Langbeleg B2, „Abgrenzung zur Knoten-Bilanz“: „S074 ist keiner eigenen Formelstelle zugeordnet (Kap. 1, Knoten-Bilanz), sondern wirkt als Sensitivitätsband über FS-Hazard, also über die bereits topographiebasierte HWGK-Wassertiefe (60-W085-01); ein zweiter Topographie-Faktor wäre ein Doppelkanal (§3.2).“ FS-Exposition kommt in B2 nicht mehr vor. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();b=s.split('**B2 — 60-S074-01')[1].split(chr(10)+'**B3')[0];a=b.split('**Abgrenzung zur Knoten-Bilanz:**')[1].split('**Datenlücke')[0];raise SystemExit(0 if 'FS-Exposition' not in b and '**keiner eigenen Formelstelle** zugeordnet' in a and 'Sensitivitätsband über FS-Hazard' in a and 'Doppelkanal (§3.2)' in a else 1)"` | Vorschlag in Runde 3; umgesetzt T-0579 |
...
### Befundregression Teil 8 (43, 44, 45, 46)

Paket T-0391 der Runde 3 (21.09.2026, zweite Hälfte des halbierten T-0369, letztes
Regressionspaket der Runde), eigene frische Sitzung: Sie hat den geprüften Stand nicht geschrieben
(eiserne Regel 4; geschrieben haben T-0235 bis T-0243, T-0256 bis T-0259 und die Revisionspakete
aus T-0281, alle im Endstatus). **In diesem Paket wird keine Leitfrage aus §5 beantwortet und kein
Befund behoben.** Prüfgegenstand ist der **Umsetzungsnachweis im heutigen Berichtsstand**, nicht
die Behauptung im Ledger. **43, 44 und 45** stehen auf „bewusst offen": Geprüft ist, ob die im
Ledger festgehaltene Begründung im heutigen Bericht als Modellgrenze sichtbar ist — nur dann
„bestätigt geschlossen"; trägt die Begründung nur einen Teil des Befunds, lautet das Urteil
„unvollständig geschlossen" (der Befund ist erledigt **erklärt**, aber nicht in seinem ganzen
Umfang). **46** trägt nach der Autor-Revision (Z. 1518) „behoben" und wird gegen den heutigen Text
gehalten. Zeilennummern beziehen sich auf den heutigen Stand von
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (2.513 Zeilen, MD5
`24972e4404a8e1bc0990e63f1959798d`).
**Befundnummern:** höchste zu Laufbeginn im Ledger vorhandene Nummer **100** (gemessen über alle
Tabellen-Nummernspalten und alle „Befund <n>"-Nennungen), neu vergeben sind deshalb
**101, 102, 103 und 104**.

| Nr | Urteil | Fundstelle (nachprüfbar) | Feststellung am heutigen Stand |
|---|---|---|---|
| 43 | **unvollständig geschlossen** | (a) Bericht **§7.1 Z. 2195–2204**, dort **Z. 2197**: „`K3-Wiederherstellung` aus `KWRA-Monetarisierung.xlsx`, Blatt „Schadenskonten-System" Z28, wie in Kap. 1 („Konto-Einbettung") gebucht", und Antragspunkt 1 **Z. 2209–2211** („Baustein-Name des Schadenskontos nach Blatt „Schadenskonten-System""); Gegenzitat der Zelle C28 in Kap. 1 **Z. 120** („**K3 schließt aus** (Konten Z28): „Betriebsunterbrechung (→K5), Infrastruktur (→K4), Personen (→K1)"") · (b) Bericht **Kap. 8 Quelle 2, Z. 2345–2351**, Zellenliste **Z. 2346–2347**: „Risiken-Monetarisierung" (Z51, Z54–Z56, Z64, Z65, Z106), „Rechenregeln" (Z9, Z11, Z20) — gegen die heute tatsächlich zitierten Zellen **Rechenregeln Z7** (Z. 143, R5) und **Z19** (Z. 135, A4) sowie **Mon. Z17 und Z42** (beide Z. 120) und **Mon. Z57** (Z. 87, Z. 100) | Beide Teile des Befunds stehen unverändert im heutigen Text; der im Ledger Z. 1194 hinterlegte Prüfausdruck endet folgerichtig mit **Exit 0**. Die im Ledger festgehaltene Begründung des „bewusst offen" trägt **nur Teil (a)**: Die falsche Zellfundstelle in §7.1 ist tatsächlich ohne Wirkung auf Wert oder Konto — der Endpunkt `K3-Wiederherstellung` ist über die Netzwerkliste J61 und die Konto-Einbettung in Kap. 1 sachlich richtig gebucht, und Kap. 8 Quelle 2 nennt „Schadenskonten-System" Z26–Z30, sodass der Leser die K3-Zeilen findet. Eine als Modellgrenze sichtbare Kennzeichnung der Abweichung gibt es im Bericht nicht; deshalb kein „bestätigt geschlossen". **Rest:** Teil (b) ist von der Begründung überhaupt nicht gedeckt und betrifft nicht §7.1, sondern das Quellenkapitel: Die Zellenliste der Quelle 2 wirkt abschließend, lässt aber fünf im Bericht wörtlich zitierte Zellen aus (Rechenregeln Z7 und Z19, Mon. Z17, Z42 und Z57). Damit ist der §3.8-Nachweis „welche Zellen der Arbeitsmappe tragen diesen Bericht" unvollständig, und zwar an Stellen, die Partitionsregeln (R9-Abgrenzung zu #12 und #37) und die Preisstands-Anforderung A4 tragen. → **Befund 101** (Kategorie C). Der Status von Befund 43 selbst bleibt unberührt. |
| 44 | **unvollständig geschlossen** | Bericht **Kap. 6 „Modellgrenzen (dokumentiert)" Z. 1800–1832**, Punkt 2 **Z. 1805–1809** („**Bauform-Grenze der Abschätzung S094 (Vorgabe P2):**"), S092 in Kap. 6 nur als konstant gehaltene Größe **Z. 1785** · gegen **§5.1.2 Z. 1648–1649** („**Modellgrenzen der Abschätzung.** (1) Kommunenweiter Pauschalfaktor statt zellscharfer Wirkung (Bauform-Grenze)") und **§5.1.3 Z. 1698/1709** (Pauschalfaktor, Richtung der \(s_{\text{bem}}\)-Näherung) · P2-Zuordnung zu S094 außerdem in **Register 60-S094-01 Z. 188** und **§3.2 Z. 515** · gemessen: `Pauschal` in Kap. 6 weiterhin **0 Treffer** | Die im Ledger festgehaltene Begründung des „bewusst offen" ist am heutigen Text **belegt**: Die Modellgrenze von S092 steht sichtbar in §5.1.2 (Z. 1648–1649, „Kommunenweiter Pauschalfaktor statt zellscharfer Wirkung (Bauform-Grenze)") und §5.1.3 (Z. 1698 „kommunenweiter Pauschalfaktor", Z. 1709 „Modellgrenze des Pauschalfaktors"); insoweit fehlt nur die Wiederholung in Kap. 6, und der Prüfausdruck Z. 1195 endet erwartungsgemäß mit **Exit 0**. **Rest:** Der zweite Teil des Befunds — die **Falschzuordnung der Vorgabe P2** — ist von dieser Begründung nicht gedeckt und steht unverändert: Kap. 6 Punkt 2 überschreibt die Materialachse S094 mit „(Vorgabe P2)", obwohl P2 Maßnahmen ohne publizierte Effektgröße betrifft; S094 ist eine Vulnerabilitätsachse der Schadensfunktion, kein Maßnahmen-Hebel. Dieselbe Zuordnung trägt Register 60-S094-01 (Z. 188) und §3.2 (Z. 515), sodass die nutzernahe Modellgrenzen-Liste P2 einer Größe zuschreibt, für die sie nicht gilt, und der einzigen Größe, für die sie gilt (S092, Entscheidungslog Nr. 3), gar nicht. → **Befund 102** (Kategorie C). Der Status von Befund 44 selbst bleibt unberührt. |
| 45 | **unvollständig geschlossen** | Bericht **Kap. 9 Kriterienraster Z. 2454–2465**, Zeile „Aufwand" **Z. 2464** („**mittel** — vier Datenebenen, davon zwei neu anzulegen (HQ-Tiefen, GEBAEUDEWERT)") und Zeile „Datenverfügbarkeit" **Z. 2461** („**hoch** — alle vier Eingänge sind frei zugänglich und im Register belegt") · gegen **§3.2 Ebenentabelle Z. 557–564**: HQ_FLAECHE **Z. 561** „**neu anzulegen**", HQ_TIEFE **Z. 562** „**neu anzulegen**", GEBAEUDEWERT **Z. 563** „**neu anzulegen**", GEBAEUDEZUSTAND_BAUSTOFF **Z. 564** „**geparkt (Datenquelle fehlt)** — Beschaffungs-Watchlist" · und gegen die eigene Ergebniszeile des Berichts **Z. 34** („vier Datenebenen nach §3.1 (drei „neu anzulegen", eine „geparkt")") · gemessen: „geparkt" in Kap. 9 heute **1 Treffer**, aber in anderer Sache (**Z. 2462**, FS-Schutzsystem-Weiche) | Der Befund steht unverändert: Kap. 9 zählt weiter **zwei** neu anzulegende Ebenen statt drei und nennt alle vier Eingänge frei zugänglich, obwohl §3.2 eine Ebene mangels Datenquelle parkt und mit dem Neutralwert 1,00 fährt. Die im Ledger festgehaltene Begründung trägt nur die **Folgenlosigkeit für die Ansatzwahl** — (b) und (c) leiden an derselben Datenlücke stärker —, nicht die Richtigkeit der beiden Zellen; als Modellgrenze ist die Abweichung im Bericht nirgends sichtbar, deshalb kein „bestätigt geschlossen". **Rest, zusätzlich zum Ursprungsbefund:** Der Widerspruch besteht heute nicht mehr nur gegenüber §3.2, sondern gegenüber der **Ergebniszeile Z. 34** desselben Berichts, die drei/eine korrekt ausweist — ein Leser findet beide Zählungen im selben Dokument. Zugleich ist der im Ledger Z. 1196 hinterlegte Prüfausdruck **blind geworden**: Er fordert `'geparkt' not in k9`, und „geparkt" kommt in Kap. 9 seit der Revision vor — allerdings in **Z. 2462** über die inaktive R7-Weiche FS-Schutzsystem, nicht über die Datenebene. Der Ausdruck endet damit heute mit **Exit 1** und meldet eine Behebung, die nicht stattgefunden hat. → **Befund 103** (Kategorie C). Der Status von Befund 45 selbst bleibt unberührt. |
| 46 | **unvollständig geschlossen** | Bericht **Kap. 1 Knoten-Bilanz Z. 85 (S074) und Z. 86 (R17)**: beide heute „**Sensitivitätsband** (Kein-Doppelkanal §3.2; Register 60-S074-01/60-R17-01) — wirkt über FS-Hazard (Wassertiefe der Gefahrenkarte), keine eigene Formelstelle; früher: FS-Exposition …"; Satz zum Kommentar-Zustand ersetzt durch **Z. 67** („Kapitel 3 ist inzwischen ausgeschrieben (§3.1–§3.7)") · Register **60-S074-01 Z. 170** („geht deshalb nicht als eigener Faktor in FS-Exposition ein") und **60-R17-01 Z. 171** („liefert kein zweites Multiplikativglied") · gemessen: „FS-Exposition" im ganzen Bericht **4 Treffer** — Z. 70 (Namensliste der Formelstellen), Z. 85, Z. 86 (je als „früher:") und **Z. 264** · Reststelle: **Langbeleg B2 (Überschrift Z. 241), Z. 263–264**: „**Abgrenzung zur Knoten-Bilanz:** S074 bleibt der Formelstelle FS-Exposition zugeordnet, wirkt dort aber über die bereits topographiebasierte HWGK-Wassertiefe" | Der im Ledger als behoben geführte Kern ist belegt: Beide Bilanzzeilen führen S074 und R17 nicht mehr an einer eigenen Formelstelle, sondern als Sensitivitätsband über FS-Hazard, mit Verweis auf §3.2 und die beiden Registerzeilen; der Satz zum Kommentar-Zustand von Kapitel 3 ist durch den Ist-Stand ersetzt; ab Kapitel 3 kommt „FS-Exposition" nicht mehr vor. Der Prüfausdruck Z. 1264 endet folgerichtig mit **Exit 1**. **Rest:** Im Langbeleg **B2** steht die alte Zuordnung wörtlich weiter — „S074 bleibt der Formelstelle FS-Exposition zugeordnet" (Z. 263–264). Der Nachsatz („wirkt dort aber über die bereits topographiebasierte HWGK-Wassertiefe; ein zweiter Topographie-Faktor wäre ein Doppelkanal") stimmt in der Sache mit der Korrektur überein, die Zuordnungsaussage selbst widerspricht ihr: Kap. 1 Z. 85 sagt „keine eigene Formelstelle", Register Z. 170 sagt „geht … nicht als eigener Faktor in FS-Exposition ein". Der Abschnitt heißt ausdrücklich „Abgrenzung zur Knoten-Bilanz" und ist damit genau die Stelle, an der ein Leser den Abgleich sucht. → **Befund 104** (Kategorie C). Der Status von Befund 46 selbst bleibt unberührt. |

#### Neue Befunde dieses Pakets (101, 102, 103 und 104)

| Nr | Kat. | Befund |
|---|---|---|
| 101 | **C** | **Stelle:** Bericht Kap. 8, Quelle 2 **Z. 2345–2351**, Zellenliste **Z. 2346–2347** („Risiken-Monetarisierung“ (Z51, Z54–Z56, Z64, Z65, Z106), „Rechenregeln“ (Z9, Z11, Z20)), gegen die im Bericht wörtlich zitierten Zellen **Rechenregeln Z7** (Z. 143), **Rechenregeln Z19** (Z. 135), **Mon. Z17** und **Mon. Z42** (beide Z. 120) sowie **Mon. Z57** (Z. 87 und Z. 100). · **Art: Lücke (§3.8 „exakte Fundstelle je zitierter Zelle“; §5 LF 10)** — Rest des mit Befund 43 verbundenen Mangels, Teil (b). · **Begründung:** Quelle 2 zählt die herangezogenen Zellen je Blatt abschließend auf, ohne Zusatz „u. a.“. Fünf Zellen, aus denen der Bericht wörtlich zitiert, fehlen in dieser Aufzählung, und es sind keine Nebenstellen: Rechenregeln Z7 trägt R5 (Versicherungsleistungen/Preisänderungen), Z19 die Annahme A4 zum Preisstand, Mon. Z17 und Z42 die Partitionszitate gegenüber #12 (Rutschungen) und #37 (Aquakulturen) in der Knoten-Bilanz, Mon. Z57 die Abgrenzung des Kanalnetzes (#52, K4). Wer die Mappenbindung des Berichts über Kap. 8 nachprüft, findet die tragenden Abgrenzungszitate dort nicht wieder; §3.8 verlangt die exakte Fundstelle gerade dafür. Kategorie **C** wie der Ursprungsbefund: Wert, Konto und Kernformel sind nicht betroffen, nur die Nachprüfbarkeit der Zitatkette. · **Vorschlag:** Die Zellenliste der Quelle 2 um Rechenregeln Z7 und Z19 sowie Risiken-Monetarisierung Z17, Z42 und Z57 ergänzen — oder die Aufzählung ausdrücklich als „u. a. (vollständige Einzelnachweise bei den Zitaten in Kap. 1/2)“ kennzeichnen, damit sie nicht abschließend wirkt. Nicht in diesem Paket umgesetzt (Dateirahmen), hier nur verbucht. |
| 102 | **C** | **Stelle:** Bericht Kap. 6, Modellgrenze 2 **Z. 1805–1809** („**Bauform-Grenze der Abschätzung S094 (Vorgabe P2):**“), dieselbe Zuordnung in Register **60-S094-01 Z. 188** („**Modellgrenzen — Bauform-Grenze der Abschätzung (Vorgabe P2)**“) und **§3.2 Z. 515** („**Bauform-Grenze als Modellgrenze der Abschätzung (Vorgabe P2):**“), gegen §5.1.2 **Z. 1648–1649** und §5.1.3 **Z. 1698/1709** (Modellgrenzen der Abschätzung S092) sowie Kap. 6 **Z. 1785** (S092 dort nur als konstant gehaltene Größe). · **Art: Fehler/Lücke (Vorgabe P2 „für Maßnahmen ohne publizierte Effektgröße“; §3.5; §5 LF 12)** — Rest des mit Befund 44 als bewusst offen geführten Mangels. · **Begründung:** P2 gilt Maßnahmen ohne publizierte Effektgröße. Die einzige solche Größe in #60 ist der Maßnahmen-Hebel S092 (Register 60-S092-01 Z. 186, „Abschätzung von KAP3“, Entscheidungslog Nr. 3). S094 ist dagegen die Materialachse der Schadensfunktion, also eine Vulnerabilitätsgröße; ihre Bauform-Grenze ist eine Modellgrenze der Abschätzung nach §3.9, aber kein P2-Fall. An drei Stellen trägt heute S094 das P2-Etikett, während S092 in der nutzernahen Modellgrenzen-Liste von Kap. 6 überhaupt keine Modellgrenze hat (`Pauschal` kommt dort 0-mal vor). Für einen Leser, der Kap. 6 als Zusammenstellung der Modellgrenzen liest — die Rolle, die das Kapitel im Produkt hat —, steht P2 damit an der falschen Größe und fehlt an der richtigen. Kategorie **C** wie der Ursprungsbefund: Wert und Band von S092 sind in §5.1.2/§5.1.3 vollständig und richtig ausgewiesen, betroffen sind Etikett und Auffindbarkeit. · **Vorschlag:** In Kap. 6 eine eigene Modellgrenze für S092 aufnehmen (kommunenweiter Pauschalfaktor statt zellscharfer Wirkung, Richtung der \(s_{\text{bem}}\)-Näherung „überschätzt den Hebel“, Band nach Register 60-S092-01) und Punkt 2 in „Bauform-Grenze der Materialabschätzung S094 (§3.9)“ umbenennen; die P2-Nennung in Register 60-S094-01 und §3.2 im selben Zug auf §3.9 umstellen. Nicht in diesem Paket umgesetzt (Dateirahmen), hier nur verbucht. |
| 103 | **C** | **Stelle:** Bericht Kap. 9 Kriterienraster, Zeile „Datenverfügbarkeit“ **Z. 2461** („alle vier Eingänge sind frei zugänglich“) und Zeile „Aufwand“ **Z. 2464** („vier Datenebenen, davon zwei neu anzulegen (HQ-Tiefen, GEBAEUDEWERT)“), gegen §3.2 Ebenentabelle **Z. 561–564** (drei „neu anzulegen“, eine „geparkt (Datenquelle fehlt)“) **und gegen die Ergebniszeile des Berichts Z. 34** („vier Datenebenen nach §3.1 (drei „neu anzulegen“, eine „geparkt“)“); dazu der Ledger-Prüfausdruck zu Befund 45 (Z. 1196), dessen Bedingung `'geparkt' not in k9` seit **Z. 2462** (FS-Schutzsystem-Weiche, anderer Sachverhalt) nicht mehr greift. · **Art: Widerspruch (§3.7 Kriterienraster; §5 LF 12) und untauglich gewordener Prüfausdruck.** · **Begründung:** Zwei Dinge, die zusammengehören. (1) Der Zählfehler aus Befund 45 steht unverändert, widerspricht heute aber nicht nur dem Modellkapitel §3.2, sondern der eigenen Ergebniszeile Z. 34 des Berichts; ein Leser findet zwei Zählungen desselben Sachverhalts im selben Dokument, und das Raster, das die Ansatzwahl trägt (Entscheidungslog Nr. 5), führt die günstigere. Die Zelle „Datenverfügbarkeit: hoch — alle vier Eingänge sind frei zugänglich“ ist dabei für die geparkte Ebene GEBAEUDEZUSTAND_BAUSTOFF sachlich falsch: Für sie gibt es nach §3.2 Z. 564 „keine bundesweite offene Erhebung“, sie fährt mit dem Neutralwert 1,00 und steht auf der Beschaffungs-Watchlist. (2) Der hinterlegte Prüfausdruck meldet dennoch Behebung (Exit 1), weil „geparkt“ inzwischen in Kap. 9 vorkommt — in Z. 2462 über die inaktive R7-Weiche, nicht über eine Datenebene. Ein Regressionsprüfer, der sich auf den Ausdruck statt auf den Text verlässt, würde Befund 45 fälschlich schließen. Kategorie **C** wie der Ursprungsbefund: Die Ansatzwahl kippt nicht, weil (b) und (c) dieselbe Datenlücke tragen; betroffen sind die Richtigkeit zweier Rasterzellen und die Tauglichkeit des Prüfausdrucks. · **Vorschlag:** Die Zellen „Aufwand“ und „Datenverfügbarkeit“ für (a) auf den Stand von §3.2/Z. 34 ziehen (drei neu anzulegende Ebenen, eine geparkt mit Neutralwert 1,00) und prüfen, ob „hoch“ bei der Datenverfügbarkeit so bestehen bleibt; den Prüfausdruck zu Befund 45 zugleich auf eine eindeutige Bedingung umstellen (z. B. auf „davon drei neu anzulegen“ und auf das Vorkommen von „GEBAEUDEZUSTAND_BAUSTOFF“ bzw. „geparkt (Datenquelle fehlt)“ in Kap. 9), damit er den Sachverhalt und nicht ein gleichlautendes Wort misst. Nicht in diesem Paket umgesetzt (Dateirahmen), hier nur verbucht. |
| 104 | **C** | **Stelle:** Bericht Kap. 2, Langbeleg **B2 — 60-S074-01** (Überschrift **Z. 241**), Abschnitt „Abgrenzung zur Knoten-Bilanz“ **Z. 263–264**: „S074 bleibt der Formelstelle FS-Exposition zugeordnet, wirkt dort aber über die bereits topographiebasierte HWGK-Wassertiefe“ — gegen Kap. 1 Knoten-Bilanz **Z. 85** („keine eigene Formelstelle“) und Register **60-S074-01 Z. 170** („geht deshalb nicht als eigener Faktor in FS-Exposition ein“). · **Art: Widerspruch im Bericht (§2.1 „verarbeitet oder begründet inaktiv“; §3.2 Kein-Doppelkanal; §5 LF 10)** — Rest des mit Befund 46 als behoben geführten Mangels. · **Begründung:** Die Korrektur zu Befund 46 ist in der Knoten-Bilanz und im Register vollzogen, im Langbeleg B2 aber nicht nachgezogen. B2 sagt weiterhin, S074 „bleibt der Formelstelle FS-Exposition zugeordnet“; Kap. 1 und das Register sagen das Gegenteil. Inhaltlich stimmen beide Stellen überein — die Geländehöhe wirkt über die HWGK-Wassertiefe, ein zweiter Topographie-Faktor wäre ein Doppelkanal —, sodass kein Wert und keine Formel betroffen ist; die Zuordnungsaussage selbst ist aber unvereinbar, und sie steht ausgerechnet in dem Absatz, der „Abgrenzung zur Knoten-Bilanz“ überschrieben ist und an dem ein Leser den Abgleich vornimmt. Für R17 gibt es keine entsprechende Reststelle: „FS-Exposition“ kommt im Bericht heute nur noch in Z. 70 (Namensliste), Z. 85/86 (jeweils als historischer Hinweis „früher: …“) und in Z. 264 vor. Kategorie **C** statt B wie beim Ursprungsbefund: Es ist eine einzelne Formulierung ohne Wirkung auf Wert, Konto oder Formelstand. · **Vorschlag:** In B2 Z. 263–264 die Zuordnungsaussage auf den Stand von Kap. 1/Register ziehen, z. B. „S074 ist **keiner eigenen Formelstelle** zugeordnet, sondern wirkt als Sensitivitätsband über FS-Hazard (HWGK-Wassertiefe, 60-W085-01); ein zweiter Topographie-Faktor wäre ein Doppelkanal (§3.2)“. Nicht in diesem Paket umgesetzt (Dateirahmen), hier nur verbucht. |
...
- **Geändert wurde ausschließlich `reviews/BEFUNDE_60.md`** (angehängt).
  ...
  mittelbar über die im Ledger zitierten Zellbezüge herangezogen (eiserne Regel 2). Der Bericht
  wurde ausschließlich an den in der Tabelle ausgewiesenen Stellen gelesen und nachgeprüft.
- **Kein Befund behoben, keiner umnummeriert.** Höchste vorhandene Nummer zu Laufbeginn: **100**;
  neu vergeben sind **101, 102, 103 und 104**. Die Status der Befunde 43 bis 46 selbst bleiben
  unberührt, ebenso die Statuszeilen zu 43–46 in der Übersichtstabelle (Z. 68–71).
- **Keine Leitfrage aus §5 beantwortet.** Dieses Paket führt allein die Regression der Nummern
  **43, 44, 45 und 46**; die Nummern 39 bis 42 hat das Schwesterpaket T-0390 geführt. Zusammen
  decken beide die acht Nummern des ersetzten T-0369 genau einmal ab; über die acht
  Regressionspakete der Runde 3 sind damit die 32 Nummern 6, 11, 12, 13, 17 und 20 bis 46
  vollständig und jede genau einmal abgedeckt.
- **Vorgaben P1/P2 angelegt (44):** geprüft ist, an welcher Größe die Vorgabe P2 im Bericht hängt
  (S094 statt S092) und ob die Modellgrenze der einzigen P2-Größe im sichtbaren Berichtstext steht
  (§5.1.2 Z. 1648–1649, §5.1.3 Z. 1698/1709 — ja, aber nicht in Kap. 6). Kein Code-Kommentar
  herangezogen.
- **Ressourcen-Regel §3.4 eingehalten:** kein nationaler 100-m-Vollraster-Lauf; geprüft wurde
  ausschließlich am gedruckten Text, die Stichproben-Dateien `docs/evidenz/60_stichprobe/*.csv`
...
| 17 | C | Code, aber Prüfskript statt Produktionspfad: Dateien unter `backend/` — hier `backend/scripts/lint_methodik.py`, kein rechnender Code unter `backend/app/` | Pflichtkapitel-Check Z. 258–292 dieses Skripts (Regression Teil 2, Z. 3286) |
...
| 71 | C | Code — Dateien unter `backend/`, hier das Prüfskript `backend/scripts/lint_methodik.py`, stumm übersprungene Prüfung | Ausgabeblock Z. 952–959 und `registry_abgleich()` Z. 296–301 (Z. 3295) |
...
| 87 | B | Produktionscode — Dateien unter `backend/`: die Kalibrierung von #60 existiert unter `backend/scripts/kalibrierung/` nicht | Bericht §4.8 Z. 1461–1475 gegen den grep jener Sitzung (Z. 3948) |
| 88 | B | Modellzahl und Code — elf ergebnistragende Größen nur im Testblock/Code-Kommentar, nicht in Dateien unter `backend/` als Parameter geführt | Bericht §4.8, Testblock Z. 1485–1487 (Z. 3949) |
...
**Nachtrag zum Umfang (T-0620, 23.09.2026).** Mitgezählt sind außerdem die beiden Prüfausdrücke der Leitfrage 11 der Runde 1 (Z. 257–262 und Z. 263 → Befunde 8 und 9) und Block (g) „Nachrechnung von \(U\) und \(O\)" der Autor-Revision nach Runde 2 zu Befund 35 (Z. 2108–2127; Z. 2108 ist die Zaunzeile mit der Kennung `python test: befund_35_u_o`, der Befehl steht in Z. 2109–2127). Beide Leitfragen-Ausdrücke stehen in beiden Zeilen und sind je Befund getrennt beurteilt. Block (g) zählt wie Ausdruck (f) zu Befund 36: ein ausführbarer Befehl der Autor-Revision, als Test gekennzeichnet und damit als Beleg lesbar, auch wenn er nicht „Prüfausdruck" heißt. Die Läufe dieser fünf Einträge liefen am Bericht mit SHA-256 `b91e8bc32e86…` (letzter Commit des Berichts `f834d53a`); am Berichtsstand `88d27a04` der übrigen Läufe enden alle zehn Befehle der fünf Blöcke (alt und neu) mit demselben Exit-Code und derselben Ausgabe der Zählung (Kontrolllauf, hier nicht abgedruckt). Ihre Proben am Vergabestand `357980fc` nehmen `backend/` aus demselben Commit (`git archive`), weil der Ausdruck aus Z. 263 und der Ersatz zu Befund 9 `backend/` lesen. Für Befund 35 ist `357980fc` nicht der Vergabestand (vergeben in Runde 2, T-0273); dort führt der Bericht noch kein Sanity-Band mit \(U\) und \(O\), der Befund ist an diesem Stand also nicht geschlossen. Kein Urteil aus T-0540/T-0599 ist geändert: In den Zeilen 8, 9 und 35 sind nur Einträge angehängt (die bisherigen Einträge der Zeilen 8 und 9 tragen dafür jetzt die Marke (a)), dazu der Zählsatz und dieser Absatz.
...
| 8 | (a) `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('### 3.5 ')[1].split(chr(10)+'### ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];ok=all(len(c)==4 and (any(a in c[3] for a in ('register:','herleitung:')) or (c[3]=='Notation' and c[2]=='—')) for c in r);ead=[c for c in r if 'EAD' in c[0]];raise SystemExit(0 if ok and len(r)>=20 and any('2026' in c[1] and 'Kommune' in c[1] for c in ead) and any('mit' in c[0] for c in ead) else 1)"` (Z. 43)<br>(b) <code>python3 -c "<br>dq,s,e=0.10,0.50,0.70<br>assert abs(dq*s*e-0.035)&lt;1e-12<br>assert abs(0.05*0.30*0.50-0.0075)&lt;1e-12 and abs(0.20*0.70*0.80-0.112)&lt;1e-12<br>print('Beispielblock rechnet auf')<br>"</code> (Z. 257–262)<br>(c) <code>grep -rn "beispiel_60" --include=*.py backend &#124; wc -l</code> (Z. 263) | (a) Bericht<br>(b) keine (reine Rechnung)<br>(c) alle `*.py` unter `backend/` | (a) tauglich<br>(b) untauglich: anderer Grund (benannt): liest keine Datei und misst einen anderen Sachverhalt — die Arithmetik des Beispielblocks, nicht die Zeichentabelle<br>(c) untauglich: anderer Grund (benannt): misst einen anderen Sachverhalt — Fundstellen von „beispiel_60" im Code, nicht die Zeichentabelle des Berichts |
| 9 | (a) `python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();b=re.findall('python test: ([a-z0-9_]+)'+chr(10)+'(.*?)'+chr(10)+chr(96)*3,s,re.S);[exec(compile(c,n,'exec'),{}) for n,c in b];raise SystemExit(0 if b and all('assert' in c for n,c in b) and any(n=='beispiel_60_kernformel' for n,c in b) else 1)"` (Z. 44)<br>(b) <code>python3 -c "<br>dq,s,e=0.10,0.50,0.70<br>assert abs(dq*s*e-0.035)&lt;1e-12<br>assert abs(0.05*0.30*0.50-0.0075)&lt;1e-12 and abs(0.20*0.70*0.80-0.112)&lt;1e-12<br>print('Beispielblock rechnet auf')<br>"</code> (Z. 257–262)<br>(c) <code>grep -rn "beispiel_60" --include=*.py backend &#124; wc -l</code> (Z. 263) | (a) Bericht<br>(b) keine (reine Rechnung)<br>(c) alle `*.py` unter `backend/` | (a) untauglich: liest nur eine von mehreren betroffenen Dateien<br>(b) untauglich: anderer Grund (benannt): liest keine Datei — rechnet nur die Zahlen des Beispielblocks nach<br>(c) untauglich: anderer Grund (benannt): das Suchwort „beispiel_60" trifft eine fremde Fundstelle (Docstring in `backend/scripts/kalibrierung/stichprobe60_kernformel.py` Z. 26) |
...
| 35 | (a) `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 4 ')[1].split(chr(10)+'## 5 ')[0];raise SystemExit(0 if ('mittleren Betroffenheit von 1/100 Jahren' in k and 'Hochrechnung \\\\(u\\\\) entfällt hier bewusst' in k and 6.311/1200>0.25*0.01) else 1)"` (Z. 1000)<br>(b) `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.6 ')[1].split(chr(10)+'### 4.7 ')[0];raise SystemExit(0 if all(x in k for x in ('0,0103','6,29','Amtlichkeitsgebot','1,132')) else 1)"` (Z. 2155)<br>(c) `python3 backend/scripts/lint_methodik.py 60`<br>(d) <code>python3 -c "<br>E_nom = 8.0<br>faktor_2026 = 1.02 ** 13<br>E_min_2026 = E_nom * faktor_2026<br>w = (1/3) * (1/3)<br>f_fluss = 0.90<br>T = 100<br>U = E_min_2026 * w * f_fluss / T<br><br>n_gk34 = 339000 * 0.1<br>n_gk2 = 1380000 * 0.01<br>wert_geb = 527280.0<br>q_deckel = 0.250<br>O = (n_gk34 + n_gk2) * wert_geb * q_deckel / 1e9<br><br>assert abs(U - 0.0103) &lt; 2e-3, U<br>assert abs(O - 6.288) &lt; 2e-2, O<br>print('U =', round(U, 3), 'Mrd. EUR2026/a; O =', round(O, 2), 'Mrd. EUR2026/a')<br>"</code> (Z. 2108–2127) | (a) Bericht<br>(b) Bericht<br>(c) Bericht (über `backend/scripts/lint_methodik.py`)<br>(d) keine (reine Rechnung) | (a) tauglich<br>(b) tauglich<br>(c) tauglich<br>(d) untauglich: anderer Grund (benannt): liest keine Datei — rechnet nur fest eingetragene Zahlen nach |
...
Geprüft wurden **71 Prüfausdrücke** (Tabelleneinträge) zu 41 Befunden; davon sind **34 untauglich** und 37 tauglich.

Nach Fehlertyp: 1 „matcht den eigenen Beleg", 5 „liest nur eine von mehreren betroffenen Dateien", 28 „anderer Grund" (davon 7 feste Zeilennummern). Der Fehlertyp des Hauses (Selbstbeleg und halbe Dateimenge) erklärt damit 6 der 34; die größte Gruppe sind Ausdrücke, die an Zeilennummern oder an einem überholten Zwischenstand hängen und deshalb nach jeder Revision kippen. Die fünf Einträge aus T-0620 kommen alle als „anderer Grund" hinzu: drei lesen keine Datei (8 (b), 9 (b), 35 (d)), einer misst einen anderen Sachverhalt (8 (c)), einer trifft eine fremde Fundstelle (9 (c)).
...
**Befund 8 (b) (Z. 257–262)** — untauglich: anderer Grund (benannt): liest keine Datei und misst einen anderen Sachverhalt — die Arithmetik des Beispielblocks, nicht die Zeichentabelle. Leitfrage 11 verweist auf die Befunde 8 und 9; der Ausdruck rechnet nur die Zahlen des Blocks `beispiel_60_s092_abschaetzung` nach und druckt am Stand der Vergabe wie heute „Beispielblock rechnet auf". Ob EAD und EAD_mit in einer Zeichentabelle stehen, kommt darin nicht vor. Ersatz ist der Schließungsausdruck der Übersicht (Z. 43), hier als tauglich beurteilt; am Stand der Vergabe endet er mit Exit 1, weil es §3.5 dort noch nicht gibt (IndexError). Soll: Stand der Vergabe Exit 1 (besteht), heute Exit 0 (bestätigt geschlossen, Regression Runde 2, Z. 1254).

Ersatz:

```bash
python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('### 3.5 ')[1].split(chr(10)+'### ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];ok=all(len(c)==4 and (any(a in c[3] for a in ('register:','herleitung:')) or (c[3]=='Notation' and c[2]=='—')) for c in r);ead=[c for c in r if 'EAD' in c[0]];raise SystemExit(0 if ok and len(r)>=20 and any('2026' in c[1] and 'Kommune' in c[1] for c in ead) and any('mit' in c[0] for c in ead) else 1)"
```
...
print('Beispielblock rechnet auf')
"; echo "Exit $?"
Beispielblock rechnet auf
Exit 0
$ python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('### 3.5 ')[1].split(chr(10)+'### ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];ok=all(len(c)==4 and (any(a in c[3] for a in ('register:','herleitung:')) or (c[3]=='Notation' and c[2]=='—')) for c in r);ead=[c for c in r if 'EAD' in c[0]];raise SystemExit(0 if ok and len(r)>=20 and any('2026' in c[1] and 'Kommune' in c[1] for c in ead) and any('mit' in c[0] for c in ead) else 1)"; echo "Exit $?"
Exit 0
```

Probe — Berichtsstand der Vergabe (T-0232, Review-Runde 1, `357980fc`), an dem der Befund bestand; `backend/` aus demselben Commit:

```
$ T=$(mktemp -d) && mkdir -p $T/docs/methodik && git archive 357980fc backend | tar -x -C $T && ln -s $PWD/docs/evidenz $T/docs/evidenz && ln -s $PWD/docs/Schadensbaum $T/docs/Schadensbaum && git show 357980fc:docs/methodik/60_gebaeudeschaeden_flusshochwasser.md > $T/docs/methodik/60_gebaeudeschaeden_flusshochwasser.md && cd $T
$ python3 -c "
dq,s,e=0.10,0.50,0.70
assert abs(dq*s*e-0.035)<1e-12
assert abs(0.05*0.30*0.50-0.0075)<1e-12 and abs(0.20*0.70*0.80-0.112)<1e-12
...
**Befund 8 (c) (Z. 263)** — untauglich: anderer Grund (benannt): misst einen anderen Sachverhalt — Fundstellen von „beispiel_60" im Code, nicht die Zeichentabelle des Berichts. Der Ausdruck liest nur die `*.py`-Dateien unter `backend/`. Seine Ausgabe wechselt zwar von 0 (Vergabe) auf 1 (heute), aber nur wegen eines Docstrings in `backend/scripts/kalibrierung/stichprobe60_kernformel.py` Z. 26 (seit T-0305, Commit `e3b88d8c`); mit der Zeichentabelle hat das nichts zu tun, das richtige Ergebnis kommt zufällig zustande. Ersatz wie (b). Soll: Stand der Vergabe Exit 1 (besteht), heute Exit 0 (bestätigt geschlossen, Regression Runde 2, Z. 1254).
...
```
$ grep -rn "beispiel_60" --include=*.py backend | wc -l; echo "Exit $?"
1
Exit 0
$ python3 -c "import re;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split('### 3.5 ')[1].split(chr(10)+'### ')[0];r=[[c.strip() for c in z.strip().strip(chr(124)).split(chr(124))] for z in t.split(chr(10)) if z.strip().startswith(chr(124))][2:];ok=all(len(c)==4 and (any(a in c[3] for a in ('register:','herleitung:')) or (c[3]=='Notation' and c[2]=='—')) for c in r);ead=[c for c in r if 'EAD' in c[0]];raise SystemExit(0 if ok and len(r)>=20 and any('2026' in c[1] and 'Kommune' in c[1] for c in ead) and any('mit' in c[0] for c in ead) else 1)"; echo "Exit $?"
Exit 0
...
**Befund 9 (b) (Z. 257–262)** — untauglich: anderer Grund (benannt): liest keine Datei — rechnet nur die Zahlen des Beispielblocks nach. Befund 9 steht zwischen dem Beispielblock im Bericht und `backend/`; der Ausdruck liest keins von beiden und druckt am Stand der Vergabe wie heute „Beispielblock rechnet auf". Er kann weder das Bestehen noch das Schließen des Befunds zeigen. Ersatz ist der Ersatz zu Befund 9 (Z. 44) weiter oben, der den Bericht und `backend/tests/` liest. Soll: heute Exit 1 (nicht geschlossen — die Regression Runde 2, Z. 1255, beurteilt die Fundstelle `backend/` als nicht erfüllt), am Stand der Vergabe Exit 1.
...
**Befund 9 (c) (Z. 263)** — untauglich: anderer Grund (benannt): das Suchwort „beispiel_60" trifft eine fremde Fundstelle (Docstring in `backend/scripts/kalibrierung/stichprobe60_kernformel.py` Z. 26). Am Stand der Vergabe zählt der Ausdruck richtig 0 Treffer. Heute zählt er 1; der einzige Treffer ist der Satz „Block beispiel_60_kernformel_zelle im Bericht ist die Referenz" im Kopf eines Kalibrierskripts (T-0305, Commit `e3b88d8c`), kein Golden-Test. Wer die 1 als „hinterlegt" liest, hält Befund 9 für geschlossen, obwohl die Regression Runde 2 (Z. 1255) die Fundstelle `backend/` als nicht erfüllt beurteilt und `backend/tests/` bis heute keinen solchen Test enthält. Ersatz wie (b). Soll: heute Exit 1 (nicht geschlossen), am Stand der Vergabe Exit 1.
...
**Befund 35 (d) (Z. 2108–2127)** — untauglich: anderer Grund (benannt): liest keine Datei — rechnet nur fest eingetragene Zahlen nach. Die Zaunzeile weist den Block als `python test: befund_35_u_o` aus; wörtlich ist er ein Shell-Befehl (`python3 -c "…"`) und läuft wie alle Ausdrücke dieses Abschnitts in der Shell. Er rechnet \(U\) und \(O\) aus eingetragenen Zahlen nach und endet an jedem Berichtsstand mit Exit 0, auch an `357980fc`, wo der Bericht noch kein Sanity-Band mit \(U\) und \(O\) führt. Heute stimmt Exit 0 nur zufällig: Die Teilpunkte (a)–(c) sind belegt (Regression Runde 3 Teil 6, Z. 4103), der Rest steht unter Befund 96 und gehört nicht zur Frage dieses Ausdrucks. Die nachgerechnete Untergrenze 0,0103 ist nicht mehr die des Berichts (T-0574: 0,189). Der Ersatz bindet deshalb nur die klassengerechte Schranke 6,29, heute die Modellschranke. Er rechnet sie nach und verlangt, dass §4.6 sie führt, zusammen mit der Fondsherleitung (AufbhG), dem Klassenbezug, der Ausnahme vom Amtlichkeitsgebot und dem Ist-Wert 1,132. Soll: heute Exit 0 (geschlossen), an `357980fc` Exit 1.

Ersatz:

```bash
python3 -c "O=(339000*0.1+1380000*0.01)*527280.0*0.250/1e9;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.6 ')[1].split(chr(10)+'### 4.7 ')[0];raise SystemExit(0 if (abs(O-6.288)<2e-2 and ('%.2f' % O).replace('.',',') in k and all(x in k for x in ('Fondsvolum','AufbhG','klassengerecht','Amtlichkeitsgebot','1,132'))) else 1)"
```
...
print('U =', round(U, 3), 'Mrd. EUR2026/a; O =', round(O, 2), 'Mrd. EUR2026/a')
"; echo "Exit $?"
U = 0.01 Mrd. EUR2026/a; O = 6.29 Mrd. EUR2026/a
Exit 0
$ python3 -c "O=(339000*0.1+1380000*0.01)*527280.0*0.250/1e9;s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'### 4.6 ')[1].split(chr(10)+'### 4.7 ')[0];raise SystemExit(0 if (abs(O-6.288)<2e-2 and ('%.2f' % O).replace('.',',') in k and all(x in k for x in ('Fondsvolum','AufbhG','klassengerecht','Amtlichkeitsgebot','1,132'))) else 1)"; echo "Exit $?"
Exit 0
```

Probe — Berichtsstand `357980fc` (T-0232, Review-Runde 1; Befund 35 ist erst in Runde 2 vergeben, an diesem Stand führt der Bericht weder \(U\) noch \(O\)); `backend/` aus demselben Commit:
...
| 25 | 99 (Kopftabelle) | M | docs/methodik/60_gebaeudeschaeden_flusshochwasser.md | docs/methodik/60_gebaeudeschaeden_flusshochwasser.md, docs/evidenz/register.md, reviews/BEFUNDE_60.md | tauglich |
| 54 | 128 (Kopftabelle) | M | docs/methodik/60_gebaeudeschaeden_flusshochwasser.md | docs/methodik/60_gebaeudeschaeden_flusshochwasser.md, docs/evidenz/register.md, reviews/BEFUNDE_60.md | tauglich |
| 55 | 129 (Kopftabelle) | M | docs/methodik/60_gebaeudeschaeden_flusshochwasser.md, docs/evidenz/register.md | docs/methodik/60_gebaeudeschaeden_flusshochwasser.md, docs/evidenz/register.md, reviews/BEFUNDE_60.md | tauglich |
...
**T-0568 (Befunde 25, 54, 55, 56, 75, 95).** Die drei T-0568-Commits (`9af956e0`, `8dec2ff2`, `d64231f1`) berühren laut `git show --stat` neben dem Bericht auch `docs/evidenz/register.md` und `reviews/BEFUNDE_60.md`. Kontrolle statt Unterstellung: `git diff 3001e90a d64231f1 -- docs/evidenz/register.md` ändert ausschließlich die beiden Registerzeilen `60-S093-01` und `60-S094-01` (Nacharbeit Runde 1 zu Befund 55, Ergänzung „neutral gesetztes Glied"); für die übrigen fünf Befunde (25, 54, 56, 75, 95) trägt `register.md` keinen Sachverhalt, den ihr jeweiliger Ausdruck prüfen müsste. `reviews/BEFUNDE_60.md` trägt bei allen sechs Befunden nur die Ledger-Buchung (Statuszeilen und der Abschnitt „Autor-Revision T-0568", dessen Tabelle die Prüfausdrücke nicht wiederholt, sondern „wortgleich in der Kopftabelle" vermerkt) — kein zusätzlicher, vom jeweiligen Ausdruck zu prüfender Sachverhalt. Alle sechs Ausdrücke wurden verbatim ausgeführt, wörtlich wie in der Kopftabelle (Z. 99, 128, 129, 130, 149, 169).

Befund 25: Der Ausdruck liest §3.5 des Berichts und prüft, ob dort eine Zeile \(q_0\) mit „geparkt" in der Herkunftsspalte und eine Zeile mit `tau_` im Zeichen stehen und Kapitel 5 keine der alten Bezeichnungen `t_1`/`t_2`/`t_3` mehr führt. Der Fehlertyp „liest nur eine von mehreren betroffenen Dateien" trifft nicht zu (siehe Absatz oben: `register.md` trägt hier keinen zu prüfenden Sachverhalt). Lauf am heutigen Stand: Exit 0 (geschlossen). Probe am Vergabestand `3001e90a` (Elterncommit des ersten T-0568-Commits, über `git show 3001e90a:docs/methodik/60_gebaeudeschaeden_flusshochwasser.md`, kein Checkout): Exit 1 (Befund bestand).

Befund 54: Der Ausdruck liest §3.5 und prüft, ob dort eine Zeile mit „AWM" im Zeichen und der Herkunft `fortschreibung-neuwert-k3` sowie eine Gattungszeile \(w\) mit „Gattungszeichen" und „Kommune" stehen. Der Fehlertyp „liest nur eine von mehreren betroffenen Dateien" trifft nicht zu (siehe Absatz oben). Lauf am heutigen Stand: Exit 0 (geschlossen). Probe am Vergabestand `3001e90a`: Exit 1 (Befund bestand).

Befund 55: Der Ausdruck liest §3.5 und die Präambel Kapitel 2 des Berichts **und** `docs/evidenz/register.md` (Spiegelzeilen `60-S09…`) und prüft dieselbe Formulierung „neutral gesetztes Glied" an allen vier Stellen sowie das Fehlen von „kein eigenes Multiplikativglied" in Bericht und Spiegel — er deckt damit den einzigen inhaltlichen `register.md`-Sachverhalt der T-0568-Commits selbst ab; der Fehlertyp trifft nicht zu. Lauf am heutigen Stand: Exit 0 (geschlossen). Probe am Vergabestand `3001e90a` (Bericht und Register über `git show 3001e90a:…`, kein Checkout): Exit 1 (Befund bestand).

Befund 56: Der Ausdruck liest §3.5, zerlegt die 31 Zeichentabellenzeilen in ein Sortierschlüssel-Tupel und prüft, ob die Liste bereits sortiert ist und der Einleitungsabsatz „alphabetisch" nennt. Der Fehlertyp „liest nur eine von mehreren betroffenen Dateien" trifft nicht zu (siehe Absatz oben). Lauf am heutigen Stand: Exit 0 (geschlossen). Probe am Vergabestand `3001e90a`: Exit 1 (Befund bestand).
...
Flächenausweis, Betrachtungsebene der EAD-Formel und Kennzeichnung des Wertsatzes GEBAEUDEWERT.
Geändert wurden `docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` und dieser Ledger.

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 24 | C | §3.1, Aufzählungspunkt „Physischer Teil-Ausweis": \(\text{EAD}_z = \bar A_z \cdot w_z\) auf der Zelle, \(\text{EAD}_k = \sum_{z \in k} \bar A_z \cdot w_z\) auf der Kommune mit Verweis auf §3.6; §3.5, \(\bar A\)-Zeile, ergänzt um dieselbe Unterscheidung. Der Status „bewusst offen" ist aufgehoben, weil die Indizierung jetzt im Text steht; der Prüfausdruck der Runde 2 (Abschn. 1.2, Gegenbeispiel > 5 % Abweichung) endet weiter mit 0 und ist durch den Prüfausdruck der Kopftabelle ergänzt, nicht ersetzt. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('\n### 3.1 ')[1].split('\n### 3.2 ')[0];raise SystemExit(0 if 'EAD}_z = ' in k and 'EAD}_k = ' in k and 'EAD} = ' not in k else 1)"` | behoben (vorher bewusst offen) |
| 57 | B | (a) wie 24; (b) §3.6, Teil-Ausweis 1: Satz zur fehlenden Proportionalität von \(\bar A_k\) und \(\text{EAD}_k\) über Kommunen, Spannweite 1.533…1.950 €₂₀₂₆/m² BGF (bis rund 21 %); (c) Golden-Test `beispiel_60_kernformel` um eine Kommune mit EFH-Zelle (1.200 m²) und MFH-Zelle (3.000 m²) erweitert: \(\sum_z \bar A_z w_z = 20.195{,}7\) gegen \(\bar A_k \cdot w_{\text{Kommune}} = 18.077{,}9\) €₂₀₂₆/a, drei `assert`-Zeilen, im Lint grün. Kein ausgewiesener Zahlenwert ändert sich. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split('\n### 3.6 ')[1].split('\n### 3.7 ')[0];raise SystemExit(0 if 'ead_mix' in k and '1.533…1.950' in k and 'nicht proportional' in k else 1)"` | behoben |
| 74 | C | Modellgrenze „nicht proportional bei gemischtem Gebäudetyp" steht jetzt in §3.1 (mit gerechnetem Beispiel, 10,5 % bezogen auf \(\text{EAD}_k\)), §3.5 (\(\bar A\)-Zeile) und §3.6 (Teil-Ausweis 1) — die Entscheidung ist nach eiserner Regel 2 außerhalb des Ledgers dokumentiert. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=lambda a,b: s.split('\n### '+a+' ')[1].split('\n### '+b+' ')[0];raise SystemExit(0 if all('nicht proportional' in t(a,b) for a,b in (('3.1','3.2'),('3.5','3.6'),('3.6','3.7'))) else 1)"` | behoben |
| 82 | C | (a) §3.2, Zeile GEBAEUDEWERT, Spalte „Normierung/Zentrierung": Vermerk „Indexierung 2010 → 2023 belegt; Fortschreibung 2023 → 2026 mit Faktor 1,105 = Abschätzung von KAP3, §3.9, Band 1,07–1,16, Herleitung B4"; (b) §3.4: „im Kern belegt, mit abgeschätztem Fortschreibungsfaktor (§3.9)" statt „belegt". Kein Zahlenwert geändert. **(c) nicht umgesetzt:** eine Lint-Regel „Parameter mit `kennzeichnung: abschaetzung_kap3` nicht als ‚belegt‘ bezeichnen" ist eine Änderung an `backend/scripts/lint_methodik.py` und liegt außerhalb des Zuschnitts dieses Pakets (Bericht §3.1/§3.2); sie bleibt als Anregung für ein eigenes Paket stehen und hindert den Status nicht, weil der Befund selbst (dreifach verschiedene Kennzeichnung) mit (a)/(b) beseitigt ist. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=lambda a,b: s.split('\n### '+a+' ')[1].split('\n### '+b+' ')[0];raise SystemExit(0 if 'Fortschreibung 2023 → 2026 mit Faktor 1,105 = Abschätzung von KAP3' in t('3.2','3.3') and 'sind belegt und auf den Preisstand' not in t('3.4','3.5') else 1)"` | behoben |

**Prüfausdrücke der Kopftabelle.** Die vier neuen Prüfausdrücke enden auf dem Branch mit 0 und auf
dem Stand von main vor dem Paket mit 1. Kein Prüfausdruck der Kopftabelle, der auf main mit 0 endete,
wurde geändert oder kippt. `python3 backend/scripts/lint_methodik.py 60`: 162 Checks grün, vor und
nach dem Paket.

## Autor-Revision T-0568 (Befunde 25, 54, 55, 56, 75, 95)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht §3.5 — Zeichentabelle vollständig, richtig
zugeordnet und alphabetisch. Geändert wurden `docs/methodik/60_gebaeudeschaeden_flusshochwasser.md`
(Präambel Kap. 2, Entscheidungsspalte der Registerzeilen 60-S093-01/60-S094-01, §3.5, §5.1.3), der
Spiegel `docs/evidenz/register.md` (dieselben zwei Registerzeilen, Nacharbeit Runde 1) und dieser Ledger. Kein Zahlenwert, kein Band und kein Parameter-Block ändert sich.

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 25 | C | §3.5: neue Zeilen \(q_0\) (Herkunft §4.7, geparkt, Datenquelle fehlt) und \(\tau_i\) (\(\tau_1\), \(\tau_2\), \(\tau_3\); m²/a; Herkunft §5.1.3). §5.1.3: die Szenariobeiträge heißen jetzt \(\tau_1\)…\(\tau_3\) statt \(t_1\)…\(t_3\). Der Status „bewusst offen" ist aufgehoben, weil die vier Zeilen jetzt stehen. Der zeilennummerngebundene Prüfausdruck der Runde 2 (Abschn. 1.2) weist die Lücke nach, nicht ihre Behebung, und ist kein Prüfausdruck der Kopftabelle; er wird nicht fortgeschrieben. | wortgleich in der Kopftabelle | behoben (vorher bewusst offen) |
| 54 | B | §3.5: neue Zeile \(f_{\text{AWM}}\) (0,55, Band 0,40–0,75, Herkunft `herleitung:#fortschreibung-neuwert-k3`, §7.2/§4.8); die Zeile \(w_z\) ist zur Gattungszeile \(w\) (\(w_z\), \(w_{\text{Kommune}}\)) erweitert — nach dem Muster der \(\bar A\)-Zeile, mit der Unterscheidung zwischen der wohnflächengewichteten Wertdichte \(w_{\text{Kommune}}\) aus §3.1 und der Summe \(\sum_{z \in k} \bar A_z w_z\). **Nicht umgesetzt:** Den Vollständigkeitsanspruch als Lint prüfen — das ist eine Änderung an `backend/scripts/lint_methodik.py` und liegt außerhalb des Zuschnitts (Bericht §3.5); sie bleibt als Anregung für ein eigenes Paket stehen und hindert den Status nicht, weil die beiden fehlenden Zeilen jetzt stehen. | wortgleich in der Kopftabelle | behoben |
| 55 | B | Präambel Kap. 2: zwei Fälle ausdrücklich zugelassen — (1) ein Zeichen einer Zeile mit Entscheidung Sensitivitätsband als neutral gesetztes Glied (1,00) in der Formel, (2) die belegten Enden \(d_1\)/\(d_5\) der Wasserstandsachse als Basiswert mit Herleitung §3.3. Registerzeilen 60-S093-01/60-S094-01: „kein eigenes Multiplikativglied im Basiswert" ersetzt durch „in der Kernformel §3.4 steht es als neutral gesetztes Glied (1,00), das den Basiswert nicht verschiebt". §3.5: \(d(h)\) und \(d_1\)/\(d_5\) mit Herkunft `herleitung: §3.3` (Langbeleg B5) statt Registerzeile, \(f_{S093}\)/\(f_{S094}\) mit Vermerk zur Entscheidung Sensitivitätsband. Gewählt ist die zweite Variante des Vorschlags (Präambel ergänzen), nicht die Teilung der Registerzeile, weil sie ohne neue Register-ID auskommt. **Nacharbeit Runde 1:** Die Entscheidungsspalte der Zeilen 60-S093-01/60-S094-01 im Spiegel `docs/evidenz/register.md` ist nach dem Präfix „#60 (“ wortgleich auf den neuen Stand des Berichts gezogen (wie T-0286 für Befund 28); die frühere Aussage, die Variante komme ohne Änderung am Spiegel aus, war falsch. Der Prüfausdruck prüft jetzt auch die beiden Spiegelzeilen. **Maschinenlesbare Herkunft von \(d_1\)/\(d_5\) bleibt bewusst auf der Registerzeile:** Die Blöcke `flood_bldg.d_1` und `flood_bldg.d_5` (Kap. 7) sowie §3.3 nennen weiter `register:60-S093-01`. Das ist gewollt und durch Präambel-Fall (2) gedeckt: Die Zeile 60-S093-01 ist die Fundstelle der Quelle (Langbeleg B5, `kennzeichnung: quelle`), ihre Entscheidung „Sensitivitätsband“ gilt nur der Zustandsachse. §3.5 nennt als Herkunft die Herleitungsstelle §3.3, auf der diese Fundstelle zitiert ist — beide Angaben zeigen auf dieselbe Quelle. Ein Umbau der Blöcke auf `herleitung:` hätte keinen Zahlenwert geändert, aber die maschinenlesbare Quellenkennzeichnung (`quelle` → Herleitungsanker) verschoben; das gehört nicht zum Zuschnitt dieses Pakets. Das Wort „Platzhalter" aus dem Vorschlag ist im Lint verboten und deshalb durch „neutral gesetztes Glied" ersetzt. | wortgleich in der Kopftabelle | behoben |
| 56 | C | §3.5: 31 Zeilen alphabetisch sortiert — nach dem Grundbuchstaben, lateinische vor griechischen Buchstaben, bei gleichem Buchstaben klein vor groß, Indizes und Zusätze nachgeordnet; die Regel steht im Einleitungsabsatz. Keine Spalte „Schritt": eine fünfte Spalte bräche den Lint (vier Zellen je Zeile) und den Prüfausdruck zu Befund 8; der Rechenschritt steht in der Herkunftsspalte. | wortgleich in der Kopftabelle | behoben |
| 75 | C | wie 25; zusätzlich nennt der Einleitungssatz von §3.5 die Zeichen ohne Rechenwirkung im Basiswert (\(f_{\text{AWM}}\), \(q_0\), \(\tau_1\)…\(\tau_3\)) und begründet die Umbenennung, so dass der Vollständigkeitsanspruch wörtlich stimmt und \(t\) allein der Laufindex des Gebäudetyps bleibt. | wortgleich in der Kopftabelle | behoben |
| 95 | C | wie 54 (Zeile \(f_{\text{AWM}}\)); die Zeile trägt die Einheit „– (Verhältnis RND/GND)" und den Vermerk, dass der Faktor nur als Sensitivität läuft und deshalb keinen Parameter-Block in Kap. 7 trägt. | wortgleich in der Kopftabelle | behoben |

**Prüfausdrücke der Kopftabelle.** Die sechs neuen Prüfausdrücke enden auf dem Branch mit 0 und auf
dem Stand von main vor dem Paket mit 1. Kein Prüfausdruck der Kopftabelle, der auf main mit 0 endete,
wurde geändert oder kippt. `python3 backend/scripts/lint_methodik.py 60`: vorher 162, nachher
165 Checks grün (drei neue Zeichentabellen-Zeilen).

## Autor-Revision T-0569 (Befunde 12, 27, 38, 60, 70, 76, 98)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 — Preisstand und Kostensatz-Fortschreibung,
\(\pi\)-Band und B4-Jahresraten. Geändert wurden `docs/methodik/60_gebaeudeschaeden_flusshochwasser.md`
(Kap. 1 „Konto-Einbettung“, Registerzeile 60-R24-01, Langbeleg B4 Rechenschritte 2–4, §3.1, §3.4,
§4.1a, §4.2, §4.3, §4.4, §4.8 samt Block `beispiel_60_kalibrierung`, Kap. 7 Blöcke
`flood_bldg.n_efh_zfh`, `flood_bldg.n_mfh`, `flood_bldg.pi`, `flood_bldg.lambda`, Entscheidungslog
Nr. 8), der Spiegel `docs/evidenz/register.md` (Registerzeile 60-R24-01, Spalte Effektgröße
wortgleich) und dieser Ledger. **Zentralwerte unverändert:** Faktor 1,105, \(n_t\) = 1.950 / 1.533
€₂₀₂₆/m² BGF, \(\pi\) = 1,07, \(A^{*}\) = 1,132, \(M_0\) = 1,360, \(\lambda\) = 0,832. **Geänderte
Bandenden** (in dieser Sitzung nachgerechnet und im Beispielblock zugesichert):

| Größe | vorher | nachher | Ursache |
|---|---|---|---|
| \(n_{\text{EFH/ZFH}}\) (€₂₀₂₆/m² BGF) | 1.889–2.047 | 1.890–2.043 | 1.765 × 1,0706 bzw. × 1,1576 (ungerundet) |
| \(n_{\text{MFH}}\) (€₂₀₂₆/m² BGF) | 1.484–1.609 | 1.485–1.606 | 1.387 × 1,0706 bzw. × 1,1576 |
| Wertdichte (€₂₀₂₆/m² Wohnfläche) | „1.993–2.535“ ohne Kennzeichnung | Typ-Spanne 1.993 (MFH) bis 2.535 (EFH/ZFH); Unsicherheitsband 1.856–2.860 | Faktorbänder fortgepflanzt |
| Bestandswert (Bio. €₂₀₂₆) | „8,2–10,4“ | Typ-Spanne 8,2–10,4; Unsicherheitsband 7,6–11,7 | wie vor |
| \(\pi\) | 1,04–1,11 | 1,039–1,124 | 1,0706/1,03 bzw. 1,1576/1,03 |
| \(A^{*}\) (Mrd. €₂₀₂₆/a) | 0,297–2,263 | 0,296–2,291 | \(\pi\)-Band |
| \(M_0\) (Mrd. €₂₀₂₆/a) | 0,657–2,643 | 0,657–2,638 | Wertsatz-Band |
| \(\lambda\)-Band = Plausibilitätsschranke | 0,11–3,44 | 0,11–3,49 | 0,296/2,638 = 0,112; 2,291/0,657 = 3,487 |

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 12 | B | Offener Rest aus den Regressionen der Runden 2 und 3 war die Preisstand-Seite (→ Befund 70); mit 70 geschlossen. Kostensatz-Typ (Entscheidungslog Nr. 7) und R5 standen bereits. | wortgleich in der Kopftabelle | behoben (vorher offen) |
| 27 | C | (a) B4 Rechenschritt 2: Herkunft der Jahresraten ausgewiesen — 5,0 % belegt, 3,4 % und 2,3 % gerundete Setzungen von KAP3 mit Richtung und Größe (Median 3,3 % ⇒ 1,033³ = 1,102, Mittel 3,83 % ⇒ 1,0383³ = 1,119; −0,2 %/+1,3 % gegenüber 1,105); (b) Bandenden ungerundet gerechnet; (c) Typ-Spanne und Unsicherheitsband getrennt in Registerzeile, Spiegel und B4 Rechenschritte 3/4. Der Status „bewusst offen“ ist aufgehoben, weil alle drei Teilpunkte im Text stehen. Der zeilennummerngebundene Prüfausdruck der Runde 2 (Abschn. 2.2) weist den Mangel nach, nicht seine Behebung, und ist kein Prüfausdruck der Kopftabelle; er wird nicht fortgeschrieben. | wortgleich in der Kopftabelle | behoben (vorher bewusst offen) |
| 38 | C | \(\pi\)-Band aus dem ungerundeten B4-Band, \(A^{*}\)-Band, \(\lambda\)-Band und Zusicherung `hi` nachgezogen (Vorschlag wörtlich, mit dem ungerundeten 1,1576). Der Mangel-Prüfausdruck der Runde 2 ist kein Prüfausdruck der Kopftabelle und wird nicht fortgeschrieben. | wortgleich in der Kopftabelle | behoben (vorher bewusst offen) |
| 60 | C | wie 38. Gewählt ist das obere Ende 1,124 (ungerundetes 1,1576/1,03) statt der im Vorschlag genannten 1,13 (gerundetes 1,16/1,03), weil Befund 27 im selben Paket die ungerundeten B4-Enden einführt; die Deckelungsvariante (1,11 als Abschätzung) entfällt. | wortgleich in der Kopftabelle | behoben |
| 70 | C | Vorschlag umgesetzt: Kap. 1 Preisstandjahr „abgeleitet aus Register 60-R24-01“, Bedingungssatz ersetzt, Kennzeichnung §3.9 ABGESCHÄTZT auf den Fortschreibungsfaktor eingegrenzt (nicht gestrichen, Ratchet nach eiserner Regel 3 unverändert); der Rückverweis „Bezugsjahr (Preisstand)“ ist nachgezogen — der Vorschlag verortet ihn in „§3.3 Z. 537–539“, er steht im Unterabschnitt 3.1. | wortgleich in der Kopftabelle | behoben |
| 76 | C | wie 27; die Entscheidung steht jetzt als „Modellgrenze:“ in B4 Rechenschritt 2 im Bericht, nicht nur im Ledger. | wortgleich in der Kopftabelle | behoben |
| 98 | C | wie 38, dazu die obere Plausibilitätsschranke 3,49 in §4.1a, §4.4, §4.8, Kap. 7 und Entscheidungslog Nr. 8 sowie `lam_hi`/`schranke_hi` im Beispielblock. Alle vier Fenster-\(\lambda\) (0,457–0,935) liegen weiter innerhalb. | wortgleich in der Kopftabelle | behoben |
| 36 | B | **Fortschreibung des Prüfausdrucks, kein neuer Eingriff.** Der Schließungsausdruck der früheren Zeile 36 („Nachzug des Rechenwegs aus T-0322 im Bericht bestätigt …“) bindet die Zahlenwerte `0,657–2,643`, `0,11–3,44`, `[0,11; 3,44]`, `0,11 bzw. 3,44`, `[0.11, 3.44]` und `0,297–2,263`, die dieses Paket nach Befund 27/38/98 bewusst ändert; er endet deshalb auf dem Branch mit 1, ohne dass der Befund 36 (hergeleitete Schranke statt freihändig gesetzter) wieder aufgeht. Fortgeschrieben auf die neuen Werte, gleiche Prüflogik. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();raise SystemExit(0 if all(x in s for x in ('0,657–2,638','0,11–3,49','[0,11; 3,49]','0,11 bzw. 3,49','[0.11, 3.49]','0,296–2,291')) else 1)"` | behoben (unverändert) |

**Prüfausdrücke der Kopftabelle.** Die sieben neuen Prüfausdrücke enden auf dem Branch mit 0 und auf
dem Stand von main vor dem Paket mit 1. Kein Prüfausdruck der Kopftabelle, der auf main mit 0 endete,
wurde geändert oder kippt; die Ausdrücke zu 2 und 15 enden schon auf main mit 1 und sind unverändert.
`python3 backend/scripts/lint_methodik.py 60`: 165 Checks grün, vor und nach dem Paket.

## Autor-Revision T-0570 (Befunde 58, 62, 89)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 Kap. 4 — \(M_0\) mit typgewichtetem
Wertsatz neu gerechnet, \(\lambda\), Band und Plausibilitätsschranke neu. Geändert wurden
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (Kap. 4 Einleitung, §4.1a, §4.3, §4.4, §4.6,
§4.8 samt Block `beispiel_60_kalibrierung`, Kap. 7 Block `flood_bldg.lambda`, Entscheidungslog
Nr. 8), neu angelegt `docs/evidenz/60_destatis_wohnflaeche_gebaeudetyp_2021.csv` (Destatis, Bestand
und Bauabgang von Wohnungen und Wohngebäuden 2021, Tabelle 2.1.3, Stichtag 31.12.2021) und dieser Ledger.

| Größe | vorher | nachher | Ursache |
|---|---|---|---|
| Typ-Mix \(\bar\theta_{\text{EFH/ZFH}}\) | nicht geführt (implizit 1,0) | 0,596 (0,471–0,624) | Wohnfläche EFH+ZFH 2.289.188 / 3.841.438 Tsd. m²; Band aus Neue Länder und Berlin bzw. Früheres Bundesgebiet |
| Wertsatz (€₂₀₂₆/m² BGF) | 1.950 (1.890–2.043) | 1.781,532 (1.675,755–1.878,688) | 0,596 · 1.950 + 0,404 · 1.533 |
| Wert je exponiertem Wohngebäude (€₂₀₂₆) | 527.280 | 481.726,25 (435.696,30–547.073,95) | 208 · 1,30 · typgewichteter Wertsatz |
| \(M_0\) (Mrd. €₂₀₂₆/a) | 1,360 (0,657–2,638) | 1,243 (0,583–2,425) | Klassenbeiträge 0,852 + 0,391 |
| \(\lambda\) | 0,832 (0,11–3,49) | 0,911 (0,12–3,93) | 1,132/1,243; 0,296/2,425 = 0,122061…; 2,291/0,583 = 3,929674… |
| Fenster-\(\lambda\) §4.1a | 0,832 / 0,935 / 0,611 / 0,457 | 0,911 / 1,023 / 0,669 / 0,500 | \(A^{*}\) je Fenster / 1,243; alle vier in [0,12; 3,93] |
| Alternativnenner §4.3 | \(M_0\) 0,931, \(\lambda\) 1,058 | \(M_0\) 0,850, \(\lambda\) 1,33 | gleicher Wertsatz |

**Unverändert:** \(A^{*}\) = 1,132 und sein Band, die Klassenraten, \(\lambda M_0\) = 1,132, die
Sanity-Grenzen \(U\) = 0,0103 und \(O\) = 6,29 (\(O\) bleibt bewusst beim reinen EFH/ZFH-Satz als
sichere Obergrenze, mit dem Typ-Mix wären es 5,74; im Bericht §4.6 begründet). §7.2
(Zeitwert-Sensitivität 1,51/2,08 auf \(M_0\) = 1,360), Kap. 1 „Konto-Einbettung“ (527.280 € je
Wohngebäude) und der Abschnitt `## Ergebnis` (Befund 94) liegen außerhalb des Zuschnitts (Kap. 4)
und sind nicht nachgezogen.

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 58 | B | §4.3 Punkt 2: nationaler Typ-Mix mit Quelle, typgewichteter Wertsatz \(\bar\theta_{\text{EFH/ZFH}} n_{\text{EFH/ZFH}} + \bar\theta_{\text{MFH}} n_{\text{MFH}}\) wie im Produktionsmodell (§3.4); Wohnfläche 208 m² und Typ-Mix beziehen sich jetzt auf dieselbe Grundgesamtheit. Bandtabelle: \(n_{\text{EFH/ZFH}}\), \(n_{\text{MFH}}\) und \(\bar\theta\) als eigene Zeilen (zehn Eingangsgrößen). \(M_0\), \(\lambda\), Band, Schranke, Fenster-Sensitivität, §4.6-Ist, §4.8 (neue Zeile \(\bar\theta\)), Beispielblock, Kap. 7 und Entscheidungslog Nr. 8 nachgezogen. Der Mix der **exponierten** Teilmenge ist nicht gemessen: im Band als Abschätzung von KAP3 geführt; die Randfälle (reiner MFH- bzw. EFH/ZFH-Satz: \(M_0\) 1,069 bzw. 1,360) stehen als Modellgrenze in §4.3, die Richtung des verbleibenden Fehlers im Vorläufigkeitsvermerk der Kap.-4-Einleitung. Quelle ist die Bestandsfortschreibung auf GWZ-2011-Basis (31.12.2021), nicht der Zensus 2022 — offen benannt in §4.3. | wortgleich in der Kopftabelle | behoben |
| 62 | C | Die drei beanstandeten Ziffernfolgen waren durch T-0569 bereits ersetzt; mit der Neurechnung sind alle „=“-Zwischenergebnisse der Band- und Schrankenrechnung aus den ausgewiesenen Eingängen neu gerechnet und nachgeprüft (0,122061…, 3,929674…, 582.838.678, 2.425.419.445, 1.781,532, 1.675,755, 1.878,688) und im Beispielblock zugesichert. **Nicht umgesetzt:** der Lint-Vorschlag (jede „=“-Division der Kalibrierkette nachrechnen) ist eine Änderung an `backend/scripts/lint_methodik.py` außerhalb des Zuschnitts; er bleibt als Anregung stehen. | wortgleich in der Kopftabelle | behoben |
| 89 | C | §4.8 \(\lambda\)-Zeile und die beiden Kommentare im Beispielblock nennen Datei, Zeile (`gk3_gk4;alle` / `gk2;alle`) und Spalte `rate_exponiert_hqextrem_1_pro_a`; die Begründung, warum die exponierte Rate und nicht die Zellrate gilt, stand schon in §4.3 Punkt 3 und ist von §4.8 aus verwiesen. Lint-Vorschlag wie bei 62 nicht umgesetzt. | wortgleich in der Kopftabelle | behoben |
...
endet auf dem Branch mit 0. Die Ausdrücke zu 2 und 15 enden schon auf main mit 1 und sind
unverändert. `python3 backend/scripts/lint_methodik.py 60`: 165 Checks grün, vor und nach dem Paket.

## Autor-Revision T-0571 (Befunde 59, 91, 94)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 — abgelösten Anker und alten
\(\lambda\)-Stand an allen Fundstellen nachgezogen. Geändert wurden
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (Abschnitt `## Ergebnis`, §4.1a, Kap. 6 Modellgrenze 9,
Entscheidungslog Nr. 7) und dieser Ledger (Kopftabelle, Einträge zu Befund 34). Maßgeblich ist der Stand
nach T-0570: \(A^{*}\) = 1,132, \(M_0\) = 1,243 Mrd. €₂₀₂₆/a, \(\lambda\) = 0,911 (0,12–3,93),
kalibrierte Bundessumme \(\lambda M_0\) = 1,132 Mrd. €₂₀₂₆/a (§4.6). Der Vorschlag aus Befund 59
nannte noch die Zielwerte auf \(M_0\) = 1,360 (\(\lambda\) 0,832; 1,51/2,08); sie sind hier auf den
geltenden \(M_0\) gerechnet.

**Bewusst nicht angefasst: §7.2 und §4.8.** §7.2 (Begründung 1 mit 1,51/2,08, Ergebnis-Sensitivität
mit 0,99/0,54, Beispielblock `beispiel_60_zeitwert` mit dem Literal 1,6) und die §4.8-Zeile
\(f_{\text{AWM}}\) tragen denselben abgelösten Stand, sind aber Gegenstand der Befunde 92, 93 und 100,
die das Schwesterpaket T-0573 (Reihenfolge 8, Vorhaben T-0401) schließt. Zöge dieses Paket sie
schon nach, endeten dessen Prüfausdrücke auf main vor dem Paket bereits mit 0, und sein
Abnahmekriterium (a) wäre nicht mehr erfüllbar. Bis dahin nennen Kap. 6 und Entscheidungslog Nr. 7
die auf den geltenden Anker gerechneten Werte, §7.2 und §4.8 noch die alten; der Abgleich ist
Sache von T-0573.

| Größe | vorher | nachher | Rechnung |
|---|---|---|---|
| Zeitwert-Sensitivität K3-Betrag (Kap. 6 MG 9, Log Nr. 7) | 0,54 (0,39–0,74) statt 0,99 Mrd. €₂₀₂₆/a | 0,62 (0,45–0,85) statt 1,13 Mrd. €₂₀₂₆/a | 1,132 · 0,55 / 0,40 / 0,75 = 0,6226 / 0,4528 / 0,849 |
| \(\lambda\) bei Umstellung nur des Basiswerts (Log Nr. 7) | 1,32 (bis 1,81) | 1,66 (bis 2,28) | 1,132 / (1,243 · 0,55) = 1,656; 1,132 / (1,243 · 0,40) = 2,277 |
| Ergebnis-Abschnitt, Offen (1) | \(M_0\) 1,360, \(\lambda\) 0,724 | \(M_0\) 1,243, \(\lambda\) 0,911 | §4.3/§4.4 |
| Gegenrechnung Alternativnenner §4.3 | (schon mit T-0570: \(M_0\) 0,850, \(\lambda\) 1,33) | unverändert | 1,132 / 0,850 = 1,332 |

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 59 | B | (a) §4.3 Gegenrechnung war mit T-0570 bereits auf den geltenden Anker gezogen (1,33 statt 1,058) — nur nachgeprüft, Prüfausdruck bindet sie. (b) Kap. 6 Modellgrenze 9: „0,62 statt 1,13 Mrd. €₂₀₂₆/a, Band 0,45–0,85“ mit Verweis auf die kalibrierte Bundessumme in §4.6; der Versionsstempel nennt nur die relative Minderung (−45 %) und bleibt wortgleich. (c) Entscheidungslog Nr. 7: \(\lambda\) 1,66 (bis 2,28), Nachzugsvermerk auf den geltenden Stand statt \(\lambda\) = 0,724, Auswirkungsspalte verweist auf die Bundessumme aus §4.6 statt den Betrag zu wiederholen. §7.2 und §4.8 bleiben dem Schwesterpaket T-0573 (siehe oben). **Nicht umgesetzt:** der Lint-Vorschlag (\(\lambda M_0\) gegen jede genannte Bundessumme prüfen) — Änderung an `backend/scripts/lint_methodik.py` außerhalb des Zuschnitts. | wortgleich in der Kopftabelle | behoben |
| 91 | C | Ledger-Einträge zu Befund 34 (Kopftabelle und Autor-Revision nach Runde 2) um den Vermerk ergänzt, dass das Band 0,22–1,66 durch 0,11–3,44 (Befund 36), 0,11–3,49 (T-0569) und 0,12–3,93 (T-0570) abgelöst ist; der alte Wortlaut bleibt stehen. Bericht §4.1a: klargestellt, dass der Tukey-Fence das Band von \(A_{\text{ver}}\) (1,061–1,838) liefert und das \(\lambda\)-Band aus §4.4 folgt. | wortgleich in der Kopftabelle | behoben |
| 94 | B | Ergebnis-Abschnitt, Offen (1): \(M_0\) = 1,243, \(\lambda\) = 0,911 mit Vermerk, dass die Werte in §4.3/§4.4 gepflegt werden. Der Standvermerk des Aufzählungspunkts („Stand 17.09.2026, nach Review-Runde 2“) ist nicht umgeschrieben, weil die Punkte (2)–(4) nicht nachgeprüft sind; der Nachzug steht deshalb am Wert selbst. | wortgleich in der Kopftabelle | behoben |

**Prüfausdrücke der Kopftabelle.** Die drei neuen Prüfausdrücke (59, 91, 94) enden auf dem Branch
mit 0 und auf dem Stand von main vor dem Paket (Bericht und Ledger per `git show main:<pfad>`) mit 1.
Kein Prüfausdruck der Kopftabelle, der auf main mit 0 endete, ist gekippt; die Ausdrücke zu 2 und 15
enden schon auf main mit 1 und sind unverändert. `python3 backend/scripts/lint_methodik.py 60`:
165 Checks grün, vor und nach dem Paket.

## Autor-Revision T-0573 (Befunde 41, 53, 92, 93, 100)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 §7.2 — Zeitwert-Sensitivität und
Beispielblock `beispiel_60_zeitwert` auf den geltenden Anker, Status des Mappen-Antrags an der
Quelle sichtbar. Geändert wurden `docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (B4,
§4.8-Zeile \(f_{\text{AWM}}\), §7.2 Sachverhalt, Begründung 1, Zeitwert je Gebäude,
Ergebnis-Sensitivität, Beispielblock und Status, Kap. 8 Quelle 2) und dieser Ledger (Kopftabelle,
Überschrift, dieser Abschnitt). Maßgeblich ist der Stand nach T-0570/T-0571: \(A^{*}\) = 1,132
(\(A_{\text{ver}}\) = 1,838, §4.2), \(M_0\) = 1,243 Mrd. €₂₀₂₆/a mit typgewichtetem Wertsatz
(481.726,25 € je exponiertem Wohngebäude, §4.3), \(\lambda\) = 0,911, kalibrierte Bundessumme
\(\lambda M_0\) = 1,132 Mrd. €₂₀₂₆/a (§4.6), \(U\) = 0,0103 Mrd. €₂₀₂₆/a (§4.6). Die Zielwerte der
Befundvorschläge 92/93/100 (1,51/2,08) standen noch auf \(M_0\) = 1,360; sie sind hier auf den
geltenden \(M_0\) gerechnet und stimmen mit Kap. 6 Modellgrenze 9 und Entscheidungslog Nr. 7 (T-0571)
überein.

| Größe | vorher | nachher | Rechnung |
|---|---|---|---|
| Neuwert je exponiertem Wohngebäude (§7.2 Sachverhalt, Block) | 527.280 € (reiner EFH/ZFH-Satz) | 481.726,25 € | 208 · 1,30 · (0,596 · 1.950 + 0,404 · 1.533), wie §4.3 |
| Zeitwert je Gebäude | 290.004 € (210.912–395.460) | 264.949 € (192.691–361.295) | 481.726,25 · 0,55 / 0,40 / 0,75 = 264.949,44 / 192.690,50 / 361.294,69 |
| \(A^{*}\) im Block | 1,6 · 0,65 · 1,54 · 0,50 · 1,15 · 1,07 = 0,985 | 1,838 · … = 1,132 | 1,1319603 |
| \(M_0\) im Block | 1,360 | 1,243 | 1,2428861 |
| \(\lambda\) nur Basiswert umgestellt (Begründung 1, Block) | 1,51 / 2,08 (Prosa) neben 1,32 / 1,81 (Block, Satz „auf 1,32") | 1,66 / 2,28, eine Angabe | 1,132 / (1,243 · 0,55) = 1,6559; / (1,243 · 0,40) = 2,2769 |
| K3-Betrag konsistent umgestellt (§7.2, §4.8) | 0,54 (0,39–0,74) statt 0,99 Mrd. €₂₀₂₆/a, −0,44 | 0,62 (0,45–0,85) statt 1,132, −0,51 | 1,132 · 0,55 / 0,40 / 0,75 = 0,6226 / 0,4528 / 0,8490; 1,132 · 0,45 = 0,5094 |
| Sanity-Untergrenze im Block | `U = 1.6 * 0.65 * 0.50 * 1.07`, `U * f_mid` ≈ 0,306 (abgelöste zirkuläre Formel) | `U = 0.0103`, 0,0057 (wie Prosa) | 0,0103 · 0,55 = 0,005665 |

**Unverändert:** \(f_{\text{AWM}}\) = 0,55 (0,40–0,75) und seine Herleitung, die relative Minderung
−45 % (Band −25 % bis −60 %), die Entscheidung selbst (Neuwert bleibt Basiswert).

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 41 | B | Kein neuer Eingriff über 92/93/100 hinaus: Der Rest, den die Befundregression Runde 3, Teil 7 als unvollständig geschlossen beurteilt hatte, ist Befund 100 und hier behoben. Der Kopfzeile stand bisher nur „vorhanden (Wortlaut: Runde 2, Abschn. 4.3)“; dessen Teil (b) verlangt `'0,54 statt 0,99' in k` für Kap. 6 und endet seit T-0571 mit 1. Er ist in der Kopftabelle durch einen eigenen Ausdruck ersetzt, der Antrag, Band und die nachgezogene Sensitivität in §4.8 bindet. | wortgleich in der Kopftabelle | behoben (unverändert) |
| 53 | B | §7.2 „Status“ um den Stand an der Quelle ergänzt: Abgleich-Protokoll ohne Zeile zu #60, die vorgesehene Zeile nach dem Muster Z151 wörtlich, Entscheider (Eigner der Mappe), Frist (vor Abnahme und Integration von #60) und Abnahmesperre im Punkt Quellen-Synchronität (LF 14, §6). Kap. 8 Quelle 2 („Anhängige Abweichung“) und B4 („Status des Antrags“) verweisen darauf. Vorschlag (a), die Zeile im Abgleich-Protokoll selbst, ist nicht vollzogen: Das ist ein Eingriff in die Arbeitsmappe und Sache ihres Eigners (eiserne Regel 2); er steht im Bericht als offene Handlung mit Frist. | wortgleich in der Kopftabelle | behoben |
| 92 | B | Beispielblock: \(A^{*}\) aus der Kette mit \(A_{\text{ver}}\) = 1,838 und Zusicherung gegen 1,132 (§4.2), Wertsatz und \(M_0\) wie §4.3, \(U\) aus §4.6. Ergebnis-Sensitivität nennt 1,132 als Ausgangsbetrag mit Verweis auf §4.2/§4.6; §4.8-Zeile \(f_{\text{AWM}}\) nachgezogen. Kap. 6 Modellgrenze 9 und Entscheidungslog Nr. 7 waren seit T-0571 auf dem geltenden Stand und sind nicht geändert. | wortgleich in der Kopftabelle | behoben |
| 93 | B | Begründung 1 auf \(M_0\) = 1,243 gerechnet (1,66 / 2,28) und ausdrücklich als die maßgebliche \(\lambda\)-Angabe des Abschnitts gekennzeichnet; die zweite Angabe („auf 1,32“) ist gestrichen und durch „(Werte in Begründung 1)“ ersetzt; der Block sichert dieselben Werte zu. | wortgleich in der Kopftabelle | behoben |
| 100 | B | Ergebnis-Sensitivität 1,132 → 0,62 Mrd. €₂₀₂₆/a (0,45–0,85), −0,51 Mrd. bzw. −45 %, mit ausgeschriebener Rechnung; „bleibt der Betrag bei 1,132“; Zeitwert je Gebäude auf dem typgewichteten Neuwert; Block wie 92; §4.8 wie 92. | wortgleich in der Kopftabelle | behoben |

**Bewusst nicht angefasst.** Entscheidungslog Nr. 7 nennt als Entscheidungstext vom 17.09.2026 den
Neuwert „527.280 €₂₀₂₆ je Wohngebäude“, Kap. 1 „Konto-Einbettung“ ebenfalls 527.280 € (schon in
T-0570 als nicht nachgezogen vermerkt); beide liegen außerhalb von §7.2 und gehören zu keinem der
fünf Befunde. Die Zeile im Abgleich-Protokoll der Arbeitsmappe (Befund 53 (a)) ist nicht angelegt,
siehe oben.

**Prüfausdrücke der Kopftabelle.** Die fünf neuen Prüfausdrücke (41, 53, 92, 93, 100) enden auf dem
Branch mit 0 und auf dem Stand von main vor dem Paket (Bericht, Ledger und `docs/evidenz/register.md`
per `git show main:<pfad>`) mit 1. Kein Prüfausdruck der Kopftabelle, der auf main mit 0 endete, ist
gekippt; die Ausdrücke zu 15 und 83 enden schon auf main mit 1 und sind unverändert, der zu 2
(`grep -c`) gibt vor und nach dem Paket 0 aus. `python3 backend/scripts/lint_methodik.py 60`:
165 Checks grün, vor und nach dem Paket.

## Autor-Revision T-0574 (Befunde 35, 61, 64, 96, 97)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 §4.4/§4.6 — Plausibilitätsschranke ohne
Zirkelschluss, Sanity-Band mit Trennschärfe. Geändert wurden
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (Einleitung Kap. 4, §4.1a Fenster-Absatz,
§4.4, §4.6, §4.8, Block `beispiel_60_kalibrierung`, §7.2 Ergebnis-Sensitivität und Block
`beispiel_60_zeitwert` nur in der Untergrenze) und dieser Ledger (Überschrift, Kopfzeilen 35, 37,
61, 64, 96, 97, dieser Abschnitt). Maßgeblich bleibt \(\lambda\) = 0,911 und
\(\lambda M_0\) = 1,132 Mrd. €₂₀₂₆/a (T-0570/T-0573); an diesen Werten ändert das Paket nichts, nur
an den Prüfsteinen, gegen die sie stehen.

| Größe | vorher | nachher | Rechnung |
|---|---|---|---|
| Plausibilitätsschranke \(\lambda\) (§4.4) | [0,12; 3,93], aus den eigenen Bändern (kann nicht scheitern) | [0,5; 2,0], Abschätzung von KAP3; [0,12; 3,93] bleibt als Unsicherheitsband | Faktor 2 um 1; 0,911 / 0,5 = 1,82; 2,0 / 0,911 = 2,20 |
| Untergrenze \(U\) (§4.6) | 0,0103 (nur Fonds 2013, \(T\) = 100 a) | **0,189** (0,095–0,315) | (8 · 1,02¹³ + 30 · 1,02⁵) · 1/9 · 0,90 / 23 = 43,471 · 0,1 / 23 = 0,18901 |
| Obergrenze unabhängig \(O_u\) | — | **11,04** | 30 · 1,02⁵ / 3 = 11,0408 |
| Modellschranke \(O_M\) | 6,29 als „Obergrenze" | 6,29, gekennzeichnet modellabhängig | 6,29 / 1,243 = 5,06; 2,0 · 1,243 = 2,49 < 6,29 |
| Spannweite des Bandes | Faktor 611 (T-0333); Runde 2 Faktor 3,5 | Faktor 58,4 | 11,041 / 0,18901; 6,29 / 0,0103; 2,264 / 0,64 |
| Abstand Ist | 110-Faches von \(U\), 18 % von \(O\) | 6,0-Faches von \(U\), 10 % von \(O_u\) | 1,132 / 0,18901 = 5,99; 1,132 / 11,041 = 0,103 |
| §7.2 Untergrenze im Zeitwertfall | 0,0103 · 0,55 = 0,0057 | 0,189 · 0,55 = 0,104 | Folge der neuen \(U\) |

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 35 | B | Der Rest aus der Befundregression Teil 6 (Weitung ohne Ausweis, → 96) ist mit 96 behoben; die drei Teilpunkte (a)–(c) waren seit T-0333 umgesetzt und sind mit der neuen Fassung erhalten (Untergrenze ohne Anker- und Registergröße, klassengerechte Bestandsschranke als Modellschranke, Ausnahme vom Amtlichkeitsgebot für alle Grenzen). | wortgleich in der Kopftabelle | behoben |
| 61 | B | §4.4 trennt das fortgepflanzte Band (Unsicherheitsband, kein Prüfstein) von der Plausibilitätsschranke [0,5; 2,0], die als Abschätzung von KAP3 aus einem Modellverständnis-Argument ohne Größe aus \(\lambda\) begründet ist, mit Sensitivität (Faktor 1,5 / 3) und dem Nachweis, dass das Band über die Schranke hinausragt. §4.1a-Fensterabsatz, Einleitung Kap. 4 (35/36 nicht mehr offen), §4.8 (zwei Zeilen) und Block nachgezogen. Die Variablen `schranke_lo/hi` im Block tragen weiter das Unsicherheitsband, weil der Prüfausdruck zu 98 das Literal `assert abs(schranke_hi - 3.93)` bindet; ein Kommentar benennt das. | wortgleich in der Kopftabelle | behoben |
| 64 | B | §4.6: unabhängige Obergrenze \(O_u\) aus dem Fondsvolumen 2021; die Bestandsschranke heißt Modellschranke \(O_M\), mit ausgewiesenem Vielfachen von \(M_0\) und dem Nachweis, dass sie nach §4.4 nicht auslösen kann. Integrationstest nennt beide Grenzarten getrennt. Anders als vorgeschlagen ohne Wiederkehrzeit: 33,12 · 0,11 · 0,90 / 100 = 0,033 läge unter dem Ist-Wert und wäre keine Obergrenze. | wortgleich in der Kopftabelle | behoben |
...
Lint dafür läge außerhalb des Zuschnitts.

**Prüfausdrücke der Kopftabelle.** Die fünf neuen Prüfausdrücke (35, 61, 64, 96, 97) enden auf dem
Branch mit 0 und auf dem Stand von main vor dem Paket (Bericht und Ledger per `git show main:<pfad>`)
mit 1. Kein Prüfausdruck der Kopftabelle, der auf main mit 0 endete, ist gekippt; die Ausdrücke zu 15
und 83 enden schon auf main mit 1 und sind unverändert, der zu 2 (`grep -c`) gibt vor und nach dem
Paket 0 aus. `python3 backend/scripts/lint_methodik.py 60`: 165 Checks grün, vor und nach dem Paket.

## Autor-Revision T-0575 (Befunde 63, 65)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 §4.5 — Verteilungsprüfung um einen
Quantilvergleich ergänzt, Regime-Anteile konsistent gerundet. Geändert wurden
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (§4.5 Ist-Ergebnis, Grenzen-Absatz, neuer
Absatz „Zweite Prüfgröße: Quantilvergleich der höchsten Jahre" mit Toleranz, Rangtabelle, Ergebnis
und Trennschärfe; §4.8 Zeile „Toleranz Quantilvergleich"; Block `beispiel_60_kalibrierung`) und
dieser Ledger (Überschrift, Nachtrag, Kopfzeilen 63 und 65, dieser Abschnitt). \(\lambda\) = 0,911,
die Bundessumme und das Urteil der ersten Prüfgröße (nicht bestanden, Modellentscheid) bleiben
unverändert.

| Größe | vorher | nachher | Rechnung |
|---|---|---|---|
| Regime-Anteile (§4.5) | 66,1 / 23,2 / 10,6 % (Summe 99,9), seltenes Regime 33,9 % | 66,14 / 23,23 / 10,63 % (Summe 100,00), seltenes Regime 33,86 % | \(\tau\) = 4,1742 / 1,4665 / 0,6708 m²/a, Summe 6,3115 |
| Ankerwert \(R_{\text{anker}}\) | 20,19/42,28 = 47,7 % | 20,186/42,28 = 47,74 % | Überschuss ungerundet 20,1864 |
| Differenz | 13,9 Pp | 47,74 − 33,86 = 13,88 Pp (gerundet 13,9) | Verdikt unverändert: > 11,5 |
| Quantilvergleich Rang 1–4 | — | Anker 9,34 / 4,67 / 2,24 / 1,44 gegen Modell 8,82 / 4,22 / 0 / 0 | \(A_{(i)}/\bar A_{-(i)}\); \(D(i/24)/\bar A_z\) |
| Toleranz Quantilvergleich | — | 90-%-Rangband; Band für \(Q_i^{\text{anker}}\): 0 bis 47,5 / 11,7 / 9,39 / 6,61 | Binomialverteilung der Rangplätze in 23 Jahren |
| Ergebnis Quantilvergleich | — | bestanden auf allen vier Rängen; auch \(A_3\) = 600 / 900 / 150 m² und Niveau 80 % bestehen | Block `beispiel_60_kalibrierung` |

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 63 | B | §4.5: zweite, quantilbasierte Prüfgröße nach dem Vorschlag — die vier höchsten Jahressummen nach Rang mit Weibull-Position \(i/24\) gegen die aus den drei Stützstellen implizierte Kurve, als Rangtabelle mit Modell- und Beobachtungswert (P3), mit eigener, vorab fixierter Toleranz (90-%-Rangband) und ausdrücklich neben, nicht statt \(R_{\text{anker}}\). Beide Seiten skaleninvariant, das Normaljahr ohne das Rangjahr. Der Grenzen-Absatz beschränkt die Nichtverfügbarkeit auf die Ereignisebene. Gemessen statt angenommen: Die Prüfung besteht, trennt bei 23 Jahren aber nicht (unteres Bandende 0); das steht im Bericht. | wortgleich in der Kopftabelle | behoben |
| 65 | C | §4.5: die drei Anteile aus dem erzeugenden Ausdruck auf zwei Stellen (Summe 100,00), seltener Anteil als Summe seiner Teile, Ankerwert und Differenz ungerundet nachgezogen; der Rundungswiderspruch der alten Fassung ist im Text benannt. Die vorgeschlagene allgemeine Lint-Regel für Anteilstripel ist nicht gebaut (außerhalb des Zuschnitts). | wortgleich in der Kopftabelle | behoben |

**Bewusst nicht angefasst.** Die Nachweisspalte der Kopfzeile 33 und die Abschnitte der Runden 2 und
3 nennen weiter „33,9 %" und „13,9 Pp"; sie sind Nachweise ihrer Pakete und bleiben wortgleich.
§5.1.3 stützt die Bandgrenze von \(s_{\text{bem}}\) auf die Ankerseite, nicht auf den modellseitigen
Anteil 33,9 %; dort ist aus Befund 65 nichts nachzuziehen.
Die Stützstellen der Schadensfunktion bleiben unverändert (§2.4), auch wenn der Punktvergleich des
Quantilvergleichs eher auf mehr Gewicht zwischen HQhäufig und HQ100 hinweist.

**Prüfausdrücke der Kopftabelle.** Die beiden neuen Prüfausdrücke (63, 65) enden auf dem Branch mit 0
und auf dem Stand von main vor dem Paket (Bericht und Ledger per `git show main:<pfad>`) mit 1. Kein
Prüfausdruck der Kopftabelle, der auf main mit 0 endete, ist gekippt; der zu 15 endet schon auf main
mit 1 und ist unverändert, der zu 2 (`grep -c`) gibt vor und nach dem Paket 0 aus.
`python3 backend/scripts/lint_methodik.py 60`: 165 Checks grün, vor und nach dem Paket.

## Autor-Revision T-0576 (Befunde 37, 88)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 §4.8 — P1-Parametertabelle vervollständigt.
Geändert wurden `docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (§4.8: dreizehn neue Zeilen,
Vermerke der einfließenden Abschätzungen bei \(\lambda\) und \(U\); Block `beispiel_60_kalibrierung`
um die neuen Zwischenwerte und die Sensitivität der Fortschreibungsrate ergänzt) und dieser Ledger
(Überschrift, Nachtrag, Kopfzeilen 37 und 88, dieser Abschnitt). Kein Zahlenwert des Berichts ändert
sich; \(\lambda\) = 0,911, \(M_0\) = 1,243 und das Sanity-Band bleiben, wie sie sind.

| Neue Zeile in §4.8 | Wert (Band) | Kennzeichnung | vorher |
|---|---|---|---|
| \(M_0\) Modellsumme | 1,243 Mrd. €₂₀₂₆/a (0,583–2,425) | berechnet, einfließende Abschätzungen benannt | nur im Fließtext von \(\lambda\) |
| Wohnfläche je Wohngebäude | 208 m² (kein Band) | Quelle 60-R24-01 | nur im Code (Befund 88) |
| \(k_{\text{BGF}}\) | 1,30 (1,25–1,40) | Abschätzung von KAP3, §3.4 Schritt 3 | nur im Code (Befund 88) |
| \(n_{\text{EFH/ZFH}}\), \(n_{\text{MFH}}\) | 1.950 (1.890–2.043), 1.533 (1.485–1.606) €₂₀₂₆/m² BGF | Quelle 60-R24-01; Fortschreibungsfaktor Abschätzung von KAP3 | nur im Code (Befund 88) |
| Wert je exponiertem Wohngebäude | 481.726,25 € (435.696,30–547.073,95) | berechnet | nur §4.3 |
| Wohngebäudeanteil je Adresse | 0,872 (kein Band) | Quelle 60-R17-01/60-R24-01 | nur im Fließtext von \(\lambda\) und im Code |
| Exponierte Adressen GK3+GK4 bzw. GK2 | 339.000 bzw. 1.380.000 (kein Band) | Quelle 60-R17-01 | nur §4.3/§4.6 |
| \(r_{\text{GK3+GK4}}\), \(r_{\text{GK2}}\) | 0,0059796 (0,0033–0,0103), 0,00067515 (0,000301–0,001154) a⁻¹ | Zentralwert Quelle `m0_klassenraten.csv`, Band Abschätzung von KAP3 | nur Dateiverweis in \(\lambda\) und im Code |
| Fortschreibungsrate der Fondsvolumina | 2 %/a (kein Band) | Abschätzung von KAP3 mit Sensitivität 0 %/a und 3 %/a | nur im Fließtext von \(E_{\text{fonds}}\) |
| Gebäudewert reiner EFH/ZFH-Satz (nur \(O_M\)) | 527.280 € | berechnet aus drei Zeilen | nur im Fließtext von \(O_M\) |
| Gedeckelte Schadensquote (nur \(O_M\)) | 0,250 | Quelle B5, §3.3 | nur im Fließtext von \(O_M\) |

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 37 | B | §4.8 führt jede in Kapitel 4 rechnende Größe als eigene Zeile mit Wert, Band und Kennzeichnung (Quelle, Abschätzung von KAP3, berechnet oder gezählt). Der Rückfall aus der Befundregression Teil 6 (drei Abschätzungen der Untergrenze nur im Fließtext) war mit T-0574 (Befund 97) behoben; dieses Paket schließt die übrigen Werte, die nur im Fließtext oder im Code standen. Bei \(\lambda\) und \(U\) sind die einfließenden Abschätzungen ergänzt. Der Prüfausdruck aus Runde 2 ist **ersetzt**: Die Durchsicht der Prüfausdrücke stufte ihn als untauglich ein, weil er nur die Namen der drei damals fehlenden Zeilen abfragt. Der neue prüft für 30 rechnende Werte von Kapitel 4, dass jeder am Anfang der Wertspalte einer eigenen Zeile steht und diese Zeile eine Kennzeichnung trägt, und dass jede Tabellenzeile drei Zellen hat. | wortgleich in der Kopftabelle | behoben |
| 88 | B | Erste Alternative des Vorschlags: die ergebnistragenden Größen als eigene Zeilen, die Überschrift „Parameter dieses Kapitels“ bleibt. Von den elf genannten Größen standen \(E_{\text{nom}}\), \(w_u\) und \(f_{\text{fluss}}\) seit T-0574 (als \(E_{\text{fonds}}\), \(w\), \(f_{\text{fluss}}\)) in der Tabelle; \(T_u\) ist dort durch die gezählte Fensterlänge \(N\) ersetzt. Neu: 0,872, beide Klassenraten mit Zeile und Spalte der Datei, BGF-Faktor, beide Wertsätze (der MFH-Satz kam mit Befund 58 hinzu), 208 m² und der Gebäudewert 527.280 € mit seinen Bausteinen. Der Block rechnet die neuen Zwischenwerte nach. | wortgleich in der Kopftabelle | behoben |

**Bewusst nicht angefasst.** Die Stützstellen der Schadensfunktion und ihre Wahrscheinlichkeiten, die
in §4.5 rechnen, stammen aus §3.3/§3.4 und stehen in deren Zeichentabelle (§3.5), nicht in der
Kapitel-4-Tabelle. Die §4.3-Bandtabelle nennt beim BGF-Faktor „Quelle: Register 60-R24-01, §3.9
‚Abgeschätzt‘“, §3.4 und §3.5 nennen ihn eine Abschätzung von KAP3; §4.8 folgt §3.4, die §4.3-Zeile
bleibt wortgleich. Die Fortschreibungsrate 2 %/a hat in §4.6 keinen eigenen Beleg; §4.8 weist sie deshalb
als Abschätzung von KAP3 mit Sensitivität aus, ohne ein Band zu erfinden — eine Herleitung in §4.6 läge
außerhalb dieses Zuschnitts.

**Prüfausdrücke der Kopftabelle.** Die beiden neuen Prüfausdrücke (37, 88) enden auf dem Branch mit 0
und auf dem Stand von main vor dem Paket (Bericht und Ledger per `git show main:<pfad>`) mit 1. Kein
Prüfausdruck der Kopftabelle, der auf main mit 0 endete, ist gekippt; der zu 97 bindet die Kopfzeile 37
weiter an „Klassenraten Bestandsschranke“ und „T-0574“ und endet mit 0. Der zu 15 endet schon auf main
mit 1 und ist unverändert, der zu 2 (`grep -c`) gibt vor und nach dem Paket 0 aus.
`python3 backend/scripts/lint_methodik.py 60`: 165 Checks grün, vor und nach dem Paket.

## Autor-Revision T-0577 (Befunde 66, 67, 68, 79)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 §4.7/Kap. 5 — Wächter-Gewicht, \(q_0\) als
abgeschätzter Parameter, Bandzuordnung S092. Geändert wurden
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (§4.7 Wächter, Verfallsregel, Modellgrenze und
\(q_0\)-Absatz `#q0-abschaetzung`; §4.8 Zeile \(q_0\); §3.5 Zeilen \(q_0\), \(r_{\text{S092}}\),
\(s_{\text{bem}}\); Kap. 1 Knotenzeile S092; Kap. 2 Registerzeile 60-S092-01; Kap. 5 Kommentar und
neuer Absatz „Nicht als Hebel geführt“; §5.1.1, §5.1.2 mit Modellgrenze 4, §5.1.3; Blöcke
`beispiel_60_s092_abschaetzung` und `beispiel_60_s_bem_obergrenze`; Kap. 7 `flood_bldg.s_bem`,
`flood_bldg.r_s092`; Entscheidungslog Nr. 3), `docs/evidenz/register.md` (Zeile 60-S092-01) und dieser
Ledger (Überschrift, Nachtrag, Kopfzeilen 19, 66, 67, 68, 79, dieser Abschnitt). Der Punktwert
\(r_{\text{S092}}\) = 0,035, \(\lambda\) = 0,911 und die Bundessumme bleiben unverändert.

| Größe | vorher | nachher | Rechnung |
|---|---|---|---|
| obere Bandgrenze \(s_{\text{bem}}\) | 0,62 (1 − 1,0/2,6) | 0,52 | 1 − 20,186/42,28 = 0,5226 (Anker §4.5, Befunde 33/65) |
| Band \(r_{\text{S092}}\) | 0,0075–0,0992 | 0,0075–0,0832 | 0,20 · 0,52 · 0,80; Obergrenze −16,1 % |
| Einzelachse \(s_{\text{bem}}\) | r 0,021–0,043 | r 0,021–0,0364 | 0,10 · 0,52 · 0,70 |
| \(q_0\) | geparkt, kein Wert | 0,15 (0,05–0,30), Abschätzung von KAP3 | Herleitung §4.7 `#q0-abschaetzung` |
| Faktor ungeschützter Teil | — | 1,055 (1,018–1,117), nicht eingerechnet | \(1/(1 - q_0 \cdot 0{,}50 \cdot 0{,}70)\) |
| Gewicht Nachrüstjahr 2020 / 2014 | 21,7 % / 47,8 % (Zählgewicht) | 40,2 % / 53,7 % (Betragsanteil) | 17,0/42,28; 22,7/42,28 |
| Verzerrung 2020 / 2014 / 2024 | 78,3 / 52,2 Pp / 95,7 % | 59,8 / 46,3 Pp / 93,9 % | \(1 - g_t\) |
| Größenordnung 2010–2015 | „Hälfte bis drei Viertel“ | 30,0 bis 49,1 % | \(1 - g_{2010}\), \(1 - g_{2015}\) |

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 66 | B | Nachzug nach dem Vorschlag: obere Bandgrenze von \(s_{\text{bem}}\) auf 0,52 aus dem heutigen Ankerwert 47,74 %, gleichlautend an allen in §5.1.3 genannten Stellen und in `docs/evidenz/register.md`. Geprüft, ob der Punktwert 0,50 mitgesenkt werden muss: nein — er ist als oberer Näherungswert zu lesen, das nach unten gestreckte Band bildet die Fehlerrichtung ab; ein gesenkter Punktwert täuschte eine Messung vor (Absatz „Punktwert 0,50 bleibt“ in §5.1.3). | wortgleich in der Kopftabelle | behoben |
| 67 | B | Erste Alternative des Vorschlags: \(q_0\) als eigener abgeschätzter Parameter (0,15, Band 0,05–0,30, Herleitung aus der Verteilung der exponierten Adressen auf GK2 und GK3/GK4; Befragungen nur als Kandidat der Watchlist, nicht als Effektgröße), \(\Delta q \le 1 - q_0\) ausdrücklich gebunden. Die Wirkung nur auf den ungeschützten Teil ist nicht in \(r_{\text{S092}}\) eingerechnet, sondern als bezifferte Modellgrenze 4 ausgewiesen (P3: Kette bleibt lesbar; Faktor liegt im Band und zeigt gegen die \(s_{\text{bem}}\)-Richtung). | wortgleich in der Kopftabelle | behoben |
| 68 | C | Sichtbarer Absatz „Nicht als Hebel geführt“ in Kapitel 5 nach dem Vorschlag; der Pflichtinhalte-Kommentar ist berichtigt und steht nicht mehr als Ersatz für Text. | wortgleich in der Kopftabelle | behoben |
| 79 | B | Gewichte in §4.7 nach dem Vorschlag auf den Betragsanteil umgestellt, Formel mit Zweizeiler-Rechenweg in Worten (P3), beide Rechenbeispiele, Verweis auf die Ankerreihen-CSV, Schiefe als Grund; die drei bezifferten Stellen und die Verfallsregel nachgezogen. Der Prüfausdruck rechnet die Gewichte selbst aus der CSV nach, statt die Zahlen nur abzufragen. | wortgleich in der Kopftabelle | behoben |

**Fortgeschriebener Prüfausdruck 19.** Der Prüfausdruck zu Befund 19 (Registerzeile 60-S092-01 und
Bericht tragen dasselbe Band von \(r_{\text{S092}}\)) band den Wortlaut „Band 0,0075–0,0992“. Mit
Befund 66 ist das Band auf 0,0075–0,0832 gesenkt; auf dem Branch endete der alte Ausdruck deshalb mit
1. Fortgeschrieben ist nur die Zahl (0,0992 → 0,0832 an beiden Stellen); geprüft wird wie bisher, dass
Register und Bericht dasselbe Band tragen und der ganz alte Wert 0,112 nirgends mehr steht. Der Befund
19 bleibt `behoben`.

**Bewusst nicht angefasst.** Die Abschnitte der Runden 2 und 3 und die Kopfzeilen 10, 26 und 33 nennen
weiter 0,62, 0,0992 oder 38,5 %; sie sind Nachweise ihrer Pakete und bleiben wortgleich. Der Prüfausdruck
zu 10 prüft nur die Begriffe „Näherung“, „überschätzt“, „0,661“ und „Stichproben“ und endet weiter mit 0.
Ein eigener Parameter-Block für \(q_0\) in Kap. 7 ist nicht angelegt: \(q_0\) geht in keine Rechnung
des Produkts ein, sondern bindet \(\Delta q\) und beziffert eine Modellgrenze; die nutzersichtbare Zeile
steht in §4.8 (P1). Der Faktor für den ungeschützten Teil ist nicht in \(r_{\text{S092}}\) eingerechnet
(Begründung oben, Zeile 67).

**Prüfausdrücke der Kopftabelle.** Die vier neuen Prüfausdrücke (66, 67, 68, 79) und der fortgeschriebene
zu 19 enden auf dem Branch mit 0 und auf dem Stand von main vor dem Paket (Bericht, Register und Ledger
per `git show main:<pfad>`) mit 1. Kein weiterer Prüfausdruck der Kopftabelle, der auf main mit 0 endete,
ist gekippt; der zu 15 endet schon auf main mit 1 und ist unverändert, der zu 2 (`grep -c`) gibt vor und
nach dem Paket 0 aus. `python3 backend/scripts/lint_methodik.py 60`: 165 Checks grün, vor und nach dem
Paket.

## Autor-Revision T-0578 (Befunde 83, 84, 85, 86, 99)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 Kap. 7 — Parameter-Blöcke für alle
rechnenden §4.8-Werte, \(\lambda\)-Vorläufigkeitsgrund aktuell. Geändert wurden
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (Kap. 7 Kopf mit drei neuen Absätzen
„Zuordnung der Zeilen aus §4.8“, „Datenebene und Ebenen-Status“, „Band der
Szenario-Wahrscheinlichkeit HQhäufig“; 28 neue Blöcke; Felder `datenebene`/`ebene_status` an allen
Blöcken, `platzhalter` an `f_s093`/`f_s094`, Band an `p_hq_haeufig`, `band_grund` an `p_hq100`,
`vorlaeufig_grund` an `lambda`; §4.8 Zeile \(\lambda\); neue Anker vor §4.1, §4.3, §4.5, §4.6) und dieser
Ledger (Überschrift, Nachtrag, Kopfzeilen 15, 83, 84, 85, 86, 99, dieser Abschnitt). Kein Zahlenwert
des Berichts ist geändert; \(\lambda\) = 0,911, \(M_0\) = 1,243 und die Bundessumme bleiben, wie sie sind.

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 83 | B | Vorschlag (a) und (b): Blöcke für alle §4.8-Zeilen, \(q_0\) als Block mit Wert (seit T-0577 nicht mehr geparkt ohne Wert, sondern abgeschätzt 0,15) und `ebene_status: geparkt`. Der Einleitungssatz bleibt wörtlich, weil er jetzt stimmt; der neue Absatz nennt die zwei Zeilen, die auf vorhandene Blöcke zeigen. Vorschlag (c) (Lint-Abgleich Tabelle ↔ Blöcke) ist nicht umgesetzt — Lint-Änderung gehört T-0234; der Prüfausdruck zählt dafür die 36 Tabellenzeilen und verlangt alle 37 Block-Kennungen. | wortgleich in der Kopftabelle | behoben |
| 84 | B | Vorschlag (a) und (b); Wirkung einmal beziffert (Rechnung unten). Vorschlag (c) (Lint-Regel `register:*` ohne `band: null`) nicht umgesetzt, gehört T-0234. | wortgleich in der Kopftabelle | behoben |
| 85 | C | Vorschlag (a) und (b): eine Quelle der Wahrheit (§4.4), Block und §4.8 auf denselben Grund gezogen, Befundnummern aus dem Block entfernt, Datum auf den Stand 23.09.2026. Die Zeile 35 unter `## Ergebnis` und §4.4 nennen denselben Grund bereits (Verteilungsprüfung nicht bestanden) und sind nicht angefasst. Vorschlag (c) (Lint-Regel) gehört T-0234. | wortgleich in der Kopftabelle | behoben |
...
**Fortgeschriebener Prüfausdruck 15.** Der bisherige Ausdruck verlangte `len(bl)==4` und einen
`herleitung_anker` mit Anker auch an Blöcken mit `kennzeichnung: quelle`; er endete deshalb schon auf
main vor diesem Paket mit 1 (in der Durchsicht der Prüfausdrücke als „untauglich“ vermerkt). Fortgeschrieben
prüft er, was Befund 15 verlangt, für jede Blockzahl: jeder Block hat `kennzeichnung` mit genau einem der
zwei zugelassenen Werte und `wertebereich_abweichung: "#fortschreibung-endpunkt-k3"`; jeder als
`abschaetzung_kap3` gekennzeichnete Block zeigt mit `herleitung_anker` auf einen im Text gesetzten
`<a id=…>`; die drei Anker aus Befund 15 stehen im Text; die Überschrift von §7.1 trägt 13.09.2026.
Befund 15 bleibt `behoben`.

**Bewusst nicht angefasst.** Die Abschnitte der Runden 1 bis 3, die Kopfzeilen anderer Befunde und
der Vermerk in der Autor-Revision T-0577 („Ein eigener Parameter-Block für \(q_0\) in Kap. 7 ist nicht
angelegt“) bleiben als Nachweise ihrer Pakete wortgleich; dieser Abschnitt löst den Vermerk ab: \(q_0\)
hat jetzt einen Block mit `rolle: waechter`, weil die Tabelle §4.8 ihn führt und Befund 83 (b) ihn
ausdrücklich als Block verlangt. Die Prüftabelle „Durchsicht der Prüfausdrücke“ nennt den alten Ausdruck
zu 15 weiter als untauglich; das ist ihr Stand vom Tag der Durchsicht.

**Prüfausdrücke der Kopftabelle.** Die fünf neuen Prüfausdrücke (83, 84, 85, 86, 99) enden auf dem
Branch mit 0 und auf dem Stand von main vor dem Paket (Bericht und Ledger per `git show main:<pfad>` in
ein Temporärverzeichnis) mit 1; der fortgeschriebene zu 15 endet auf dem Branch mit 0. Kein weiterer
Prüfausdruck der Kopftabelle hat seinen Ausgang geändert (Abgleich aller Nummern, main gegen Branch).
`python3 backend/scripts/lint_methodik.py 60`: vor dem Paket 165 Checks grün, danach 221 Checks grün,
„ALLE LINTS GRÜN“.

## Autor-Revision T-0579 (Befunde 21, 46, 47, 48, 72, 104)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 Kap. 1 — Knoten-Bilanz: Namen,
Formelstellen, Kein-Doppelkanal. Geändert wurden `docs/methodik/60_gebaeudeschaeden_flusshochwasser.md`
(Kap. 1 Präambel der Knoten-Bilanz; Bilanzzeilen S074, W100, S092 Spalte „Name“; Bilanzzeile S104
Spalte „rechnet in“; Kap. 2 Langbeleg B2, Satz „Abgrenzung zur Knoten-Bilanz“) und dieser Ledger
(Überschrift, Nachtrag, Kopfzeilen 21, 46, 47, 48, 72, 104, dieser Abschnitt). Kein Zahlenwert, keine
Formel und kein Parameter-Block des Berichts ist geändert; die Bundessumme bleibt, wie sie ist.

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 21 | C | Vorschlag, erste Alternative: die drei Namen wörtlich aus B199/B223/B256 übernommen. Der Prüfausdruck aus Runde 1 ist fortgeschrieben: gleicher Maßstab (Name ohne Klammerzusatz = Spalte B der KWK-Zeile), das Pipe-Zeichen im regulären Ausdruck über `chr(124)` gebaut, zusätzlich verlangt er alle 32 Bilanzzeilen. | wortgleich in der Kopftabelle | behoben |
| 46 | B | Der Kern war mit T-0245 behoben (Zeilen S074/R17). Nachgezogen sind die zwei Reste, die die Befundregression dazu fand: Präambel (Befund 48) und Langbeleg B2 (Befund 104). Der alte Ausdruck (Runde 2) verlangte `**FS-Exposition**` in den Bilanzzeilen und endete deshalb seit T-0245 mit 1; er stand in der Kopftabelle nicht. Der neue prüft den Zielstand: beide Zeilen als Sensitivitätsband ohne eigene Formelstelle, `**FS-Exposition**` nirgends im Bericht, keine Zuordnungsaussage „Formelstelle FS-Exposition zugeordnet“, Präambel führt die Formelstelle als aufgehoben. | wortgleich in der Kopftabelle | behoben |
| 47 | B | Vorschlag umgesetzt: S104 als „inaktiv (geparkt …)“ mit Zitat aus Kap. 6, analog zu S096–S098. Die Kap.-6-Stelle selbst ist nicht geändert; sie nennt die Formelstelle als Ziel, sobald 60-S104-01 entschieden ist. Registerzeile 60-S104-01 bleibt `offen`. | wortgleich in der Kopftabelle | behoben |
| 48 | C | Vorschlag, zweite Alternative („als aufgehoben kennzeichnen“): FS-Exposition steht nicht mehr in der Liste der benannten Formelstellen, sondern im Satz danach als aufgehoben, mit Grund. „sieben“ → „sechs“. FS-Bestandsdynamik trägt denselben Vermerk „in dieser Fassung inaktiv, geparkt“ wie FS-Schutzsystem (Folge aus 47). Der B2-Teil des Vorschlags ist unter 104 umgesetzt. | wortgleich in der Kopftabelle | behoben |
| 72 | C | Vorschlag, erste Alternative (wörtliche Übernahme, dann entfällt 21 mit), dazu ein Satz in der Präambel, dass die Spalte „Name“ ungekürzt ist und nur der Klammerzusatz vom Bericht stammt — damit ist der Maßstab für den Leser sichtbar. | wortgleich in der Kopftabelle | behoben |
| 104 | C | Vorschlag wörtlich übernommen, mit Verweis auf Kap. 1 statt auf die aufgehobene Formelstelle. | wortgleich in der Kopftabelle | behoben |

**Bewusst nicht angefasst.** Die Registerzeile 60-S074-01 sagt weiterhin, S074 gehe „nicht als eigener
Faktor in FS-Exposition ein“. Die Aussage verneint und steht damit nicht im Widerspruch zur Bilanz, nennt
aber die aufgehobene Formelstelle; sie gehört keinem der sechs Befunde dieses Pakets und bleibt
unverändert. Die Abschnitte der Runden 1 bis 3 und die Durchsicht der Prüfausdrücke (dort die alten
Ausdrücke zu 21 und 46) bleiben als Nachweise ihrer Stände
wortgleich.

**Prüfausdrücke der Kopftabelle.** Die sechs Prüfausdrücke (21, 46, 47, 48, 72, 104) enden auf dem
Branch mit 0 und auf dem Stand von main vor dem Paket (Dateien per `git show main:<pfad>` in ein
Temporärverzeichnis kopiert) mit 1. Keiner der 56 übrigen Prüfausdrücke der Kopftabelle, die auf main
mit 0 endeten, hat seinen Ausgang geändert (Abgleich aller Nummern, main gegen Branch).
`python3 backend/scripts/lint_methodik.py 60`: vor dem Paket 221 Checks grün, danach 221 Checks grün,
„ALLE LINTS GRÜN“.

## Autor-Revision T-0580 (Befund 49)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 Kap. 2 — Entscheidung für die 25
Registerzeilen ohne Entscheidung. Geändert wurden `docs/methodik/60_gebaeudeschaeden_flusshochwasser.md`
(Kap. 2 Registertabelle, 25 Zeilen, und Präambel; Kopfvermerk „Geltungsbereich“ und Abschnitt
„Ergebnis“, je ein Satz zur Zahl der Zeilen auf `offen`; Kap. 1 Präambel der Knoten-Bilanz und
Bilanzzeile S104 Spalte „rechnet in“; Kap. 6 Modellgrenze „Bestandsdynamik S104“),
`docs/evidenz/register.md` (Spiegel derselben 25 Zeilen) und dieser Ledger (Überschrift, Nachtrag,
Kopfzeilen 47, 48, 49, dieser Abschnitt). Kein Zahlenwert, keine Formel und kein Parameter-Block ist
geändert; keine der 25 Zeilen rechnet, die Bundessumme bleibt, wie sie ist.

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 49 | B | Vorschlag umgesetzt. Die 19 in Kapitel 1 inaktiven Knoten (E02, E03, E10, E14, E17, R18, R19, R23, R25, S096, S097, S098, W006, W008, W074, W077, W087, W091, W100) tragen „bewusst inaktiv“ mit der Begründung und dem Zitat aus ihrer Bilanzzeile; S096–S098 als „geparkt: FS-Schutzsystem ohne Term in §3.4, Modul #50 fehlt“. E07, E12, S072, S073 tragen „bewusst inaktiv (im Hazard-Datensatz enthalten, Kein-Doppelkanal §3.2)“; E08 ebenso für den Anteil über W085, den direkten Kanal mit dem R9-Zitat und Mon. Z64 (bucht #59). S104 ist gemeinsam mit Befund 47 entschieden: „bewusst inaktiv (geparkt: FS-Bestandsdynamik ohne Term)“ mit der Kap.-6-Stelle. Die Evidenzspalten tragen „entfällt — kein Rechenpfad“, wie der Vorschlag es zulässt. | wortgleich in der Kopftabelle | behoben |
| 47 | B | Folge aus 49: Die Bilanzzeile S104 nannte die Registerzeile 60-S104-01 „offen“; sie heißt jetzt „bewusst inaktiv“, sonst widerspräche Kapitel 1 dem Register. Der Prüfausdruck ist fortgeschrieben, nur der Wortlaut der Registerangabe im verlangten Zeilenanfang wechselt von „offen“ auf „bewusst inaktiv“; alle übrigen Bedingungen (Zitat aus Kap. 6, Kap. 6 nennt 60-S104-01) sind unverändert. | wortgleich in der Kopftabelle | behoben (unverändert) |
| 48 | C | Folge aus 49: Die Präambel der Knoten-Bilanz sagte „Registerzeile 60-S104-01 ist offen“; jetzt „ist bewusst inaktiv (geparkt)“. Der Prüfausdruck ist fortgeschrieben, nur dieser eine verlangte Wortlaut wechselt; alle übrigen Bedingungen (sechs Formelstellen, FS-Exposition aufgehoben, zweimal „in dieser Fassung inaktiv“) sind unverändert. | wortgleich in der Kopftabelle | behoben (unverändert) |

**Mitgezogen, ohne eigenen Befund.** Kap. 6 („Bestandsdynamik S104“) nannte für 60-S104-01 den Stand
„offen“ und kündigte die Bindung an FS-Bestandsdynamik an, „sobald 60-S104-01 eine Entscheidung trägt“;
beides hieße nach diesem Paket etwas Falsches. Der Stand heißt jetzt „bewusst inaktiv (geparkt)“, die
Ankündigung „sobald 60-S104-01 eine rechnende Entscheidung trägt“ (ebenso am Ende der Bilanzzeile S104).
Kopfvermerk und Abschnitt „Ergebnis“ sagten „die übrigen 25 stehen auf `offen`“ und sind auf den neuen
Stand gebracht.

**Bewusst nicht angefasst.** Der Umsetzungsnachweis zu Befund 3 in der Kopftabelle („die übrigen 25
Zeilen weiterhin auf ‚offen‘“) beschreibt den Stand, mit dem Befund 3 geschlossen wurde, und bleibt als
Nachweis wortgleich; ebenso die Abschnitte der Runden 1 bis 3 und die Revision T-0579 mit den alten
Ausdrücken zu 47 und 48.

**Prüfausdrücke der Kopftabelle.** Der Prüfausdruck zu 49 gibt auf dem Branch `32 0` aus und endet
mit 0; auf dem Stand von main vor dem Paket (Dateien per `git show main:<pfad>` in ein
Temporärverzeichnis kopiert) gibt er `32 25` aus und endet mit 25. Die fortgeschriebenen Ausdrücke zu
47 und 48 enden auf dem Branch mit 0 (ihre alten Fassungen enden dort mit 1, weil sie den Wortlaut
„offen“ verlangen). Keiner der übrigen 59 Prüfausdrücke, die auf main mit 0 endeten, hat seinen Ausgang
geändert (Abgleich aller Nummern, main gegen Branch; 83 endet auf main wie auf dem Branch mit 1).
`python3 backend/scripts/lint_methodik.py 60`: vor dem Paket 221 Checks grün, danach 221 Checks grün,
„ALLE LINTS GRÜN“.

## Autor-Revision T-0581 (Befunde 29, 30, 31, 77, 78, 90)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401): Bericht 60 Kap. 2/§3.3 — Registerzeilen 60-S092-01,
60-S093-01, 60-W085-01 und Typstruktur der Stützstellen. Geändert wurden
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md` (Kap. 2 Registerzeilen 60-W085-01, 60-S092-01,
60-S093-01; Langbelege B1 und B5; §3.3 neuer Absatz „Typstruktur — Modellgrenze“; §5.1 „Anlass“, ein
Satz; Kap. 9 Ansatz (a), ein Satz), `docs/evidenz/register.md` (Spiegel derselben drei Zeilen) und
dieser Ledger (Überschrift, Nachtrag, Kopfzeilen 29, 30, 31, 77, 78, 90, dieser Abschnitt). Kein
Zahlenwert, keine Formel und kein Parameter-Block ist geändert: \(p_3\) = 2,236·10⁻³ a⁻¹ rechnete
schon vorher (§3.4, Kap. 7 `flood_bldg.p_hq_extrem`), \(r_{\text{S092}}\) = 0,035 (Band
0,0075–0,0832) und \(d(h)\) bleiben, wie sie sind. Die Typstruktur ist nach der zweiten Option des
Vorschlags zu 30/78 behandelt (Modellgrenze mit Richtung und Größenordnung), nicht als neue
Registerzeile: FLEMOps publiziert keine Zahlentabelle je Gebäudetyp, eine typabhängige Schadensquote
wäre deshalb eine zweite Abschätzung ohne Beleg im Rechenpfad.

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 29 | C | Vorschlag umgesetzt. Registerzeile 60-S092-01, Spalte Studientyp: „Befragungen nach Ereignissen sind nur Kandidat, im Volltext nicht verifiziert“ ersetzt durch Thieken u. a. 2008 (FLEMOps, 1.697 Haushalte) als **volltextgeprüfte**, nach §3.5 als Wertquelle **nicht zulässige** Befragungsevidenz (Langbeleg B5, Tab. 2 S. 318). Mitgezogen: §5.1 „Anlass“ sagte dasselbe („zudem sind diese Studien hier nicht im Volltext verifiziert“) und nennt jetzt die volltextgeprüfte Befragung als bloße Plausibilitätsprobe. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-S092-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;raise SystemExit(0 if 'Thieken u. a. 2008' in c[4] and '**volltextgeprüft**' in c[4] and 'nach §3.5 als Wertquelle aber **nicht zulässig**' in c[4] and 'nicht verifiziert' not in c[4] and 'nicht im Volltext verifiziert' not in s else 1)"` | behoben |
| 77 | C | Vorschlag umgesetzt. In derselben Zelle die Plausibilitätsprobe der Kette §5.1 (nicht als Wert): Tab. 2 C0P1 0,64 ÷ C0P0 0,92 = 0,696 und C0P2 0,41 ÷ 0,92 = 0,446 (−30 %/−55 % je vorsorgendem Gebäude) gegen \(s_{\text{bem}} \cdot e_{\text{bem}}\) = 0,35 je nachgerüstetem Gebäude (Band 0,15–0,416) — der Kettenwert liegt zwischen beiden Befragungswerten. Kopplung S092 ↔ S093 in der Zeile und in B5 (nach der bestehenden „Kopplung (§3.9)“) vermerkt. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-S092-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;b=s.split('**B5 — 60-S093-01')[1].split('**B6 — ')[0];raise SystemExit(0 if all(x in c[4] for x in ('0,696','0,446','Plausibilitätsprobe der Kette §5.1 (nicht als Wert)','Kopplung S092 ↔ S093')) and 'Kopplung S092 ↔ S093' in b and 'Registerzeile 60-S092-01' in b else 1)"` | behoben |
| 30 | C | Vorschlag (zweite Option) umgesetzt. Registerzeile 60-S093-01, Spalte Übertragbarkeit: neue Modellgrenze (d) „Typstruktur“ — die Gebäudetyp-Achse von FLEMOps wird für die Schadensquote nicht genutzt, \(d(h)\) ist typunabhängig, der Gebäudetyp rechnet nur im Preis (\(n_t\), 60-R24-01); Richtung und Größenordnung mit Verweis auf §3.3. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();r=open('docs/evidenz/register.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-S093-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;y=[l for l in r.split(chr(10)) if l.startswith(P+' 60-S093-01 ')];raise SystemExit(0 if '(d) **Typstruktur:**' in c[6] and 'typunabhängig' in c[6] and 'in §3.3' in c[6] and len(y)==1 and '(d) **Typstruktur:**' in y[0] else 1)"` | behoben |
| 78 | C | Vorschlag (zweite Option) umgesetzt. §3.3 neuer Absatz „Typstruktur — Modellgrenze“: Endwerte als Wert des nationalen Typ-Mixes gelesen (\(\bar\theta\) = 0,596, §4.3); Verhältnis der Schadensquoten MFH ÷ EFH \(\rho\) ≈ 0,50–0,67 (Anteil des überfluteten Erdgeschosses am Gebäudewert, Abschätzung von KAP3); Richtung: EFH-Zellen unterschätzt, MFH-Zellen überschätzt; Größenordnung: Faktor 1,25/0,63 bei \(\rho\) = 0,50, 1,15/0,77 bei \(\rho\) = 0,67, also +15 % bis +25 % bzw. −23 % bis −37 %; Bundessumme über den Niveau-Skalar kalibriert, betroffen ist die Verteilung zwischen Kommunen. Kap. 9 Ansatz (a) beschreibt jetzt den umgesetzten Aufbau (Typachse nicht im Schadensgrad, Gebäudetyp im Wertsatz). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();t=s.split(chr(10)+'### 3.3 ')[1].split(chr(10)+'### 3.4 ')[0];k9=s.split(chr(10)+'## 9 ')[1].split(chr(10)+'## Entscheidungslog')[0];raise SystemExit(0 if '*Typstruktur — Modellgrenze' in t and all(x in t for x in ('**Richtung:**','**Größenordnung:**','+15 % bis +25 %','−23 % bis −37 %','**typunabhängig**')) and 'Gebäudetyp ·' not in k9 and 'Typachse von FLEMOps' in k9 else 1)"` | behoben |
| 31 | C | Vorschlag umgesetzt. Registerzeile 60-W085-01, Spalte Effektgröße: Zentralwert HQextrem \(p_3\) = 2,236·10⁻³ a⁻¹ (T ≈ 447 a; §3.9 Abgeschätzt, geometrisches Mittel der Bandenden, Herleitung §3.4 Schritt 2 und B1); B1 trägt den Rechenschritt. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();r=open('docs/evidenz/register.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-W085-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;b1=s.split('**B1 — 60-W085-01')[1].split('**B2 — ')[0];y=[l for l in r.split(chr(10)) if l.startswith(P+' 60-W085-01 ')];raise SystemExit(0 if '= 2,236·10⁻³ a⁻¹** (T ≈ 447 a; §3.9 Abgeschätzt, geometrisches Mittel der Bandenden' in c[3] and 'Zentralwert' in b1 and '2,236·10⁻³ a⁻¹' in b1 and len(y)==1 and '2,236·10⁻³' in y[0] else 1)"` | behoben |
| 90 | C | Vorschlag umgesetzt (erste Option, zusätzlich der Satz der zweiten). Spalte Modellgrenze derselben Zeile: die Zusammenziehung des Extrembands auf \(p_3\) ist als bewusste Entscheidung mit Grund und Verweis auf §3.4 Schritt 2 benannt; Spalte Entscheidung nennt \(p_3\) als Basiswert des Extremszenarios. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();P=chr(124);k=s.split(chr(10)+'## 2 ')[1].split(chr(10)+'### Belege')[0];z=[l for l in k.split(chr(10)) if l.startswith(P+' 60-W085-01 ')];c=z[0].split(P) if len(z)==1 else ['']*9;raise SystemExit(0 if all(x in c[6] for x in ('zum Zentralwert','2,236·10⁻³','§3.4 Schritt 2')) and 'Zentralwert' in c[8] and '2,236·10⁻³' in c[8] else 1)"` | behoben |

**Mitgezogen, ohne eigenen Befund.** `docs/evidenz/register.md` spiegelt die Zeilen 60-W085-01 (Zentralwert,
Modellgrenze, Entscheidung), 60-S092-01 (Studientyp, verkürzt) und 60-S093-01 (Modellgrenze (d)).
Prüfausdruck 19 (Band 0,0075–0,0832 in beiden Dateien) ist davon nicht berührt.

**Bewusst nicht angefasst.** Der Entscheidungslog Nr. 5 („p(HQ) × Schadensgrad(Wassertiefe · Gebäudetyp
· Gebäudequalität) × Gebäudewert“) ist ein datierter Eintrag vom 13.09.2026 und bleibt wortgleich; die
geltende Beschreibung steht in Kap. 9. Die Abschnitte der Runden 2 und 3 mit den alten Ausdrücken zu 29,
30 und 31 bleiben als Nachweis stehen.

**Prüfausdrücke der Kopftabelle.** Die sechs neuen Ausdrücke enden auf dem Branch mit 0 und auf dem
Stand von main vor dem Paket (Dateien per `git show main:<pfad>` in ein Temporärverzeichnis kopiert)
mit 1. Keiner der übrigen 63 Prüfausdrücke, die auf main mit 0 endeten, hat seinen Ausgang geändert
(Abgleich aller Nummern, main gegen Branch; 2 endet auf main wie auf dem Branch mit Ausgang 1 und
Ausgabe `0`). `python3 backend/scripts/lint_methodik.py 60`: vor dem Paket 221 Checks grün, danach
221 Checks grün, „ALLE LINTS GRÜN“.

## Autor-Revision T-0728 (Befunde 11, 69)

Autor-Paket vom 23.09.2026 (Vorhaben T-0401, Auflösung von T-0582-cto, Reihenfolge 22): Bericht 60
Kap. 8 „Quellen (§3.8)“, Quelle 1 — Fundstellenliste der Wirkungsketten-Mappe. Geändert wurde nur
`docs/methodik/60_gebaeudeschaeden_flusshochwasser.md`, Kap. 8, Quelle 1 (ein Satz), und dieser
Ledger (Kopf-Nachtrag, Kopfzeilen 11 und 69, dieser Abschnitt). Kein Zahlenwert, keine Formel und
kein Parameter-Block ist geändert.

| Nr | Kat. | Vorgenommene Änderung | Prüfausdruck | Status danach |
|---|---|---|---|---|
| 69 | C | Vorschlag umgesetzt (beide Teile). Der Zeilenbereich der Klimawirkungsketten-Mappe ist von „Z3–Z271“ auf „Z3–Z272“ erweitert und deckt damit die Zeile des Zielknotens W117 (Kap. 1, zitiert bei Befund 13) ab; die abschließend wirkende Formulierung „wie in Kap. 1 zitiert“ trägt jetzt den Zusatz „u. a.“, sodass die Liste nicht mehr als vollständig gilt. | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();q1=s.split(chr(10)+'1. **KWRA-Schadensbaum')[1].split(chr(10)+'2. **KWRA-Monetarisierung')[0];raise SystemExit(0 if ('Z3–Z272' in q1 and 'Z271' not in q1 and 'u. a. wie in Kap. 1 zitiert' in q1) else 1)"` | behoben |
| 11 | B | Kein eigener Eingriff — der laut Regression Runde 3 einzig verbliebene Rest der Forderung ist Befund 69; mit dessen Behebung ist Befund 11 vollständig erfüllt (Fundstellenliste von Quelle 1 deckt jetzt die tragende Zeile ab, alle drei Quellen tragen weiterhin DOI/URL bzw. Dateistand/Prüfsumme mit Zugriffsdatum aus der Regression Teil 1). | `python3 -c "s=open('docs/methodik/60_gebaeudeschaeden_flusshochwasser.md',encoding='utf-8').read();k=s.split(chr(10)+'## 8 ')[1].split(chr(10)+'## 9 ')[0];h=k.count('http')>=3;q1=s.split(chr(10)+'1. **KWRA-Schadensbaum')[1].split(chr(10)+'2. **KWRA-Monetarisierung')[0];r=('Z3–Z272' in q1) and ('Z271' not in q1);raise SystemExit(0 if (h and r) else 1)"` | behoben |

**Mitgezogen, ohne eigenen Befund.** Dieselbe Änderung streicht in Quelle 1 aus der Zellenliste der
„Schadensbaum-Netzwerkliste“ die Einträge Z51 und Z60, die der Bericht nirgends zitiert (Teil des
Vorschlags zu Befund 50). Befund 50 selbst betrifft daneben auch Quelle 2 (unveränderte Zellenliste)
und bleibt deshalb bewusst auf `offen` stehen; er wird erst mit dem Folgepaket zu Quelle 2
geschlossen.

**Bewusst nicht angefasst.** Quelle 2, §7.1, Kapitel 2 und `backend/scripts/lint_methodik.py` bleiben
unverändert (Dateirahmen dieses Pakets); die historischen Abschnitte der Runden 2/3 und der
Befundregression mit den alten Ausdrücken zu 11 und 69 bleiben als Nachweis stehen.

**Prüfausdrücke der Kopftabelle.** Die zwei neuen Ausdrücke enden auf dem Branch mit 0 und auf dem
Stand von main vor dem Paket (Dateien per `git show main:<pfad>` in ein Temporärverzeichnis kopiert)
mit 1. Keiner der übrigen Prüfausdrücke, die auf main mit 0 endeten, hat seinen Ausgang geändert
(Befunde 50 und 101, die dieselbe Fundstelle in Worten beschreiben, tragen keinen ausführbaren
Prüfausdruck — Feld „—“ — und sind deshalb nicht betroffen). `python3 backend/scripts/lint_methodik.py 60`:
vor dem Paket 221 Checks grün, danach 221 Checks grün, „ALLE LINTS GRÜN“.
