...
| 37 | Bericht §4.8 Parametertabelle gegen §4.2, §4.4, §4.5, §4.6 · **Lücke** — drei in Kapitel 4 rechnende Werte fehlen in der P1-Tabelle | B | offen | Urteil der Befundregression Runde 3, Teil 6: **zurückgefallen** — die Zeilen „Baupreisanstieg" und „Plausibilitätsschranke λ" stehen weiterhin in §4.8, aber die inzwischen die Untergrenze \(U\) tragenden drei Abschätzungen von KAP3 (Wohn-/Wohngebäudeanteil 0,11, flussseitiger Anteil 0,90, Wiederkehrzeit 100 a, §4.6) kommen in §4.8 nur als Fließtext in der Herleitungsspalte von \(U\) vor, ohne eigene Zeile, Wert oder Band — dieselbe Lage, die der Befund für die alte Betroffenheit 1/100 a beanstandet hatte. → neuer Befund 97. | vorhanden (Wortlaut: Runde 2, Abschn. 3.3) | Vorschlag in Runde 2. Nachtrag T-0574: Die in Runde 2 geführte Zeile „Betroffenheit exponierter Gebäude“ ist mit der §4.6-Neufassung durch „Klassenraten Bestandsschranke“ abgelöst; die rechnenden Abschätzungen der Untergrenze stehen seit T-0574 als eigene Zeilen in §4.8 (Befund 97), der Status von 37 ist hier nicht fortgeschrieben. |
