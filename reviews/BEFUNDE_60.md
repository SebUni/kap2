...
| 27 | C | (a) B4 Rechenschritt 2: Herkunft der Jahresraten ausgewiesen — 5,0 % belegt, 3,4 % und 2,3 % gerundete Setzungen von KAP3 mit Richtung und Größe (Median 3,3 % ⇒ 1,102, Mittel 3,8 % ⇒ 1,119); (b) Bandenden ungerundet gerechnet; (c) Typ-Spanne und Unsicherheitsband getrennt in Registerzeile, Spiegel und B4 Rechenschritte 3/4. Der Status „bewusst offen“ ist aufgehoben, weil alle drei Teilpunkte im Text stehen. Der zeilennummerngebundene Prüfausdruck der Runde 2 (Abschn. 2.2) weist den Mangel nach, nicht seine Behebung, und ist kein Prüfausdruck der Kopftabelle; er wird nicht fortgeschrieben. | wortgleich in der Kopftabelle | behoben (vorher bewusst offen) |
