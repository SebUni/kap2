...
`bewusst offen`, die übrigen fünf `offen` — die Überschrift zählt deshalb 71 − 6 = 65.
...
| 60 | Bericht §4.2 Z. 1119–1121 (\pi = 1,07: „Das Register führt für 2023 → 2026 den Baupreisfaktor 1,105 (B4, Band 1,07–1,16). Abzüglich rund 3… · **Fehler** — \pi ist ein abgeleiteter Parameter: Er entsteht aus dem B4-Faktor durch Division mit 1,03. | C | offen | — | — | Vorschlag in Runde 3 |
...
| 98 | Bericht §4.2 Z. 1093 und Z. 1120–1121, §4.8 Z. 1466 (je „1,07 (1,04–1,11)"), Beispielblock Z. 1483–1484 (`* 1.11`, `assert abs(hi - 2.263)… · **Fehler (fortbestehender Rundungsfehler ohne sichtbare Modellgrenze; neue Folgewirkung)** — Befund 38 ist im Ledger als „bewusst offen" geführt mit der Begründung, der Rundungsfehler werde mit Befund 27 nachgezogen. | C | offen | — | — | Vorschlag in Runde 3 |
