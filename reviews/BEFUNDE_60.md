...
T-0566) steht in dieser Kopftabelle ausschließlich die Kurzfassung aus Review-Runde 3; kein
Befund dieser Runde ist bislang bearbeitet, alle stehen auf `offen`, Umsetzungsnachweis und
Prüfausdruck sind noch nicht vergeben.
...
| 57 | Bericht §3.1 Z. 541–548 — Betrachtungsebene „die Kommune" (Z. 541) und Formel \text{EAD} = \bar A \cdot w (Z. 548) —, gegen §3.6 Z. 797… · **Fehler/Lücke** — Auf der Zelle ist der Euro-Betrag exakt proportional zur physischen Zwischengröße (\text{EAD}_z = \bar A_z w_z) — das erfüllt den Kern von LF 3. | B | offen | — | — | Vorschlag in Runde 3 |
