...
(Präambel Kap. 2, Entscheidungsspalte der Registerzeilen 60-S093-01/60-S094-01, §3.5, §5.1.3) und
dieser Ledger. Kein Zahlenwert, kein Band und kein Parameter-Block ändert sich.
...
| 55 | B | Präambel Kap. 2: zwei Fälle ausdrücklich zugelassen — (1) ein Zeichen einer Zeile mit Entscheidung Sensitivitätsband als neutral gesetztes Glied (1,00) in der Formel, (2) die belegten Enden \(d_1\)/\(d_5\) der Wasserstandsachse als Basiswert mit Herleitung §3.3. Registerzeilen 60-S093-01/60-S094-01: „kein eigenes Multiplikativglied im Basiswert" ersetzt durch „in der Kernformel §3.4 steht es als neutral gesetztes Glied (1,00), das den Basiswert nicht verschiebt". §3.5: \(d(h)\) und \(d_1\)/\(d_5\) mit Herkunft `herleitung: §3.3` (Langbeleg B5) statt Registerzeile, \(f_{S093}\)/\(f_{S094}\) mit Vermerk zur Entscheidung Sensitivitätsband. Gewählt ist die zweite Variante des Vorschlags (Präambel ergänzen), nicht die Teilung der Registerzeile, weil sie ohne neue Register-ID und ohne Änderung am Spiegel `docs/evidenz/register.md` auskommt. Das Wort „Platzhalter" aus dem Vorschlag ist im Lint verboten und deshalb durch „neutral gesetztes Glied" ersetzt. | wortgleich in der Kopftabelle | behoben |
