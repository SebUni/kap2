...
| BGF-Faktor | 1,30 | **1,25** | **1,40** | **Abschätzung von KAP3:** Register 60-R24-01, §3.9 „Abgeschätzt" (Rechenschritt 3, Band 1,25–1,40). |
...
| Fortschreibungsrate der Fondsvolumina auf den Preisstand 2026 | 2 %/a (\(1{,}02^{13}\) = 1,294 für 2013, \(1{,}02^{5}\) = 1,104 für 2021; Band 0–3 %/a) | **Abschätzung von KAP3**: Herleitung in §4.6 (keine Quelle trägt die Rate; Band = die dort gerechnete Sensitivität); Sensitivität: ohne Fortschreibung (0 %/a) \(U\) = 0,165 und \(O_u\) = 10,0 Mrd. €₂₀₂₆/a, mit 3 %/a \(U\) = 0,202 und \(O_u\) = 11,59 Mrd. €₂₀₂₆/a — Lage des Ist-Werts 1,132 im Band unverändert |
...
- **`herleitung_anker:`** — bei jedem als `abschaetzung_kap3` gekennzeichneten Block der benannte
  ...
  Die genannten sind Anker, zum Beispiel für die Form; die Liste ist nicht vollständig, und jeder
  Block trägt seinen Anker selbst im Feld `herleitung_anker:`.
