...
- **Schutzprogramme vulnerable Gruppen (Knoten S152; Hitzetelefon, aufsuchende Betreuung,
  ...
  eher die obere Grenze. **Untere Grenze aus Tabelle 2 (Befund 132):** Zu den Anstiegen gibt Tabelle 2 die
  Standardabweichung zwischen den Stadtteilen an, 73,1 Pp. über 4 Stadtteile ohne und 6,8 über
  3 Stadtteile mit Programm (Stadtteile nach dem Methodenteil von [70]). Daraus:
  ...
  Zentralwert 0,68 bleibt eine Abschätzung von KAP3 und ist nie null: [70] meldet im Abschnitt „Results“ mit
  einem Regressionsmodell einen signifikant kleineren Anstieg (p < 0,001; 25 vermiedene Todesfälle, 13 %). (3) **Reichweite** \(r_{\text{VG}}\) = 20 %
