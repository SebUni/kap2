...
| \(r_{\text{VG}},\ w_{\text{VG}}\) | Reichweite eines Schutzprogramms (Anteil der Menschen ab 75) / Wirkung bei Erreichten (Anteil des Exzesses, der wegfällt) | — | 0,20 (0,05–0,40), Setzung von KAP3 / 0,68 (0–0,68; untere Grenze aus [70] Tabelle 2, Befund 132; bereinigt nach Tabelle 3: 0,34, Befund 134) = Halbierung 0,498 geteilt durch den Einschreibeanteil 0,728 in [70] (Befund 128); register:95-S152-03 |
...
| \(\delta_{\text{VG}}\) | Dämpfung durch Schutzprogramme vulnerable Gruppen — multiplikativ auf den Wochen-Exzess der Bänder 75–84 und 85+ (85+ ohne Heimbewohner); Maßnahme §5 | — | 0,864 (0,794–1,0) = 1 − \(r_{\text{VG}} \times w_{\text{VG}}\), Wirkung höchstens bis zum Paketwert 0,794 [47]; Abschätzung von KAP3 [47,70]; register:95-S152-03 |
| \(\delta_{\text{VG,morb}}\) | Faktor der Schutzprogramme auf die Einweisungen (Morbidität) der Bänder 75–84 und 85+ ohne Heimbewohner; Maßnahme §5 | — | 1,0 (0,864–1,136), Abschätzung von KAP3: unten wie \(\delta_{\text{VG}}\), oben 1 + \(r_{\text{VG}} \times w_{\text{VG}}\) (Befund 131); register:95-S152-03 |
...
- **Gekühlte Räume / Klimaanlagen in Pflegeheimen (S157):** rOR ≈ 0,93 an Extremhitzetagen
  ...
  **Warum \(\text{OR}_{\text{ohne}}\) = 1,11 fest bleibt (Befund 132):** Auch \(\text{OR}_{\text{ohne}}\) hat in [46]
  ...
  0,98–1,07, ohne 1,06–1,16), liegen 95 % der Werte zwischen 0 und 0,83. Beides liegt im Band 0–0,90; das Band
...
- **Schutzprogramme vulnerable Gruppen (Knoten S152; Hitzetelefon, aufsuchende Betreuung,
  ...
  (Befund 128). Band 0–0,68: Der Vergleich ist ökologisch, mit 336 Todesfällen im Sommer 2015 und ohne
  Angaben zu Klimaanlagen und Urlaubsabwesenheit (Abschnitt 4, letzter Absatz, von [70]); 0,68 ist deshalb
  eher die obere Grenze. **Untere Grenze aus Tabelle 2 (Befunde 132, 133):** Tabelle 2 von [70] führt den Anstieg
  ...
  damit im Intervall, und die untere Grenze von \(w_{\text{VG}}\) ist 0 statt der früheren Setzung 0,30.
  **Bereinigte Lesart (Tabelle 3, Befund 134):** Die Autoren rechnen außerdem eine Regression über die 7 Stadtteile,
  nach Einwohnern gewichtet und bereinigt um die Sterberate vor dem Sommer und den Anteil ab 90 (Abschnitt 3).
  Danach senkt das Programm den Anstieg um 24,4 Pp. (95-%-Intervall 19,7–29,0 Pp.; Tabelle 3, Zeile „LLE program“),
  halb so viel wie der rohe Unterschied. Ein Teil des rohen Unterschieds ist Altersstruktur: Mit Programm sind 9,0 %
  der Einwohner 90 oder älter, ohne 10,3 % (Tabelle 1). Auf die Erreichten umgerechnet:
  \(w_{\text{VG}} = 24{,}4 / 97{,}3 / 0{,}728 = 0{,}34\) (0,28–0,41); auch diese Lesart liegt im Band 0–0,68. Die
  „13 %“ aus Abschnitt 3 („25 deaths were averted“, 167 statt erwarteter 192 Todesfälle) beziehen sich auf alle
  Todesfälle des Sommers, nicht auf den Anstieg, und gehen deshalb nicht in \(w_{\text{VG}}\) ein. **Zentralwert:**
  vorerst die rohe Lesart 0,68, eine Abschätzung von KAP3, nie null. Die bereinigte Lesart ergäbe für Berlin
  11,7 statt 23,1 Mio. € je Jahr; welche Lesart gilt, ist dem methodik_manager als Befund 134 vorgelegt (Log 43). (3) **Reichweite** \(r_{\text{VG}}\) = 20 %
  ...
  je Jahr** weniger (Band 0–34,9 Mio. €), das sind 6,4 % (0–9,6 %) des Jahresbetrags 362,9 Mio. €.
  Stärkster Treiber ist die Reichweite \(r_{\text{VG}}\): Von 5 % bis 40 % wandert der Betrag von
  5,8 Mio. € bis an die Kappung bei 34,9 Mio. €. **Morbidität (Befund 131, Block `heat.delta_vg_morb`):** Faktor \(\delta_{\text{VG,morb}}\) = 1,0
  (Band 0,864–1,136, **Abschätzung von KAP3**) auf die Einweisungen \(F_{75\text{–}84} + F_{85+} \times (1 - h_{\text{Heim}})\),
  gleiche Formelzeile wie oben mit \(F\) statt \(D\). Die Wirkung geht in beide Richtungen: Aufsuchende Betreuung
  verhindert Einweisungen, wie sie Todesfälle verhindert (untere Grenze 0,864 wie \(\delta_{\text{VG}}\)). Sie findet
  aber auch Menschen, die ohne Besuch zu Hause geblieben wären, und zieht deren Einweisung vor (obere Grenze
  \(1 + 0{,}20 \times 0{,}68 = 1{,}136\): so viele Einweisungen zusätzlich, wie Todesfälle wegfallen). Welche
  ...
  Betrag um ± 0,05 Mio. € (± 0,013 % des Jahresbetrags). **Doppelzählungs-Wächter:** Hat die Kommune ein solches Programm schon
...
parameter:
  ...
  wert: 0.864
  einheit: "-"
  band: [0.794, 1.0]   # 1 - r x w mit r 0,05-0,40 und w 0-0,68 (untere Grenze aus [70] Tab. 2, Befund 132); Wirkung gekappt am Paketwert DE 0,794 [47] (Befund 128)
  herkunft: register:95-S152-03
  quelle: urban2025_liotta2018
  preisstand: null
  bandzuordnung: [75-84, 85+]
  endpunkt: mortalitaet   # Morbiditaet: eigener Block heat.delta_vg_morb (1,0, Band 0,864-1,136; §5, Befund 131)
  kennzeichnung: abschaetzung_kap3   # 1 - r_VG x w_VG = 1 - 0,20 x 0,68; w = 0,498 / 0,728 aus Liotta 2018 [70] Tab. 1-2 (roh; bereinigt Tab. 3: 0,34, Befund 134), Obergrenze Paket Urban 2025 [47] Tab. 1 (DE 0,794); r Setzung von KAP3 (§5, Log 43). Faktor auf den Wochenexzess 75-84 und 85+ ohne Heimbewohner (D_85+ x (1 - h_Heim)), nicht v_vers,a; mit heat.delta_hap zusammen max(delta_hap x delta_vg; 0,794)
  abgeleitet_aus: []
parameter:
  id: heat.delta_vg_morb
  wert: 1.0
  einheit: "-"
  band: [0.864, 1.136]   # unten wie heat.delta_vg (Einweisungen verhindert), oben 1 + 0,20 x 0,68 (Einweisungen vorgezogen); Befund 131
  herkunft: register:95-S152-03
  quelle: urban2025_liotta2018
  preisstand: null
  bandzuordnung: [75-84, 85+]
  endpunkt: morbiditaet
  kennzeichnung: abschaetzung_kap3   # Richtung der Wirkung auf Einweisungen nicht gemessen; Zentralwert 1,0 setzt Verhindern und Vorziehen gleich (§5). Faktor auf F_75-84 + F_85+ x (1 - h_Heim); Berlin +-0,05 Mio. EUR je Jahr
...
for d, soll in ((delta_vg, 23.1), (paket_de, 34.9), (1.0, 0.0)):
    assert abs(eur_7585 * (1 - d) - soll) < 0.05
# Befund 134: bereinigte Lesart [70] Tab. 3, Zeile LLE program: -24,372 Pp. (95-%-KI -29,029 bis -19,714)
w_ber = [x / 97.3 / einschreibung for x in (24.372, 19.714, 29.029)]
assert [round(x, 2) for x in w_ber] == [0.34, 0.28, 0.41] and w_ber[2] < 0.68
assert abs(1 - r * w_ber[0] - 0.931) < 0.001 and abs(eur_7585 * r * w_ber[0] - 11.7) < 0.05
...
morb_band = (delta_vg, 1 + r * w)             # heat.delta_vg_morb, Befund 131
assert abs(morb_band[1] - 1.136) < 1e-9
for m in morb_band:
    assert abs(abs(f_75 * 7152 * (1 - m) / 1e6) - 0.047) < 0.001   # +-0,05 Mio. EUR
...
- **[70]** G. Liotta, M. C. Inzerilli, L. Palombi, O. Madaro, S. Orlando, P. Scarcella, D. Betti,
  ...
  gewichtet); bereinigte Regression in Tabelle 3, Zeile „LLE program“; vollständig gelesen am 26.09.2026: Abschnitte
...
gegenüber dem Katalogwert im Produkt (T-1295, Befunde 123 und 124). Eintrag 44: Hebel S157
