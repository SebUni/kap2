# Zuständigkeit für Klimaanpassungskonzepte nach § 12 Abs. 1 KAnG — Rechtslage der 16 Länder

Zweck: Diese Übersicht hält je Land fest, ob und durch welche Landesnorm die öffentlichen
Stellen bestimmt sind, die nach § 12 Abs. 1 KAnG
(https://www.gesetze-im-internet.de/kang/__12.html) für die Gebiete der Gemeinden und Kreise
...
- **Baden-Württemberg:** Umweltministerium BW, Seite zum KlimaG BW
  (https://um.baden-wuerttemberg.de/de/klima-energie/klimaschutz/klimaschutz-und-klimawandelanpassungsgesetz-baden-wuerttemberg):
  Das Änderungsgesetz vom 29.07.2025 verankert die Konzeptpflicht in „§§ 29a ff. KlimaG BW“
  und setzt § 12 KAnG um; Pflichtaufgabe von Stadtkreisen, Großen Kreisstädten und Landkreisen.
  Absatzangabe aus dem amtlichen Hinweispapier des Umweltministeriums (09/2025,
  https://um.baden-wuerttemberg.de/fileadmin/redaktion/m-um/intern/Dateien/Dokumente/4_Klima/Klimaschutz/Klimagesetz/Hinweispapier-zur-Erstellung-von-kommunalen-Klimaanpassungskonzepten.pdf):
  „Jeder Stadtkreis und jede Große Kreisstadt muss eigenständig für das Gemeindegebiet ein
  Klimaanpassungskonzept erstellen … (§§ 29b Absatz 1 Satz 1 Nummer 1, 29c Absatz 1 KlimaG BW)“;
...
- **Nordrhein-Westfalen:** Novelle des Klimaanpassungsgesetzes NRW, im Landtag beraten,
...
Wer eine Zeile ändert, setzt `Stand` neu. Bei `keine Bestimmung getroffen` wird der Wert in
`Rechtsgrundlage` mitgezogen (`keine Bestimmung getroffen, Stand <Stand>`). Ein Entwurf wandert
erst in die Tabelle, wenn er verkündet ist. Die Form prüft
`backend/tests/test_kang_zustaendigkeit_doku.py`.
